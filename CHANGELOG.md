...
* [`79cf214b7`](https://github.com/talos-systems/talos/commit/79cf214b78db360f8e034d1ae5489f9d87dd8eb4) test: retry `talosctl time` call in the tests
* [`b79948f9a`](https://github.com/talos-systems/talos/commit/b79948f9a8169b054bfe944e491f7b09b9792438) feat: show human-readable aliases in `talosctl get rd`
* [`ccf468ea2`](https://github.com/talos-systems/talos/commit/ccf468ea253354aededfcc180865758a0c367a0b) feat: update Kubernetes to 1.23.1
* [`5bf3a1519`](https://github.com/talos-systems/talos/commit/5bf3a1519acd2fe7caf48411bdbac4c2178b168e) fix: update DHCP library with the panic fix
* [`bc8983b93`](https://github.com/talos-systems/talos/commit/bc8983b93cfe785a858bd86986e60394091e29e6) release(v0.14.0-beta.1): prepare release
* [`02796f889`](https://github.com/talos-systems/talos/commit/02796f8893b8af489cdb36e9f81a7c027f83753e) fix: allow kubelet to be started via the API
* [`e69eacae1`](https://github.com/talos-systems/talos/commit/e69eacae1042819fe8320c120e8b1518ebea81ba) fix: use default time servers in time API if none are configured
* [`c60e153a1`](https://github.com/talos-systems/talos/commit/c60e153a1b7f1e3c546141dcb3ead73d59079028) fix: cleanup affiliates
* [`301f9e4e0`](https://github.com/talos-systems/talos/commit/301f9e4e0331d857fdcd14330a0e28f8dde4b9a8) feat: update Kubernetes to 1.23.0
* [`fe2e953af`](https://github.com/talos-systems/talos/commit/fe2e953afe543836171f5a4f7ffe27bd0b4b2c1e) feat: upgrade kubelet version in `talosctl upgrade-k8s`
* [`4daff7895`](https://github.com/talos-systems/talos/commit/4daff78957488b53fe87461b7d3c78fd31e5f3a3) chore: update Go to 1.17.5
* [`35cb34bd5`](https://github.com/talos-systems/talos/commit/35cb34bd55e8da409ff4abfb6335d7bf443cc7d5) release(v0.14.0-beta.0): prepare release
* [`1d6f140d7`](https://github.com/talos-systems/talos/commit/1d6f140d76f53b12f40c07ef11ced8aebc6fc003) fix: make `apply-config` work reliably in any Talos state
* [`a5a6c720e`](https://github.com/talos-systems/talos/commit/a5a6c720e96a3c64b1f3126f1bfa4014ac00a85b) chore: remove boot-{arch}.tar.gz artifact
* [`fc5ec5007`](https://github.com/talos-systems/talos/commit/fc5ec500731b4593d2b2735e0b616e9825cf4f4f) fix: relax validation for wireguard endpoints
* [`cdbd5cff4`](https://github.com/talos-systems/talos/commit/cdbd5cff40eb521d98fa8f9ad1469740b5b60542) docs: vlan VIP
* [`149ffa977`](https://github.com/talos-systems/talos/commit/149ffa9774bc3fbea1a69afc01f5da4ac311f085) fix: increase boot and etcd join timeouts
* [`dc9db2141`](https://github.com/talos-systems/talos/commit/dc9db2141967603aaf2855e5a6874465e207d7b1) feat: autocomplete nodes, context and resource definitions
* [`b4b3e2133`](https://github.com/talos-systems/talos/commit/b4b3e21333c54cff3559fcc3464327fc23e673ee) chore: bump tools/pkgs/extra to final released versions
* [`d225cf91e`](https://github.com/talos-systems/talos/commit/d225cf91e83077857b386e5131e74980d3aef476) fix: tmpfs default permissions
* [`8f3e1a4ad`](https://github.com/talos-systems/talos/commit/8f3e1a4ad6af61e75c26fffd496c9a4b7fca313e) fix: drop unpacked layers from containerd image store
* [`1fc43619d`](https://github.com/talos-systems/talos/commit/1fc43619d2e80088540fdf8fa99f0cfcdd36bab0) docs: improve clarity for users
* [`36c9a65ac`](https://github.com/talos-systems/talos/commit/36c9a65ac083e975c27a22e198213c55899f1f93) feat: update deps and Kubernetes to 1.23.0-rc.1
* [`64a4f6e77`](https://github.com/talos-systems/talos/commit/64a4f6e77c52dde4068659129c52b3b00bd9a6fd) test: bump Talos versions in upgrade tests
* [`d2ebda78c`](https://github.com/talos-systems/talos/commit/d2ebda78cc592afca57aea51cdd3e343329d4b10) feat: update runc to 1.0.3
* [`adf05072a`](https://github.com/talos-systems/talos/commit/adf05072ac9bc8090bd83bf3fdfceb2d988f5bb7) chore: drop unused package
* [`961d1567d`](https://github.com/talos-systems/talos/commit/961d1567d9124069d047a1d44b9afbfdec365120) chore: update Go to 1.17.4
* [`d2fd7c217`](https://github.com/talos-systems/talos/commit/d2fd7c217015405a28cf3564a6916508425d48ef) feat: make kubelet service apply changes immediately
* [`4f5d9da92`](https://github.com/talos-systems/talos/commit/4f5d9da922bc3ca29ff9e834863471f0d2b830fd) feat: allow overriding KSPP kernel parameters
* [`6377f3df7`](https://github.com/talos-systems/talos/commit/6377f3df7bf8017d764c3311c664f97a9b90b8a2) test: uplift capi versions and templates
* [`2a0da0624`](https://github.com/talos-systems/talos/commit/2a0da062475edd80c2f4aa7a26da433d5fdc6d5a) feat: split installer and imager images
* [`1a13aaa23`](https://github.com/talos-systems/talos/commit/1a13aaa239d8afa5f7d2bfd3096762eb70e5fab7) feat: update Linux to 5.15.6
* [`73293bc2a`](https://github.com/talos-systems/talos/commit/73293bc2a76cbb40f29b0767784461f186c0f1b2) feat: can disable controlmanager and scheduler
* [`7f9922296`](https://github.com/talos-systems/talos/commit/7f9922296a6a19019c2bf0299d16f2b84f41c38e) feat: add powercycle mode in reboot
* [`bc69f6ec8`](https://github.com/talos-systems/talos/commit/bc69f6ec84418000e6397c887a5a01a99948c5da) feat: vip for VLANs
* [`99338e5ff`](https://github.com/talos-systems/talos/commit/99338e5ffde0e9bb87f948935633861a23858720) feat: update Flannel to 0.15.1
* [`8370dde1f`](https://github.com/talos-systems/talos/commit/8370dde1fd17d7f1a4c91fd3360835e527dc1d4f) docs: fix typos
* [`a5646db29`](https://github.com/talos-systems/talos/commit/a5646db297f382274dbf02eed7a4fa3ed4f2e950) feat: support MTU for VLAN's
* [`4aad0ebf9`](https://github.com/talos-systems/talos/commit/4aad0ebf91387b21fe430f77d8cc4111e05294d2) docs: expand logging documentation
* [`400225c88`](https://github.com/talos-systems/talos/commit/400225c886d1115ffc61ceac07c882a34e16a8df) docs: fix GCP docs
* [`f7c87d1d9`](https://github.com/talos-systems/talos/commit/f7c87d1d9d8ec5bf7bd8277c0502ea76563e65b1) release(v0.14.0-alpha.2): prepare release
* [`e9f4b7b20`](https://github.com/talos-systems/talos/commit/e9f4b7b2041223309467227fa8b99cf35b797c72) feat: update Linux to 5.15.5
* [`4d0a75a3f`](https://github.com/talos-systems/talos/commit/4d0a75a3f0795d5a0537c3b59007f97423c072ab) docs: add documentation about logging
* [`8d1cbeef9`](https://github.com/talos-systems/talos/commit/8d1cbeef9f2ae95d04035f5d999aa181fb88e9fc) chore: add API breaking changes detector
* [`ed7fb9db1`](https://github.com/talos-systems/talos/commit/ed7fb9db14554ccc191cc0c989aba38021a59690) feat: move kubelet proccesses to /podruntime cgroup
* [`2cd3f9be1`](https://github.com/talos-systems/talos/commit/2cd3f9be1f36dd3389ee528fa8f0b2548032c2f7) feat: filter out SideroLink addresses by default
* [`0f169bf9b`](https://github.com/talos-systems/talos/commit/0f169bf9b15239bfd35f371832211c42caf4349c) chore: add API deprecations mechanism
* [`eaf6d4720`](https://github.com/talos-systems/talos/commit/eaf6d4720383881c0dcf967dbc4e960d5ef49dd8) refactor: use random port listener in kernel log delivery tests
* [`bf4c81e7d`](https://github.com/talos-systems/talos/commit/bf4c81e7da854b7e9491f4ecb6fce89b026f4a9f) feat: kernel log (kmsg) delivery controller
* [`f3149780e`](https://github.com/talos-systems/talos/commit/f3149780e6663f7dc0fd0091cd6e3df605eac848) feat: update Kubernetes to 1.23.0-rc.0
* [`b824909d6`](https://github.com/talos-systems/talos/commit/b824909d686b1f5a8cd20afe9ca5a4f291a6f12d) fix: disable kexec on RPi4
* [`3257751bc`](https://github.com/talos-systems/talos/commit/3257751bc0a18e0d3bb7097191989440ae473ee6) fix: initialize Drainer properly
* [`e4bc68bf0`](https://github.com/talos-systems/talos/commit/e4bc68bf026966a3326872a1d342ef3b9c05cc9d) fix: leave only a single IPv4/IPv6 address as kubelet's node IP
* [`e6d007418`](https://github.com/talos-systems/talos/commit/e6d007418efeb5d7f82eb82a35cddacc64ec99ba) feat: update pkgs - Linux 5.15.4, LibreSSL 3.2.7
* [`d5cbc3640`](https://github.com/talos-systems/talos/commit/d5cbc3640256090e354b3896ffea72b8e58874bb) feat: add GCP ccm
* [`7433150fd`](https://github.com/talos-systems/talos/commit/7433150fd84ef0935e1aad91ca654892dc522806) feat: implement events sink controller
* [`b4a406ae7`](https://github.com/talos-systems/talos/commit/b4a406ae7c72e30ba488493682045495cd31dc4e) test: pin cluster API templates version to tag v1alpha4
* [`9427e78dc`](https://github.com/talos-systems/talos/commit/9427e78dc6d581e752bf41a20f1e0379cc99d92d) fix: catch panics in network operator runs
* [`d1f55f901`](https://github.com/talos-systems/talos/commit/d1f55f90128859d41ada63159d6b2d12e83fabac) fix: update blockdevice library to properly handle absent GPT
* [`5ac64b2d9`](https://github.com/talos-systems/talos/commit/5ac64b2d97c6e013c83a6618c6bece2e70dedd98) chore: set version in unit-tests
* [`20d39c0b4`](https://github.com/talos-systems/talos/commit/20d39c0b48b64f237270e13df7f277abd262d10b) chore: format .proto files
* [`852bf4a7d`](https://github.com/talos-systems/talos/commit/852bf4a7de815b75e2e632de18fae30bd1bc22be) feat: talosctl fish completion support
* [`6bb75150a`](https://github.com/talos-systems/talos/commit/6bb75150a394ee1ef4a3677ab4d8e73f27172209) fix: allow add_key and request_key in kubelet seccomp profile
* [`6487b21fe`](https://github.com/talos-systems/talos/commit/6487b21feb12291419c6fd1f6635a051b0a60afc) feat: update pkgs for u-boot, containerd, etc
* [`f7d1e7776`](https://github.com/talos-systems/talos/commit/f7d1e7776917475507aa99847f88b9c22c9f7b95) feat: provide SideroLink client implementation
* [`58892cd69`](https://github.com/talos-systems/talos/commit/58892cd697676c19f830f55e8ba1d84cd6000621) fix: unblock events watch on context cancel
* [`caa76be2c`](https://github.com/talos-systems/talos/commit/caa76be2c982d9d6bc8d3103f16b5915796f76b1) fix: containerd failed to load plugin
* [`1ffa8e048`](https://github.com/talos-systems/talos/commit/1ffa8e0480084264eee551ad177b2443ddb02ead) feat: add ULA prefix for SideroLink
* [`c6a67b866`](https://github.com/talos-systems/talos/commit/c6a67b8662bb3c6efbe912b19699ace19e70dd3f) fix: ignore not existing nodes on cordoning
* [`f73025257`](https://github.com/talos-systems/talos/commit/f730252579879df2e95878de292f17f791740804) feat: add new event types
* [`7c9b082f7`](https://github.com/talos-systems/talos/commit/7c9b082f74f26349a0e309d9818d5bc55e672378) feat: update Kubernetes to 1.23.0-beta.0
* [`750e31c4a`](https://github.com/talos-systems/talos/commit/750e31c4a46f2835eca9fc9a085d2bb64e582e40) fix: ignore EBUSY from `kexec_file_load`
* [`2d11b5955`](https://github.com/talos-systems/talos/commit/2d11b59558c98f4cd07a50b25be29b5c355a4495) fix: ignore virtual IP as kubelet node IPs
* [`030fd349b`](https://github.com/talos-systems/talos/commit/030fd349b1c0669d7059f8c6883c85096f6f9ef5) fix: don't run kexec prepare on shutdown and reset
* [`6dcce20e6`](https://github.com/talos-systems/talos/commit/6dcce20e6fa088c3063aab728912731f5e827eb7) test: set proper pod CIDR for Cilium tests
* [`695300dac`](https://github.com/talos-systems/talos/commit/695300dac46c114b8e7e40abdaeece25f7079c88) release(v0.14.0-alpha.1): prepare release
* [`753a82188`](https://github.com/talos-systems/talos/commit/753a82188f227da4f2f40da5f4d46ebe45774455) refactor: move pkg/resources to machinery
* [`0102a64a5`](https://github.com/talos-systems/talos/commit/0102a64a5f6de2c3fe5d7792c2c5845fc737edff) refactor: remove pkg/resources dependencies on wgtypes, netx
* [`7462733bc`](https://github.com/talos-systems/talos/commit/7462733bcb075b923b8c7ba4a763308c641c49a2) chore: update golangci-lint
* [`032c99a03`](https://github.com/talos-systems/talos/commit/032c99a0300ccb09105a07434884d2b1f57e537d) refactor: remove pkg/resources dependencies on k8s and base62
* [`4a5cff45f`](https://github.com/talos-systems/talos/commit/4a5cff45f397ac29b7bfc390f11691c32d8615b2) perf: raspberry PIs clockspeed as fast as firmware allows
* [`a76f6d69d`](https://github.com/talos-systems/talos/commit/a76f6d69dbfdf34e4383dd5d2ee9f8cca4661e87) feat: allow kubelet to be restarted and provide negative nodeIP subnets
* [`189221d58`](https://github.com/talos-systems/talos/commit/189221d589c1c9d4fc012dd9e31fd6d142d88dde) chore: update dependencies
* [`41f0aecc1`](https://github.com/talos-systems/talos/commit/41f0aecc1d3c4afce96d034f160fa9f120c67e85) docs: update partition info
* [`95105071d`](https://github.com/talos-systems/talos/commit/95105071de29f70552bd7c0881c2cc2e7c78c0ac) chore: fix simple issues found by golangci-lint
* [`d4b0ca21a`](https://github.com/talos-systems/talos/commit/d4b0ca21a1ee1183b28738bb3d9ca251e1968fe7) test: retry upgrade mutex lock failures
* [`4357e9a84`](https://github.com/talos-systems/talos/commit/4357e9a849fcb7fb66378bdd767a926dde0c4318) docs: add Talos partions info
* [`8e8687d75`](https://github.com/talos-systems/talos/commit/8e8687d7592d4bc071981478491d70489e7dd4a9) fix: use temporary sonobuoy version
* [`e4e8e8737`](https://github.com/talos-systems/talos/commit/e4e8e8737f564be47098e284706a63ef84636890) test: disable e2e-misc test with Canal CNI
* [`897da2f6e`](https://github.com/talos-systems/talos/commit/897da2f6efc571a66d14722a67bbc401bad31887) docs: common typos
* [`a50483ddd`](https://github.com/talos-systems/talos/commit/a50483dddfd9a742b998f509ee713af996a2484e) feat: update Linux to 5.15.1
* [`a2233bfe4`](https://github.com/talos-systems/talos/commit/a2233bfe46bfb55d71cfc07174f6f22aee6d2651) fix: improve NTP sync process
* [`7efc1238e`](https://github.com/talos-systems/talos/commit/7efc1238ee285d55c4619b6a40190b54ff953a66) fix: parse partition size correctly
* [`d6147eb17`](https://github.com/talos-systems/talos/commit/d6147eb17d2ebf263ca0537068bbbba6d3ced061) chore: update sonobuoy
* [`efbae7857`](https://github.com/talos-systems/talos/commit/efbae7857d09aa7e5e704d5989efced5aa655259) fix: use etc folder for du cli tests
* [`198eea51a`](https://github.com/talos-systems/talos/commit/198eea51a81bf041470c3c88cb6cb97af3a4e203) fix: wait for follow reader to start before writing to the file
* [`e7f715eb0`](https://github.com/talos-systems/talos/commit/e7f715eb0ca0587a05949910cafdeb486654b577) chore: log KubeSpan IPs overlaps
* [`82a1ad168`](https://github.com/talos-systems/talos/commit/82a1ad1681bf262dcc68fc9cbac71ff2eb5639af) chore: bump dependencies
* [`e8fccbf53`](https://github.com/talos-systems/talos/commit/e8fccbf5351ec2481813553181cb73b8f16c915a) fix: clear time adjustment error when setting time to specific value
* [`e6f90bb41`](https://github.com/talos-systems/talos/commit/e6f90bb41a757b5173bbbf7554b6f85c08aaf58e) chore: remove unused parameters
* [`785161d19`](https://github.com/talos-systems/talos/commit/785161d19f68fb64451cf3d887b67f85a8bcb952) feat: update k8s to 1.23.0-alpha.4
* [`fe228d7c8`](https://github.com/talos-systems/talos/commit/fe228d7c85a1f8437398061b18c090962adc9f29) fix: do not use yaml.v2 in the support cmd
* [`9b48ca217`](https://github.com/talos-systems/talos/commit/9b48ca21731cce53f0a61f05f74dcd264417d784) fix: endpoints and nodes in generated talosconfig
* [`6e16fd2fe`](https://github.com/talos-systems/talos/commit/6e16fd2feeb3f8bf0b99e6cbe21047b7a5c1f05c) chore: update tools, pkgs, and extras
* [`261c497c7`](https://github.com/talos-systems/talos/commit/261c497c71eb5ab5197bef05d8c209dbeb770d3f) feat: implement `talosctl support` command
* [`fc7dc4548`](https://github.com/talos-systems/talos/commit/fc7dc454840e100d82bb036a7f065293234593f7) chore: check our API idiosyncrasies
* [`b15844298`](https://github.com/talos-systems/talos/commit/b15844298a6bfedca5acc0cc27061666481eb94b) feat: use GCP deployment manager
* [`3e7d4df99`](https://github.com/talos-systems/talos/commit/3e7d4df99019e3cc6d9a90920d377c73a76ac577) chore: bump dependencies
* [`88f242295`](https://github.com/talos-systems/talos/commit/88f2422955690d1eca1e21cd60a35e1d49141e3d) refactor: get rid of prometheus/procfs dependency in pkg/resources
* [`dd196d300`](https://github.com/talos-systems/talos/commit/dd196d3006d29ae5cae5d43b648da1ca2e5af236) refactor: prepare for move of pkg/resources to machinery
* [`f6110f803`](https://github.com/talos-systems/talos/commit/f6110f8036bc176188abb583bfa51296c4d3897d) fix: remove listening socket to fix Talos in a container restart
* [`53bbb13ed`](https://github.com/talos-systems/talos/commit/53bbb13ed8592978dc27578fa79b3a2018941427) docs: update docs with emmc boot guide
* [`8329d2111`](https://github.com/talos-systems/talos/commit/8329d21114abf841788be64765378343c12eaf69) chore: split polymorphic RootSecret resource into specific types
* [`c97becdd9`](https://github.com/talos-systems/talos/commit/c97becdd9548d85b2b894a05765f93dcdf9ad803) chore: remove interfaces and routes APIs
* [`d798635d9`](https://github.com/talos-systems/talos/commit/d798635d993a21392b8a7972a689c4be0728db32) feat: automatically limit kubelet node IP family based on service CIDRs
* [`205a8d6dc`](https://github.com/talos-systems/talos/commit/205a8d6dc495e25af87bf0b920d0f55b8a27bbfd) chore: make nethelpers build on all OSes
* [`5b5dd49f6`](https://github.com/talos-systems/talos/commit/5b5dd49f64bef584000655687e5b9c5d25af6a93) feat: extract JSON fields from more log messages
* [`eb4f11822`](https://github.com/talos-systems/talos/commit/eb4f11822dc0b35541e0576a75ca263ca96d4981) docs: create cluster in hetzner cloud
* [`728164e25`](https://github.com/talos-systems/talos/commit/728164e25a5705ae5194b416941f3607d592b140) docs: fix kexec_load_disabled param name in release notes
* [`f6328f09a`](https://github.com/talos-systems/talos/commit/f6328f09a2bf8d233a48354dd548fb740e509341) fix: fix filename typo
* [`01b0f0abb`](https://github.com/talos-systems/talos/commit/01b0f0abb341b387f16d9b3a142af742f36c8c2b) release(v0.14.0-alpha.0): prepare release
* [`8b6206537`](https://github.com/talos-systems/talos/commit/8b6206537a30be049f74f8c4c7350028e6e56c74) fix: skip generating empty `.machine.logging`
* [`60ad00636`](https://github.com/talos-systems/talos/commit/60ad006367e73f56fd69726e0044f1ce48f18a8b) fix: don't drop ability to use ambient capabilities
* [`b6b78e7fe`](https://github.com/talos-systems/talos/commit/b6b78e7fef3f6ef0c566e1815d1e28f16f868c93) test: add cluster discovery integration tests
* [`97d64d160`](https://github.com/talos-systems/talos/commit/97d64d160ce7e71c3107adbd31404853f543f7cc) fix: hcloud network config changes
* [`4c76865d0`](https://github.com/talos-systems/talos/commit/4c76865d0ecec726e801a4b8f87e09476481d808) feat: multiple logging improvements
* [`1d1e1df64`](https://github.com/talos-systems/talos/commit/1d1e1df643832478aaa715aea5f51ad2e61e2880) fix: handle skipped mounts correctly
* [`0a964d921`](https://github.com/talos-systems/talos/commit/0a964d921922a247293e36b5fecaab466b91d924) test: fix openstack unit-test stability
* [`72f62ac27`](https://github.com/talos-systems/talos/commit/72f62ac27b5d0a72db409fd003a7cf9c41a03d7c) chore: bump Go and Docker dependencies
* [`9c48ebe8f`](https://github.com/talos-systems/talos/commit/9c48ebe8f94afa85921ee5f1c1e9315201905a92) fix: gcp fetching externalIP
* [`6c297268c`](https://github.com/talos-systems/talos/commit/6c297268ce596c2a875b7c419c85317dc24d9f4f) test: fix e2e k8s version
* [`ae5af9d3f`](https://github.com/talos-systems/talos/commit/ae5af9d3fad399dea95c316d94e3e66b124bfb24) feat: update Kubernetes to 1.23.0-alpha.3
* [`28d3a69e9`](https://github.com/talos-systems/talos/commit/28d3a69e9d4ae7ffa231804e26af6d1f39c07afd) feat: openstack config-drive support
* [`2258bc491`](https://github.com/talos-systems/talos/commit/2258bc4918e89b3d6fcb841b2ad677f114ddba7e) test: update GCP e2e script to work with new templates
* [`36b6ace25`](https://github.com/talos-systems/talos/commit/36b6ace25378e8c4a607de6efb6b89a2d52f5cea) feat: update Linux to 5.10.75
* [`38516a549`](https://github.com/talos-systems/talos/commit/38516a5499d933a8038ce6768946ff096e7c6f98) test: update Talos versions in upgrade tests
* [`cff20ec78`](https://github.com/talos-systems/talos/commit/cff20ec78340b3855751e13f2ad0e54bd47e9989) fix: change services OOM score
* [`666a2b620`](https://github.com/talos-systems/talos/commit/666a2b6207d257edda20c9e0411b0d4cd4112aa6) feat: azure platform ipv6 support
* [`d32814e30`](https://github.com/talos-systems/talos/commit/d32814e302c370ec1e82aa2879186a034cd2a905) feat: extract JSON fields from log lines
* [`e77d81fff`](https://github.com/talos-systems/talos/commit/e77d81fff31d68f762da3741846f95a6d2303903) fix: treat literal 'unknown' as a valid machine type
* [`c8e404e35`](https://github.com/talos-systems/talos/commit/c8e404e356878f6cd819a33386b351c1c152c3f5) test: update vars for AWS cluster
* [`ad23891b1`](https://github.com/talos-systems/talos/commit/ad23891b1f6b33409721528c6771304b7ab94b2c) feat: update CoreDNS version 1.8.6
* [`41299cae9`](https://github.com/talos-systems/talos/commit/41299cae9961665c2bf2a642290f8309683f040d) feat: udev rules support
* [`5237fdc95`](https://github.com/talos-systems/talos/commit/5237fdc957efbb018649b866bfb756f280f589a2) feat: send JSON logs over UDP
* [`6d44587a4`](https://github.com/talos-systems/talos/commit/6d44587a4d4c16defa6bb06329cdfc6e39c95188) feat: coredns service dualstack
* [`12f7888b7`](https://github.com/talos-systems/talos/commit/12f7888b75fa2498e0f8305f5d6910cecad5c65c) feat: feed control plane endpoints on workers from cluster discovery
* [`431e4fb4b`](https://github.com/talos-systems/talos/commit/431e4fb4b690fa4955c407d8dd8156bdecd9a2c5) chore: bump Go and Docker dependencies
* [`89f3b9f8d`](https://github.com/talos-systems/talos/commit/89f3b9f8d41e33c4cb736917f418ab5cfb9edd83) feat: update etcd to 3.5.1
* [`e60469a38`](https://github.com/talos-systems/talos/commit/e60469a38cb81ace2039bae1927eb6c5f1f0ad1f) feat: initial support for JSON logging
* [`68c420e3c`](https://github.com/talos-systems/talos/commit/68c420e3c96a0fdc3b3e6cd75be24cc797c48e09) feat: enable cluster discovery by default
* [`3e100aa97`](https://github.com/talos-systems/talos/commit/3e100aa97734ea809563e23fc36e19bdd3df1920) test: workaround EventsWatch test flakiness
* [`9bd4838ac`](https://github.com/talos-systems/talos/commit/9bd4838ac10abbd4760da4fb905d7639a1c26f9f) chore: stop using sonobuoy CLI
* [`6ad459519`](https://github.com/talos-systems/talos/commit/6ad45951975aac48fdcc282e5a0e31344058d07e) docs: fix field names for bonding configuration
* [`d7a3b7b5b`](https://github.com/talos-systems/talos/commit/d7a3b7b5b70293884d2e19c6a59b14ebcfa24397) chore: use discovery-client and discovery-api modules
* [`d6309eed6`](https://github.com/talos-systems/talos/commit/d6309eed6618abd1b4efd0e3cd18a6c0df39378f) docs: create docs for Talos 0.14
* [`c0fda6436`](https://github.com/talos-systems/talos/commit/c0fda6436ae27d8bbc210ee74a1128968108f6a6) fix: attempt to clean up tasks in containerd runner
* [`8cf442daa`](https://github.com/talos-systems/talos/commit/8cf442daa60d911caff59d1c2c05dd77652c8b51) chore: bump tools, pkgs, extras
* [`0dad5f4d7`](https://github.com/talos-systems/talos/commit/0dad5f4d7846f3fb41ff4ba27395023d33796a61) chore: small cleanup
* [`e3e2113ad`](https://github.com/talos-systems/talos/commit/e3e2113adc058940725b1041827d7adb8895c6cf) feat: upgrade CoreDNS during `upgrade-k8s` call
* [`d92c98e19`](https://github.com/talos-systems/talos/commit/d92c98e19a054472bff3e0d646756f16c5e65bbf) docs: fix discovery service documentation link
* [`e44b11c59`](https://github.com/talos-systems/talos/commit/e44b11c595e4cab796128a932843b90734ff6d1d) feat: update containerd to 1.5.7, bump Go dependencies
* [`24129307a`](https://github.com/talos-systems/talos/commit/24129307a14d6e59c6bc0d3586c0c95969bde679) docs: make Talos 0.13 docs latest, update documentation
* [`31b6e39e5`](https://github.com/talos-systems/talos/commit/31b6e39e58a27e1f2c1be500fca8636971bfa5c6) fix: delete expired affiliates from the discovery service
* [`877a2b6fc`](https://github.com/talos-systems/talos/commit/877a2b6fc00eaa7574349f9086d78c04df163840) test: bump CAPI components to v1alpha4
* [`2ba0e0ac4`](https://github.com/talos-systems/talos/commit/2ba0e0ac4ad460409101f5f2374e66698adbba4c) docs: add KubeSpan documentation
* [`997873b6d`](https://github.com/talos-systems/talos/commit/997873b6d3116b59ebb46df66b8aa1cee06df92f) fix: use ECDSA-SHA512 when generating certs for Talos < 0.13
* [`7137166d1`](https://github.com/talos-systems/talos/commit/7137166d1d5817e2d44ead4a01796275f92a9d4a) fix: allow overriding `audit-policy-file` in `kube-apiserver` static pod
* [`8fcd42196`](https://github.com/talos-systems/talos/commit/8fcd4219671a9359880ba344a2ec7fd65dfe5e2a) chore: fix integration-qemu-race
* [`91a858b53`](https://github.com/talos-systems/talos/commit/91a858b53704ede86392fe3c155ce9ab3c2d406f) fix: sort output of the argument builder
* [`657f7a56b`](https://github.com/talos-systems/talos/commit/657f7a56b10089e0dc551e178bc85b28d8003243) fix: use ECDSA-SHA256 signature algorithm for Kubernetes certs
* [`983d2459e`](https://github.com/talos-systems/talos/commit/983d2459e2aa036774828f773bbaba5697665ae7) feat: suppress logging NTP sync to the console
* [`022c7335f`](https://github.com/talos-systems/talos/commit/022c7335f3063675ab744454a2ad4b2c0c19bfbc) fix: add interface route if DHCP4 router is not directly routeable
* [`66a1579ea`](https://github.com/talos-systems/talos/commit/66a1579ea7d2a9c4fdf15b762cd024c54b3e8ffb) fix: don't enable 'no new privs' on the system level
* [`423861cf9`](https://github.com/talos-systems/talos/commit/423861cf9f99eaf034a4f0cb243d73d1275c3f38) feat: don't drop capabilities if kexec is disabled
* [`facc8c38a`](https://github.com/talos-systems/talos/commit/facc8c38a021610da900a45f397aea8ddfc74f1c) docs: fix documentation for cluster discovery
* [`ce65ca4e4`](https://github.com/talos-systems/talos/commit/ce65ca4e4a2994f901f01ce5ca269d6df86f0de8) chore: build using only amd64 builders
* [`e9b0f010d`](https://github.com/talos-systems/talos/commit/e9b0f010d2855b968a5d8b8b5fbcd268e06ba302) chore: update docker image in the pipeline
</p>
</details>
...
* [`d6b73a7`](https://github.com/talos-systems/extras/commit/d6b73a799b76053499b5114c987281a40a7e98bf) feat: update Go to 1.17.5
* [`bc66403`](https://github.com/talos-systems/extras/commit/bc664037d1e11aad6c82f92cd357b0347214571f) chore: update pkgs and tools to 0.9.0
* [`d5ffdd8`](https://github.com/talos-systems/extras/commit/d5ffdd8c1bdb6792ef88f52da3c9d7926ce41f03) feat: update Go to 1.17.4
* [`50fc401`](https://github.com/talos-systems/extras/commit/50fc401e06b4660269ac4418428926f8f5bfe77e) feat: include flannel CNI plugin into install-cni package
...
* [`7a3419a`](https://github.com/talos-systems/pkgs/commit/7a3419a27b88e314c7126a2abbf076fa49f53e7b) feat: update Go to 1.17.5
* [`4534074`](https://github.com/talos-systems/pkgs/commit/45340743caba2aea7ce0c6a2a44e569546c103c6) feat: update tools to 0.9.0
* [`4112eed`](https://github.com/talos-systems/pkgs/commit/4112eed2234cf74c9fd4a7da9663b2ebfe08f730) feat: update runc to 1.0.3
* [`49f3c17`](https://github.com/talos-systems/pkgs/commit/49f3c1705b0416fc10fa04b77c2a2f6717dfe209) feat: enable additional support for RPi hardware
* [`7c066d0`](https://github.com/talos-systems/pkgs/commit/7c066d0abc99675f329fe07d7fd48595997e7087) feat: update Go to 1.17.4
* [`4b55a29`](https://github.com/talos-systems/pkgs/commit/4b55a29e66d36a1ab3a9399aafcde3e735bb976b) feat: update Linux to 5.15.6
* [`80a5f97`](https://github.com/talos-systems/pkgs/commit/80a5f97669e56ebbe3a966c770b9a63fe18dffdb) feat: update CNI to 1.0.1, separate package for flannel
...
* [`b1146f9`](https://github.com/talos-systems/tools/commit/b1146f924ec4dec25bf806ac81e9c2486dd8fc75) feat: update Go to 1.17.5
* [`86ce921`](https://github.com/talos-systems/tools/commit/86ce921b9dcf579f3274a6ada6e0dfa8b07a5e51) chore: bump toolchain to the final 0.4.0 version
* [`cc8426b`](https://github.com/talos-systems/tools/commit/cc8426bf52f94d6882fafeddd2f1ca5432d4de30) feat: update Go to 1.17.4
* [`aacbc5b`](https://github.com/talos-systems/tools/commit/aacbc5b82db76d5ec58cec5c9fe21286f35676c0) feat: update toolchain with Linux headers 5.15
...
* **go.uber.org/atomic**                             v1.9.0 **_new_**
...
* **k8s.io/component-base**                          v0.23.1 **_new_**
...
## [Talos 0.14.0-beta.1](https://github.com/talos-systems/talos/releases/tag/v0.14.0-beta.1) (2021-12-13)
...
### Changes
<details><summary>172 commits</summary>
<p>

* [`02796f88`](https://github.com/talos-systems/talos/commit/02796f8893b8af489cdb36e9f81a7c027f83753e) fix: allow kubelet to be started via the API
* [`e69eacae`](https://github.com/talos-systems/talos/commit/e69eacae1042819fe8320c120e8b1518ebea81ba) fix: use default time servers in time API if none are configured
* [`c60e153a`](https://github.com/talos-systems/talos/commit/c60e153a1b7f1e3c546141dcb3ead73d59079028) fix: cleanup affiliates
* [`301f9e4e`](https://github.com/talos-systems/talos/commit/301f9e4e0331d857fdcd14330a0e28f8dde4b9a8) feat: update Kubernetes to 1.23.0
* [`fe2e953a`](https://github.com/talos-systems/talos/commit/fe2e953afe543836171f5a4f7ffe27bd0b4b2c1e) feat: upgrade kubelet version in `talosctl upgrade-k8s`
* [`4daff789`](https://github.com/talos-systems/talos/commit/4daff78957488b53fe87461b7d3c78fd31e5f3a3) chore: update Go to 1.17.5
* [`35cb34bd`](https://github.com/talos-systems/talos/commit/35cb34bd55e8da409ff4abfb6335d7bf443cc7d5) release(v0.14.0-beta.0): prepare release
...
* **k8s.io/component-base**                          v0.23.0 **_new_**
...
## [Talos 0.14.0-beta.0](https://github.com/talos-systems/talos/releases/tag/v0.14.0-beta.0) (2021-12-07)
...
* **k8s.io/component-base**                          v0.23.0-rc.1 **_new_**
