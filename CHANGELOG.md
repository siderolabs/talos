...
This release of Talos provides initial support for [cluster membership discovery](https://www.talos.dev/docs/v0.13/guides/discovery/) and [KubeSpan](https://www.talos.dev/docs/v0.13/guides/kubespan/).
...
### Changes
<details><summary>120 commits</summary>
<p>

* [`d5072858`](https://github.com/talos-systems/talos/commit/d50728580ae6f138b7cbd0b5e878e92330e1eeb5) fix: allow overriding `audit-policy-file` in `kube-apiserver` static pod
* [`98759512`](https://github.com/talos-systems/talos/commit/98759512e520178777a1d3d7ddc53344c5ba613d) fix: use ECDSA-SHA512 when generating certs for Talos < 0.13
* [`fd5c4777`](https://github.com/talos-systems/talos/commit/fd5c477710aaf003329536a283e5305b593b08d2) fix: use ECDSA-SHA256 signature algorithm for Kubernetes certs
* [`ccc210ea`](https://github.com/talos-systems/talos/commit/ccc210ead2a49deae10588b98a297097d3026492) chore: fix integration-qemu-race
* [`7457d793`](https://github.com/talos-systems/talos/commit/7457d7939a596de2a5ef255108c53a5b79f69ad2) release(v0.13.0-beta.1): prepare release
* [`250529e1`](https://github.com/talos-systems/talos/commit/250529e19b06793738cd8a9b8ef76796cc25681d) fix: revert use ECDSA-SHA256 signature algorithm for Kubernetes certs
* [`a3ac9bfd`](https://github.com/talos-systems/talos/commit/a3ac9bfd8442b1b1499ad741ec9c956ed480af55) fix: sort output of the argument builder
* [`81c38992`](https://github.com/talos-systems/talos/commit/81c3899269ea749108fa22f9fc7b3c4619009655) fix: use ECDSA-SHA256 signature algorithm for Kubernetes certs
* [`bc3e07f6`](https://github.com/talos-systems/talos/commit/bc3e07f68fbe202f516d1a962145940c4a0c432c) feat: suppress logging NTP sync to the console
* [`27a695be`](https://github.com/talos-systems/talos/commit/27a695be51482fc4572f057c72eeb19bc9cf1c8f) fix: add interface route if DHCP4 router is not directly routeable
* [`c55b4a5e`](https://github.com/talos-systems/talos/commit/c55b4a5eec2b47b301aa70be93fcef5d529ed0d3) fix: don't enable 'no new privs' on the system level
* [`3ecec6ec`](https://github.com/talos-systems/talos/commit/3ecec6eccea2cc94a286330b135f8d12326a70e8) chore: build using only amd64 builders
* [`d2c7e855`](https://github.com/talos-systems/talos/commit/d2c7e855ce2857ca85ef81a50dc775b0dfeb5c9b) chore: update docker image in the pipeline
* [`e82a443e`](https://github.com/talos-systems/talos/commit/e82a443e82442e11c91e3e1c203004d450fd7075) release(v0.13.0-beta.0): prepare release
...
* [`ee4b2a4`](https://github.com/talos-systems/discovery-service/commit/ee4b2a4098d1c34991e2ef8cf242f85d01e1648b) fix: retry on Hello failures
* [`ab9c7c9`](https://github.com/talos-systems/discovery-service/commit/ab9c7c98dca3f4d83640dfe0d720d8a557f260be) chore: add Prometheus metrics
...
* [`9706baf`](https://github.com/talos-systems/extras/commit/9706baf4e7734d09e748f51b41209068545adb44) chore: use tagged versions tools and pkgs 0.8.0
* [`8738709`](https://github.com/talos-systems/extras/commit/873870959ed5e62fb3591f3e18b8522a32481e93) chore: update pkgs and tools
...
* [`3148f01`](https://github.com/talos-systems/pkgs/commit/3148f01aba9a95d2bdbf419852a1a27f03777e74) chore: update tools to tagged version 0.8.0
* [`f22ce18`](https://github.com/talos-systems/pkgs/commit/f22ce181d8dae3481a011772e92029d6ef351cc5) feat: update containerd to 1.5.6, runc to 1.0.2, libseccomp to 2.5.2
...
* [`835b297`](https://github.com/talos-systems/tools/commit/835b2970d4c4b6f94c5ebc06cc330f2aa997e450) chore: use tagged toolchain 0.3.0
...
* **github.com/talos-systems/discovery-service**     v0.1.0 **_new_**
...
## [Talos 0.13.0-beta.1](https://github.com/talos-systems/talos/releases/tag/v0.13.0-beta.1) (2021-10-08)
...
## [Talos 0.13.0-beta.0](https://github.com/talos-systems/talos/releases/tag/v0.13.0-beta.0) (2021-10-01)
...
### Changes
<details><summary>106 commits</summary>
<p>
