## [Talos 0.12.3](https://github.com/talos-systems/talos/releases/tag/v0.12.3) (2021-09-28)
...
### Changes
<details><summary>148 commits</summary>
<p>

* [`07c87a1b6`](https://github.com/talos-systems/talos/commit/07c87a1b6018fd9cb2d2301668e3e01de4d49bdf) fix: check trustd API CA on worker nodes
* [`ce1226b2f`](https://github.com/talos-systems/talos/commit/ce1226b2f8231d978ae3212107ee386d39528812) fix: check for existence of dhcp6 FQDN first
* [`ed94d504a`](https://github.com/talos-systems/talos/commit/ed94d504a582649aa516e9b97eba1f98f6463891) fix: containerd log symlink
* [`7e63e43eb`](https://github.com/talos-systems/talos/commit/7e63e43eb399c27a30cd2ce2aa2603f174826fec) fix: don't marshal clock with SecretsBundle
* [`f195bf537`](https://github.com/talos-systems/talos/commit/f195bf537d1ee4a5831876d9578686d73212d045) release(v0.12.2): prepare release
* [`7b4a6b361`](https://github.com/talos-systems/talos/commit/7b4a6b3619e2ab55d6c588c9f1a018504f127664) fix: patch multi nodes support
* [`ccb24bc18`](https://github.com/talos-systems/talos/commit/ccb24bc18e22f6e31b48e8dcaba6171a3629a1f5) feat: update Kubernetes to 1.22.2
* [`110551865`](https://github.com/talos-systems/talos/commit/110551865df08c59d4e1c47bdeab6515a0691ff0) fix: tear down control plane static pods when etcd is stopped
* [`5824f5024`](https://github.com/talos-systems/talos/commit/5824f5024e4b51e6e88940e187bbac4e2fb35bd1) fix: completely prevent editing resources other than mc
* [`5700c81bf`](https://github.com/talos-systems/talos/commit/5700c81bf66392477588a6229af48925bbf888bf) fix: write KubernetesCACert chmodded 0400 instead of 0500
* [`6adaee33a`](https://github.com/talos-systems/talos/commit/6adaee33a76a4a9561331c09dcfc0f074bb9fc5c) release(v0.12.1): prepare release
* [`a72fa2a93`](https://github.com/talos-systems/talos/commit/a72fa2a931c39db584cac99d3c38e8e005e8efc2) fix: correctly define example for `extraMounts`
* [`ff9681a74`](https://github.com/talos-systems/talos/commit/ff9681a74e4927e147753aed6a283b2d9ad22c29) release(v0.12.0): prepare release
* [`75ce68d90`](https://github.com/talos-systems/talos/commit/75ce68d909309e019c4a37ce5e7bcb6eda8aa1e4) release(v0.12.0-beta.2): prepare release
* [`87c258093`](https://github.com/talos-systems/talos/commit/87c258093a17dd5725b84377a3f42270c977df63) fix: allow updating diskSelector option
* [`eba00723d`](https://github.com/talos-systems/talos/commit/eba00723d3df0d8be30c9d3931421117ea74deea) fix: don't extract nil IPs in the GCP platform
* [`3a38f0ded`](https://github.com/talos-systems/talos/commit/3a38f0deda18906b785b1ad76872a78b689eb171) fix: properly handle omitempty fields in the validator
* [`2e220cb65`](https://github.com/talos-systems/talos/commit/2e220cb65876e5ee0153afe67e1929beacd27152) fix: validate IP address returned as HTTP response in platform code
* [`b63a2ea0e`](https://github.com/talos-systems/talos/commit/b63a2ea0e230046fca327c420250b25d722febf5) fix: don't allow bootstrap if etcd data directory is not empty
* [`cd0532848`](https://github.com/talos-systems/talos/commit/cd0532848f80625c67ff98947d206c7faf4d27c7) fix: cgroup delegate
* [`e22301e76`](https://github.com/talos-systems/talos/commit/e22301e762e6f112d64d9fb3a91cb9b4db877b4e) chore: fix arm64 reproducibility issues
* [`30e1ff614`](https://github.com/talos-systems/talos/commit/30e1ff614220c4531e135cef89bd1519fd2b1e27) release(v0.12.0-beta.1): prepare release
* [`7630d998f`](https://github.com/talos-systems/talos/commit/7630d998fbbbd0be011ebab1173d09411653ad5a) chore: don't require single commit per PR
* [`208ac9ac4`](https://github.com/talos-systems/talos/commit/208ac9ac450c615b561fb4be0d398edc738d10d9) feat: update Kubernetes to 1.22.1
* [`e84e2902c`](https://github.com/talos-systems/talos/commit/e84e2902c1b832c270af362a0ae0870c38ecec41) fix: don't support cgroups nesting in process runner
* [`2cf53fb34`](https://github.com/talos-systems/talos/commit/2cf53fb3408d244f76d67da164387be75afdfc77) fix: do not set KSPP kernel params in container mode
* [`1908f57c6`](https://github.com/talos-systems/talos/commit/1908f57c6b6aadc1b558d672917f9dceb24301bb) test: adapt tests to the cgroupsv2
* [`4bb84ea0c`](https://github.com/talos-systems/talos/commit/4bb84ea0c6d63abe2020d2b9530b19ce2ad9f71d) fix: extramount should have `yaml:",inline"` tag
* [`e948560be`](https://github.com/talos-systems/talos/commit/e948560be1b0c479fad72ba734cf66fe987ba0ee) fix: don't panic if the machine config doesn't have network (EM)
* [`a5726f2e6`](https://github.com/talos-systems/talos/commit/a5726f2e690d0c84f83a6dfb900306e0a9e818c2) chore: do not check that go mod tidy gives empty output
* [`67494923b`](https://github.com/talos-systems/talos/commit/67494923be54c308adca1ccae490a14fec906894) fix: make sure file mode is same (reproducibility issue)
* [`65292880a`](https://github.com/talos-systems/talos/commit/65292880a0496b55bb87b6fbd13a10679e6c990b) feat: check if cluster has deprecated resources versions
* [`7a0eb5fa2`](https://github.com/talos-systems/talos/commit/7a0eb5fa25e5baae9b9fa897bba6b6dd238a91a8) release(v0.12.0-beta.0): prepare release
* [`c601dc73f`](https://github.com/talos-systems/talos/commit/c601dc73f6d08c031afaf4193c2fe5740b9f29c5) chore: update versions to final release tags
* [`82731124b`](https://github.com/talos-systems/talos/commit/82731124b2c7ce08e740fbcd350abaceeb08b103) chore: run e2e-qemu test against Talos with race-detector enabled
* [`37ea2c9ca`](https://github.com/talos-systems/talos/commit/37ea2c9ca240c92f93c61ca640e9b4bb27bf91ec) feat: support for route source addresses in the configuration
* [`0ef8f83ac`](https://github.com/talos-systems/talos/commit/0ef8f83acfa509700b241e86ebdaf79b5b9a517d) chore: bump dependencies via dependabot
* [`2108fd7b6`](https://github.com/talos-systems/talos/commit/2108fd7b6c90c4266518a0c28398f9b74a53968b) feat: update Linux to 5.10.58 and many pkgs updates
* [`6ee690d9a`](https://github.com/talos-systems/talos/commit/6ee690d9a778c559b5cc528147bb0db5e808914e) release(v0.12.0-alpha.1): prepare release
* [`1ed5e5453`](https://github.com/talos-systems/talos/commit/1ed5e545385e160fe3b61e6dbbcaa8a701437b62) feat: add ClusterID and ClusterSecret
* [`228b37616`](https://github.com/talos-systems/talos/commit/228b376163597cd825e4a142e6b4bdea0f870365) chore: run etcd as non-root user
* [`3518219bf`](https://github.com/talos-systems/talos/commit/3518219bff44f71a60ad8e448e518844d1b933fd) chore: drop deprecated `--no-reboot` param and KernelCurrentRoot const
* [`33d1c3e42`](https://github.com/talos-systems/talos/commit/33d1c3e42582649f25a44fc3c86007bcebbc80b3) chore: run apid and trustd services as non-root user
* [`dadaa65d5`](https://github.com/talos-systems/talos/commit/dadaa65d542171d25317840fcf35fa3979cf0632) feat: print uid/gid for the files in `ls -l`
* [`e6fa401b6`](https://github.com/talos-systems/talos/commit/e6fa401b663d0ebd4374c9e47a7ca6150a4756cd) fix: enable seccomp default profile by default
* [`8ddbcc964`](https://github.com/talos-systems/talos/commit/8ddbcc9643113c15de538fc070b7053d1c6efdfc) feat: validate if extra fields present in the decoder
* [`5b57a9800`](https://github.com/talos-systems/talos/commit/5b57a98008c64d7cb07729fd9b31a0e3493c289c) chore: update Go to 1.16.7, Linux to 5.10.57
* [`eefe1c21c`](https://github.com/talos-systems/talos/commit/eefe1c21c30fa2cd281fc5524b2e88553f6fdfcc) feat: add new etcd members in learner mode
* [`b1c66fbad`](https://github.com/talos-systems/talos/commit/b1c66fbad113400729cf4db806e30192bf7e0462) feat: implement Equinix Metal support for virtual (shared) IP
* [`62242f979`](https://github.com/talos-systems/talos/commit/62242f979e1921ed8abfa06a26564ea0bf8a5fb3) chore: require GPG signatures
* [`faecae44f`](https://github.com/talos-systems/talos/commit/faecae44fde60fc626ccb01da3b221519a9d41d7) feat: make ISO builds reproducible
* [`887c2326a`](https://github.com/talos-systems/talos/commit/887c2326a4f81c846e3aa3bd1787bc840877e494) release(v0.12.0-alpha.0): prepare release
* [`a15f01844`](https://github.com/talos-systems/talos/commit/a15f01844fdaf0d3e2dad2750d9353d03e18dea2) fix: move etcd PKI under /system/secrets
* [`eb02afe18`](https://github.com/talos-systems/talos/commit/eb02afe18be63bf483a0467f655611561aef10f6) fix: match correctly routes on the address family
* [`cb948accf`](https://github.com/talos-systems/talos/commit/cb948accfeca13c57b3b512dc8a06425989294f9) feat: allow multiple addresses per interface
* [`e030b2e8b`](https://github.com/talos-systems/talos/commit/e030b2e8bb0a65abf4e1f7b5f27348631210ebc4) chore: use k8s 1.21.3 in CAPI tests for now
* [`e08b4f8f9`](https://github.com/talos-systems/talos/commit/e08b4f8f9e72f8db1116b4bbe395d49b4bccb460) feat: implement sysctl controllers
* [`fdf6b2433`](https://github.com/talos-systems/talos/commit/fdf6b2433c40613bcb039852a96196dbe9b7b5e2) chore: revert "improve artifacts generation reproducibility"
* [`b68ed1eb8`](https://github.com/talos-systems/talos/commit/b68ed1eb896039ec1319db2e3d6d364034c86863) fix: make route resources ID match closer routing table primary key
* [`585f63371`](https://github.com/talos-systems/talos/commit/585f633710abb7a6d863b54c37aa65c50a3c7312) fix: correctly handle nodoc for struct fields
* [`f2d394dc4`](https://github.com/talos-systems/talos/commit/f2d394dc42f9ec704050db0a8a928a889483ce3e) docs: add AMIs for v0.11.5
* [`d0970cbfd`](https://github.com/talos-systems/talos/commit/d0970cbfd696b28b201b232a03da2119f664afbd) feat: bootstrap token limit
* [`5285a46d7`](https://github.com/talos-systems/talos/commit/5285a46d78ef2fc76594aad4ad4acb75312bc0a7) fix: maintenance mode reason message
* [`009d15e8d`](https://github.com/talos-systems/talos/commit/009d15e8dc6e75eca6b5963dddf8063941099f14) chore: use etcd client TryLock function on upgrade
* [`4dae9ea55`](https://github.com/talos-systems/talos/commit/4dae9ea55c087c28a9d7a8d241e0ec3a7a1b8ca3) chore: use vtprotobuf compiled marshaling in Talos API
* [`7ca5749ad`](https://github.com/talos-systems/talos/commit/7ca5749ad4267701ce639d0f0d91c10a7f9c1d3d) chore: bump dependencies via dependabot
* [`b2507b41d`](https://github.com/talos-systems/talos/commit/b2507b41d250b989b9c13ad23e16202cd53a18d2) chore: improve artifacts generation reproducibility
* [`1f7dad234`](https://github.com/talos-systems/talos/commit/1f7dad234b480c7a5e3484ccf10180747c979036) chore: update PKGS version (512 cpus, new ca-certficates)
* [`1a2e78a24`](https://github.com/talos-systems/talos/commit/1a2e78a24e997241c4cd18dfac3c2d971ba78116) fix: update go-blockdevice
* [`6d6ed1170`](https://github.com/talos-systems/talos/commit/6d6ed1170f3f28e7f559ccdf64e7c34dfee022a0) chore: use parallel xz with higher compression level
* [`571f7db1b`](https://github.com/talos-systems/talos/commit/571f7db1bb44a0dcb5e373f9c37396d50eb0e8f4) chore: workaround GitHub new release notes limit
* [`09d70b7ea`](https://github.com/talos-systems/talos/commit/09d70b7eafb18343eb4ca57d7f8b84e4ccd2fcfb) feat: update Kubernetes to v1.22.0
* [`f25f10e73`](https://github.com/talos-systems/talos/commit/f25f10e73ec534acd7cc483f254d612d8a7c1858) feat: add an option to disable PSP
* [`7c6e4cf23`](https://github.com/talos-systems/talos/commit/7c6e4cf230ba1f30da664374c41c934d1e6620bc) feat: allow both DHCP and static addressing for the interface
* [`3c566dbc3`](https://github.com/talos-systems/talos/commit/3c566dbc30595467a3789707c6e993aa92f36df6) fix: remove admission plugins enabled by default from the list
* [`69ead3735`](https://github.com/talos-systems/talos/commit/69ead37353b7e3aa7f089c70073037a6eba37767) fix: preserve PMBR bootable flag correctly
* [`dee630517`](https://github.com/talos-systems/talos/commit/dee63051702d49f495bfb28b4be74ed8b39143ad) fix: align partitions with minimal I/O size
* [`628902297`](https://github.com/talos-systems/talos/commit/628902297d2efe93e6388377b2ea6d4beda83095) feat: update GRUB to 2.06
* [`b9d04928d`](https://github.com/talos-systems/talos/commit/b9d04928d960f9d576671c6f3511cf242ff31cb7) feat: move system processes to cgroups
* [`0b8681b4b`](https://github.com/talos-systems/talos/commit/0b8681b4b49ab109b8863792d48c2f551d1ceeb5) fix: resolve several issues with Wireguard link specs
* [`f8f4bf3ba`](https://github.com/talos-systems/talos/commit/f8f4bf3baef31d4ac957ec68cd869adea1e931cd) docs: add disk encryptions examples
* [`79b8fa64b`](https://github.com/talos-systems/talos/commit/79b8fa64b9453917860faae3df5d14647186b9ba) feat: update containerd to 1.5.5
* [`539f42090`](https://github.com/talos-systems/talos/commit/539f42090e436921a23087296cde6eaf7e495b5e) chore: bump dependencies via dependabot
* [`0c7ce1cd8`](https://github.com/talos-systems/talos/commit/0c7ce1cd814354213a1a6c7a9251b166ee58c493) feat: remove remnants of bootkube support
* [`d4f9804f8`](https://github.com/talos-systems/talos/commit/d4f9804f8659562f6152ae73cb1788f6f6d6ad89) chore: fix typos
* [`5f027615f`](https://github.com/talos-systems/talos/commit/5f027615ffac68e0a484a5da4827a6589bae3880) feat: expose more encryption options to the machine config
* [`585152a0b`](https://github.com/talos-systems/talos/commit/585152a0be051accd4cb8b7c2f130c5a92dfd32d) chore: bump dependencies
* [`fc66ec596`](https://github.com/talos-systems/talos/commit/fc66ec59691fb1b9d00b27e1f7b34c870a09d717) feat: set oom score for main processes
* [`df54584a3`](https://github.com/talos-systems/talos/commit/df54584a33d88de13deadcb87a5cfa9c1f9b3961) fix: drop linux capabilities
* [`f65d0b739`](https://github.com/talos-systems/talos/commit/f65d0b739bd36a57979f9bf26c3092ac544e607c) docs: add 0.11.3 AMIs
* [`7332d6369`](https://github.com/talos-systems/talos/commit/7332d63695074dd5eef35ad545d48aff857fbde8) fix: bump pkgs for new kernel 5.10.52
* [`70d2505b7`](https://github.com/talos-systems/talos/commit/70d2505b7c8807cb5d4f8a017f9f6200757e13e0) fix: do not require ToVersion to be set when detecting version
* [`0953b1998`](https://github.com/talos-systems/talos/commit/0953b1998579f855adffff4b83db917f26687a7b) chore: update extras to bring a new CNI bundle
* [`b6c47f866`](https://github.com/talos-systems/talos/commit/b6c47f866a57bafb60f85fb1ce10428ed3f52c4a) fix: set the /etc/os-release HOME_URL parameter
* [`c780821d0`](https://github.com/talos-systems/talos/commit/c780821d0b8fda0b3ef6d33b63b595e40970a897) feat: update containerd to 1.5.3, runc to 1.0.1
* [`f8f1c83a7`](https://github.com/talos-systems/talos/commit/f8f1c83a757f5a729896174f95f83c6d804d4858) feat: detect the lowest Kubernetes version in upgrade-k8s CLI command
* [`55e17ccdd`](https://github.com/talos-systems/talos/commit/55e17ccdd1df789466ccfb0c9cfe55a62b437f77) chore: bump dependencies
* [`da6f786ca`](https://github.com/talos-systems/talos/commit/da6f786cab80cbacb886d34b7c5e0ed957cc24c9) fix: kuberentes => kubernetes typo
* [`2e463348b`](https://github.com/talos-systems/talos/commit/2e463348b26fb8b36657b8cb6871e4bce8030b0b) fix: pass all logs through the options.Log method
* [`4e9c5afb6`](https://github.com/talos-systems/talos/commit/4e9c5afb6dd6bdedb4032b7cf4a24b6f1bf88144) fix: make ethtool optional in link status controller
* [`bf61c2cc4`](https://github.com/talos-systems/talos/commit/bf61c2cc4a51d290fe98aaeb80224bdd52bb7ac5) fix: write upgrade logs only to the LogOutput if it's defined
* [`9c73257cb`](https://github.com/talos-systems/talos/commit/9c73257cb128a76459b7d4442b56a50feed089d6) feat: update Go to 1.16.6
* [`23ef1d40a`](https://github.com/talos-systems/talos/commit/23ef1d40af44b873d60337d691f878e2cfe0fe8d) chore: add ability to redirect talos upgrade module logs to io.Writer
* [`33e9d6c98`](https://github.com/talos-systems/talos/commit/33e9d6c984f82af24ad79e002758841935e60a6a) chore: bump github.com/aws/aws-sdk-go in /hack/cloud-image-uploader
* [`604434c43`](https://github.com/talos-systems/talos/commit/604434c43eb63aa760cd2176aa1041b653c9bd75) chore: bump github.com/prometheus/procfs from 0.6.0 to 0.7.0
* [`2ea28f62d`](https://github.com/talos-systems/talos/commit/2ea28f62d8dcac3280d7a133ae6532f3ca5709cc) chore: bump node from 16.3.0-alpine to 16.4.2-alpine
* [`b358a189b`](https://github.com/talos-systems/talos/commit/b358a189bcbaa480d1bb3fbcc58eecd1b61f447d) fix: correctly pick route scope for link-local destination
* [`6848d4314`](https://github.com/talos-systems/talos/commit/6848d431427636e415436cdda95543a9a0da5676) feat: can change clusterdns ip lists
* [`72b76abfd`](https://github.com/talos-systems/talos/commit/72b76abfd43d04aa7a9283669925bd49498dc05f) fix: workaround issues when IPv6 is fully or partially disabled
* [`679b08f4f`](https://github.com/talos-systems/talos/commit/679b08f4fabd098311786551e75e38c2a027bd31) docs: update docs for 0.12
* [`6fbec9e0c`](https://github.com/talos-systems/talos/commit/6fbec9e0cb656f411cceb986560473b1a40b6a45) fix: cache etcd client used for healthchecks
* [`eea750de2`](https://github.com/talos-systems/talos/commit/eea750de2c11a9883f343c65a36e30712b987f89) chore: rename "join" type to "worker"
* [`951493ac8`](https://github.com/talos-systems/talos/commit/951493ac8356a414ff85fce25e30e4bd808b412c) docs: update what's new for Talos 0.11
* [`b47d1098b`](https://github.com/talos-systems/talos/commit/b47d1098b1f1cbd21c501266ffc4a38711ed213f) docs: promote 0.11 docs to be the latest
* [`d930a2650`](https://github.com/talos-systems/talos/commit/d930a26502759cebccb05d9b78741e1fc147b30b) chore: implement DeepCopy for machine configuration
* [`fe4ed3c73`](https://github.com/talos-systems/talos/commit/fe4ed3c734e5713b2fa1d639bd80bffc7888d7e7) chore: ignore tags which don't look like semantic version
* [`b969e7720`](https://github.com/talos-systems/talos/commit/b969e7720ebcb0103e94494533d819a91dba59f5) chore: update references to old protobuf package
* [`2ba8ac9ab`](https://github.com/talos-systems/talos/commit/2ba8ac9ab4b24572512c2a877acd26b912b5423a) docs: add documentation directory for 0.12
* [`011e2885e`](https://github.com/talos-systems/talos/commit/011e2885e7f88a3a92f3f495fdc1d3be6ed0c877) fix: validate bond slaves addressing
* [`10c28758a`](https://github.com/talos-systems/talos/commit/10c28758a4fc50a5e5a29097769b4a3a92ed249a) fix: ignore DeadlineExceeded error correctly on bootstrap
* [`77fabacec`](https://github.com/talos-systems/talos/commit/77fabaceca242f89949d4bf231e9754b4d04eb5e) chore: ignore future pkg/machinery/vX.Y.Z tags
* [`6b661114d`](https://github.com/talos-systems/talos/commit/6b661114d03a7cd1ddd8939ea323d4fe2ce9976c) fix: make COSI runtime history depth smaller
* [`9bf899bdd`](https://github.com/talos-systems/talos/commit/9bf899bdd852befbb4aa5ac4f3ceecb3c33502c8) fix: make forfeit leadership connect to the right node
* [`4708beaee`](https://github.com/talos-systems/talos/commit/4708beaee53e3aacbeec07c38cdd2c7316d16a4c) feat: implement `talosctl config info` command
* [`6d13d2cf9`](https://github.com/talos-systems/talos/commit/6d13d2cf9243adce739673f1982cbc1f12252ef1) fix: close Kubernetes API client
* [`aaa36f3b4`](https://github.com/talos-systems/talos/commit/aaa36f3b4fb250d2921f35c09bcb01b6c31ad423) fix: ignore 'not a leader' error on forfeit leadership
* [`22a419367`](https://github.com/talos-systems/talos/commit/22a4193678d2245b4c24b7e173d4cfd5fa876e95) fix: workaround 'Unauthorized' errors when accessing Kubernetes API
* [`71c6f7004`](https://github.com/talos-systems/talos/commit/71c6f7004e28c8a72410652d7d38f770bcf8a5f8) chore: bump go.mod dependencies
* [`915cd8fe2`](https://github.com/talos-systems/talos/commit/915cd8fe20c55112cc1fa7776c115ac85c7f3da9) docs: add guide for RBAC
* [`f5721050d`](https://github.com/talos-systems/talos/commit/f5721050deffe61f892a9fca2d20b3fccb5021a6) fix: controlplane keyusage
* [`3d7726613`](https://github.com/talos-systems/talos/commit/3d7726613ca5c5e6b14b4854564d71ee3644d32e) fix: fill uuid argument correctly in the config download URL
* [`d8602025c`](https://github.com/talos-systems/talos/commit/d8602025c828189fa15350a15bf3ccefe39bd0ce) chore: update containerd config version 2
* [`5949ec4e6`](https://github.com/talos-systems/talos/commit/5949ec4e6e05ada904d69a24c9d21e20cc7dea85) docs: describe the new network configuration subsystem
* [`444d72b4d`](https://github.com/talos-systems/talos/commit/444d72b4d7cff7b38c8e3a483bbe10c74251448a) feat: update pkgs version
* [`e883c12b3`](https://github.com/talos-systems/talos/commit/e883c12b31e2ddc3860abc04e7c0867701f46026) fix: make output of `upgrade-k8s` command less scary
* [`7f8e50de4`](https://github.com/talos-systems/talos/commit/7f8e50de4d9a36dae9de7783d71a981fb6a72854) fix: restart the merge controllers on conflict
* [`60d736094`](https://github.com/talos-systems/talos/commit/60d7360944ff6fc1e75f98e37a754f3bb2962144) fix: ignore deadline exceeded errors on bootstrap
* [`ee06dd69f`](https://github.com/talos-systems/talos/commit/ee06dd69fc39d5df720a88991caaf3646c6fa349) fix: don't print git sha of the release twice in the dashboard
* [`07fb61e5d`](https://github.com/talos-systems/talos/commit/07fb61e5d22da86b434d30f12b84b845ac1a4df7) fix: issue worker apid certs properly on renewal
* [`84817f733`](https://github.com/talos-systems/talos/commit/84817f733458cbd35549eebc72df6a5df202b299) chore: bump Talos version in upgrade tests
* [`2fa54107b`](https://github.com/talos-systems/talos/commit/2fa54107b2c84cabe948ace5d70836dd4be95799) chore: fix tests for disabled RBAC
* [`78583ba98`](https://github.com/talos-systems/talos/commit/78583ba985fa2b90ec610d148b2cbeb0b92d646b) fix: don't set bond delay options if miimon is not enabled
* [`bbf1c091d`](https://github.com/talos-systems/talos/commit/bbf1c091d4cea0b4610bce7165a98c7572423b01) feat: add RBAC to `talosctl version` output
* [`5f6ec3ef6`](https://github.com/talos-systems/talos/commit/5f6ec3ef66c8bf2cb334e02b5aa9869330c985d8) fix: handle cases when merged resource re-appears before being destroyed
* [`1e9a0e745`](https://github.com/talos-systems/talos/commit/1e9a0e745db73bd45ec0881aa19e43d7badb5914) fix: documentation typos
* [`f228af406`](https://github.com/talos-systems/talos/commit/f228af4061e2025531c953fdb7f8bf83de4bf8b0) chore: bump go.mod dependencies
* [`2060ceaa0`](https://github.com/talos-systems/talos/commit/2060ceaa0b16be04a61a00e0085e25889ffe613a) chore: add CAPI version to CI setup
* [`ad047a7de`](https://github.com/talos-systems/talos/commit/ad047a7dee4c0ac26c01862bdaa923fab93cc2e1) chore: small RBAC improvements
</p>
</details>
...
* [`07c87a1b`](https://github.com/talos-systems/talos/commit/07c87a1b6018fd9cb2d2301668e3e01de4d49bdf) fix: check trustd API CA on worker nodes
* [`ce1226b2`](https://github.com/talos-systems/talos/commit/ce1226b2f8231d978ae3212107ee386d39528812) fix: check for existence of dhcp6 FQDN first
* [`ed94d504`](https://github.com/talos-systems/talos/commit/ed94d504a582649aa516e9b97eba1f98f6463891) fix: containerd log symlink
* [`7e63e43e`](https://github.com/talos-systems/talos/commit/7e63e43eb399c27a30cd2ce2aa2603f174826fec) fix: don't marshal clock with SecretsBundle
</p>
</details>
...
## [Talos 0.12.2](https://github.com/talos-systems/talos/releases/tag/v0.12.2) (2021-09-17)
...
* [`7b4a6b36`](https://github.com/talos-systems/talos/commit/7b4a6b3619e2ab55d6c588c9f1a018504f127664) fix: patch multi nodes support
* [`ccb24bc1`](https://github.com/talos-systems/talos/commit/ccb24bc18e22f6e31b48e8dcaba6171a3629a1f5) feat: update Kubernetes to 1.22.2
* [`11055186`](https://github.com/talos-systems/talos/commit/110551865df08c59d4e1c47bdeab6515a0691ff0) fix: tear down control plane static pods when etcd is stopped
* [`5824f502`](https://github.com/talos-systems/talos/commit/5824f5024e4b51e6e88940e187bbac4e2fb35bd1) fix: completely prevent editing resources other than mc
* [`5700c81b`](https://github.com/talos-systems/talos/commit/5700c81bf66392477588a6229af48925bbf888bf) fix: write KubernetesCACert chmodded 0400 instead of 0500
* [`6adaee33`](https://github.com/talos-systems/talos/commit/6adaee33a76a4a9561331c09dcfc0f074bb9fc5c) release(v0.12.1): prepare release
* [`a72fa2a9`](https://github.com/talos-systems/talos/commit/a72fa2a931c39db584cac99d3c38e8e005e8efc2) fix: correctly define example for `extraMounts`
* [`ff9681a7`](https://github.com/talos-systems/talos/commit/ff9681a74e4927e147753aed6a283b2d9ad22c29) release(v0.12.0): prepare release
* [`75ce68d9`](https://github.com/talos-systems/talos/commit/75ce68d909309e019c4a37ce5e7bcb6eda8aa1e4) release(v0.12.0-beta.2): prepare release
...
## [Talos 0.12.1](https://github.com/talos-systems/talos/releases/tag/v0.12.1) (2021-09-06)
...
## [Talos 0.12.0](https://github.com/talos-systems/talos/releases/tag/v0.12.0) (2021-08-31)
...
### Changes
<details><summary>135 commits</summary>
<p>
