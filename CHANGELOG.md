## [Talos 0.9.3](https://github.com/talos-systems/talos/releases/tag/v0.9.3) (2021-04-23)
...
* [`c7e3ccef`](https://github.com/talos-systems/talos/commit/c7e3ccef22aceb11a0c72d08fccd21b04ba8b0e5) fix: check if OVF env is empty
* [`73caf799`](https://github.com/talos-systems/talos/commit/73caf799c8d3edb717079bca5706dd54ffc0d4f0) chore: list specifically for enabled regions
* [`6158a226`](https://github.com/talos-systems/talos/commit/6158a22668f1cc4c307f7517650d585e13bbe029) release(v0.9.2): prepare release
* [`2b83440d`](https://github.com/talos-systems/talos/commit/2b83440d6f7fd557d3568ade16790b7e7f2b19ed) feat: bump k8s version to 1.20.6
* [`cb82fb58`](https://github.com/talos-systems/talos/commit/cb82fb58cea7247606d215c820d7816a30dfe58d) fix: zero out manifest contents before setting new value
* [`c1ce1b82`](https://github.com/talos-systems/talos/commit/c1ce1b8274f6600985ba502cb0840c021f327e20) feat: add support for reading OVF data on VMWare
* [`4f768228`](https://github.com/talos-systems/talos/commit/4f76822891b1a264c7a7249e23c3d89e628fe384) feat: validate the machine configuration in the installer container
* [`702661bc`](https://github.com/talos-systems/talos/commit/702661bcad4a7a6c0a2ccd980551e2430e894c46) fix: print task failure error immediately
* [`948ae7ba`](https://github.com/talos-systems/talos/commit/948ae7bac81adc5a4aba545f01d12d1ed3e949a8) fix: ignore EOF errors from Kubernetes API when converting control plane
* [`5ce00af3`](https://github.com/talos-systems/talos/commit/5ce00af3cbb8fdddf141a4559f2f5b9310f1c245) chore: use tagged version of cluster-api-templates
* [`faab2800`](https://github.com/talos-systems/talos/commit/faab280043651019b46a36c40d7b4dc1c2ed97d8) test: update CAPA to 0.6.4
* [`1d8e9674`](https://github.com/talos-systems/talos/commit/1d8e9674a91bda051a2b01bfcaa04e8f1aa834b7) release(v0.9.1): prepare release
* [`be149162`](https://github.com/talos-systems/talos/commit/be149162bb5ceb3ac8e65f27043d4ac5c73aa1b6) fix: prevent panic in validate config if `machine.install` is missing
* [`a8cf70cf`](https://github.com/talos-systems/talos/commit/a8cf70cf563e0a9de253299bf80cc52ff234d4e0) fix: allow `convert-k8s --remove-initialized-keys` with K8s cp is down
* [`41cf6c1c`](https://github.com/talos-systems/talos/commit/41cf6c1c45d2ced55037ee920eb5f1c87d9ec86f) fix: get rid of data race in encoder and fix concurrent map access
* [`5772e7ff`](https://github.com/talos-systems/talos/commit/5772e7ff6b5c28f015a8b48860240863776ba5bc) fix: resolve the issue with DHCP lease not being renewed
* [`80b7b221`](https://github.com/talos-systems/talos/commit/80b7b2219a7fbb2cf911a9aab577a476f8c16965) release(v0.9.0): prepare release
* [`c6f7c7f3`](https://github.com/talos-systems/talos/commit/c6f7c7f3643b0514fc2f085ad772317edc994585) fix: command `etcd remove-member` shouldn't remove etcd data directory
* [`84d59731`](https://github.com/talos-systems/talos/commit/84d597319863ab4bbb60c08b7cc2cfd52b0a425c) chore: remove old `osctl` reference
* [`26c92461`](https://github.com/talos-systems/talos/commit/26c9246197d88ae6a355a72d0edc9ecfda90b7de) fix: upgrade-k8s bug with empty config values and provision script
* [`6ffe084f`](https://github.com/talos-systems/talos/commit/6ffe084f9379c216e467670a4447e1fa77a35a25) feat: update Kubernetes to 1.20.5
* [`02839b10`](https://github.com/talos-systems/talos/commit/02839b10d38a24229b9f709704f521698706301d) release(v0.9.0-beta.1): prepare release
...
## [Talos 0.9.2](https://github.com/talos-systems/talos/releases/tag/v0.9.2) (2021-04-16)
...
### Changes
<details><summary>201 commits</summary>
<p>
...
## [Talos 0.9.1](https://github.com/talos-systems/talos/releases/tag/v0.9.1) (2021-04-01)
...
## [Talos 0.9.0](https://github.com/talos-systems/talos/releases/tag/v0.9.0) (2021-03-22)
