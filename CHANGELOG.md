## [Talos 0.10.4](https://github.com/talos-systems/talos/releases/tag/v0.10.4) (2021-06-22)
...
### Changes
<details><summary>156 commits</summary>
<p>

* [`ae5bbf58`](https://github.com/talos-systems/talos/commit/ae5bbf58b64be08f7ac5116f726e64c4b6636f9a) feat: update Linux kernel with support for HP ILO driver
* [`1e19e372`](https://github.com/talos-systems/talos/commit/1e19e3720f29eadab6f9a52be7d9d846873edde8) fix: prefer extraConfig over OVF env, skip empty config
* [`e53dff8b`](https://github.com/talos-systems/talos/commit/e53dff8b966ac9b03456aab5616f0911f7c1bf1e) feat: create certificates with os:admin role
* [`828772ce`](https://github.com/talos-systems/talos/commit/828772cec9a3f3752fa91272e5b6dd3b8d16cfb1) release(v0.10.3): prepare release
* [`70ee15b7`](https://github.com/talos-systems/talos/commit/70ee15b793fbf4a58914a5ad9b619ce4f5906c12) fix: stop networkd and pods before leaving etcd on upgrade
* [`1e9496b8`](https://github.com/talos-systems/talos/commit/1e9496b80b7e96045333a03ea1614b5929edbf71) fix: properly populate AllowSchedulingOnMasters option in gen config RPC
* [`166618b2`](https://github.com/talos-systems/talos/commit/166618b21887542482b0e913712129b84cbd2ed9) feat: update containerd to 1.4.6, runc to 1.0.0-rc95
* [`8d73bc59`](https://github.com/talos-systems/talos/commit/8d73bc5999b42474ca73c0a1d5458bb7e3ea0563) release(v0.10.2): prepare release
* [`20ad263b`](https://github.com/talos-systems/talos/commit/20ad263b46132deefbe7dea562d8a2b095e2676e) feat: update Kubernetes to 1.21.1
* [`4941356f`](https://github.com/talos-systems/talos/commit/4941356f468163ff45cd12ce317d6bde1b45dc58) feat: update go-smbios library
* [`747903a1`](https://github.com/talos-systems/talos/commit/747903a100d3c17360a6fe43c02ab9750d67cf22) fix: stop networkd before leaving etcd on 'reset' path
* [`6fd98d95`](https://github.com/talos-systems/talos/commit/6fd98d95b9a2e9df7a618b609d0f056f7e775f26) fix: update the way NTP sync uses `adjtimex` syscall
* [`f1298f6e`](https://github.com/talos-systems/talos/commit/f1298f6e3ca017490eac4485c864ff9d7a55e208) fix: avoid data race on CRI pod stop
* [`994bdb5a`](https://github.com/talos-systems/talos/commit/994bdb5af78a411a4fa278fe03f52b8136e1f4c1) feat: update containerd to 1.4.5, runc to 1.0.0-rc94
* [`d0a3d69d`](https://github.com/talos-systems/talos/commit/d0a3d69d5f7810aa87a560a54a3dc8dadaea773a) release(v0.10.1): prepare release
* [`99de689d`](https://github.com/talos-systems/talos/commit/99de689d0674d294026846732bb3cb398462dea3) feat: pull kernel with VMware balloon module enabled
* [`194baa3d`](https://github.com/talos-systems/talos/commit/194baa3d6b1d653edbac743bd03b88fd9f02ca05) fix: properly parse matcher expressions
* [`c613d3e2`](https://github.com/talos-systems/talos/commit/c613d3e2274b866871ff8df8b98a1831203f8202) fix: bump crypto library for the CSR verification fix
* [`25fa7a19`](https://github.com/talos-systems/talos/commit/25fa7a191782eaa7995ec28e415cff9af8719254) chore: remove security API ReadFile/WriteFile
* [`e415c81a`](https://github.com/talos-systems/talos/commit/e415c81ad7f42e65836d3238e3e22d0d68057be1) feat: add `--config-patch` flag by node type
* [`801808c5`](https://github.com/talos-systems/talos/commit/801808c545209939df34da5c2d1f997f2a5b500f) fix: use both self-signed and Kubernetes CA to verify Kubelet cert
* [`90533694`](https://github.com/talos-systems/talos/commit/905336940d4f23a68a2fe9988f8d47e6e52ec5ff) release(v0.10.0): prepare release
* [`280b5940`](https://github.com/talos-systems/talos/commit/280b5940cfa58bee696d7888de65b0a181390413) fix: update osType in OVA other3xLinux64Guest"
* [`b338628d`](https://github.com/talos-systems/talos/commit/b338628dc8547b0fd392a841c83f48e3b32f6333) fix: check if OVF env is empty
* [`4e664ce1`](https://github.com/talos-systems/talos/commit/4e664ce174340eea4cd8401b0f03621e6a134a51) chore: list specifically for enabled regions
* [`c07b5152`](https://github.com/talos-systems/talos/commit/c07b5152a21e8b64d8fa1062a0be7d39ba93578f) release(v0.10.0-beta.1): prepare release
* [`e1475256`](https://github.com/talos-systems/talos/commit/e1475256e39ea5a3b87478413584c26b7a828e7b) test: implement `talosctl conformance` command to run e2e tests
* [`564b45ba`](https://github.com/talos-systems/talos/commit/564b45ba200531ac9dacdccd984b22eb39acdedf) fix: update etcd client errors, print etcd join failures
* [`9fde88cc`](https://github.com/talos-systems/talos/commit/9fde88cc45d43d0a85c98c506328d24ee9648e63) feat: provide an option to recover etcd from data directory copy
* [`54f243c4`](https://github.com/talos-systems/talos/commit/54f243c464f9e161e64a1af7887a59a8fe297750) feat: update kernel config for rpi to improve performance by 3x
* [`8ed75c84`](https://github.com/talos-systems/talos/commit/8ed75c84a38a4fd17787d55e3143f41a26d30bf6) release(v0.10.0-beta.0): prepare release
* [`e69732ed`](https://github.com/talos-systems/talos/commit/e69732ed59d9252c9448a8ea37137bf9a3614839) feat: provide Talos machine config with field placeholders and docs
* [`f0970ea7`](https://github.com/talos-systems/talos/commit/f0970ea7ffe0dbca62caef2e343b91443a6ddfcb) fix: zero out manifest contents before setting new value
* [`8b8542e3`](https://github.com/talos-systems/talos/commit/8b8542e3b510ceb86dd7d7eacf86a1da3d37a19f) feat: add support for reading OVF data on VMWare
* [`04dbafca`](https://github.com/talos-systems/talos/commit/04dbafca7224e40077760b326beacaf19c91e2c9) feat: update Linux to 5.10.29
* [`3dc7b8a8`](https://github.com/talos-systems/talos/commit/3dc7b8a8a2ec669e6aa4e7d9b74761ab281ee29e) chore: fix import path mismerge
* [`2402f20c`](https://github.com/talos-systems/talos/commit/2402f20c2030860a39149ac4cd804bd0e17da6d8) feat: implement inline manifests in the machine configuration
* [`e26c977d`](https://github.com/talos-systems/talos/commit/e26c977d85028dd58b6b7482a7dd37237982f0ea) fix: check retryable network errors by interface
* [`767f3b95`](https://github.com/talos-systems/talos/commit/767f3b95efc6a876f2f4fdba089a930a8aab2745) chore: apply coverage analysis to all packages
* [`7b0ac468`](https://github.com/talos-systems/talos/commit/7b0ac4682d2790b73840b3802c2bf101cff2a0d1) test: extend unit-tests for config contract parsing
* [`d24df8f8`](https://github.com/talos-systems/talos/commit/d24df8f8446219e4d3f749ca69ed358da35dda5c) chore: re-import talos-systems/os-runtime as cosi-project/runtime
* [`cae25909`](https://github.com/talos-systems/talos/commit/cae25909f317f07697e076b6f652a8987f5e437c) chore: use Go 1.16 global install command
* [`d5e2a45d`](https://github.com/talos-systems/talos/commit/d5e2a45db3d433e492e634de564f207effa3c8cb) feat: validate the machine configuration in the installer container
* [`ef24fd6a`](https://github.com/talos-systems/talos/commit/ef24fd6a01335159617a10a8357798fdc37eaaa3) chore: bump dependencies via dependabot
* [`94520b03`](https://github.com/talos-systems/talos/commit/94520b03f6a10b0057d53d07bfc5f33b42739dae) docs: fixup typo in encryption guide command
* [`e3585f24`](https://github.com/talos-systems/talos/commit/e3585f24bcaebf2f00f2b31878927eede6c5b000) chore: update Linux to 5.10.28, u-boot to final 2021.04 release
* [`daf22087`](https://github.com/talos-systems/talos/commit/daf22087499a82681fb2328d82365c3ac7b1bc44) test: update upgrade tests to 0.10 release
* [`1fcf38f9`](https://github.com/talos-systems/talos/commit/1fcf38f9d6b19bf249d309826abc7e889921fdb3) feat: add support for "none" CNI type
* [`37a5edf0`](https://github.com/talos-systems/talos/commit/37a5edf04a892a0e59a34fc446d3961260c6e789) feat: update Kubernetes to 1.21.0 release
* [`30f687b4`](https://github.com/talos-systems/talos/commit/30f687b417eeee2b789cfb064ed9cb4ab5a301e0) fix: document HDMI problem on RPi 4
* [`29da22d0`](https://github.com/talos-systems/talos/commit/29da22d063e4fc8f15c821e7a5cc4db59188af08) feat: add config validation warnings
* [`eee7ad13`](https://github.com/talos-systems/talos/commit/eee7ad13aa00a82edd39c628657f041c89b37d13) release(v0.10.0-alpha.2): prepare release
...
* [`d39dc41`](https://github.com/talos-systems/extras/commit/d39dc41243f97ad6fe5abaac9780a9986a504184) chore: use 0.5.0 tagged images of pkgs and tools
...
* [`15654f6`](https://github.com/talos-systems/pkgs/commit/15654f6d4c4a10f19e020c7768c15f3ca91e9191) feat: enable HP ILO kernel module (both amd64 arm64)
* [`2f9eccf`](https://github.com/talos-systems/pkgs/commit/2f9eccf0e1112ac154b1afe581af89fcb5390365) feat: update containerd to 1.4.6
* [`d63b9ac`](https://github.com/talos-systems/pkgs/commit/d63b9ac1cbc5d76f374fdb05c87357c0718f170b) feat: update runc to 1.0.0-rc95
* [`80ebaa7`](https://github.com/talos-systems/pkgs/commit/80ebaa75fe1f7b207c1c7a6b59e0c52889dff497) feat: update containerd to 1.4.5, runc to 1.0.0-rc94
* [`6b85f48`](https://github.com/talos-systems/pkgs/commit/6b85f48bc9ebad1bb115099b84881b1cab558032) feat: enable VMware baloon kernel module
* [`5dd650b`](https://github.com/talos-systems/pkgs/commit/5dd650bc9b0ea8db8818af9ecb340f70f8d85fa1) feat: add cpu scaling for rpi
* [`b636cac`](https://github.com/talos-systems/pkgs/commit/b636cac908fe3fc5679da4e4145b6d14a6f738e7) feat: update Linux to 5.10.29
* [`cd77b6e`](https://github.com/talos-systems/pkgs/commit/cd77b6e86a1fa05a6e0c2e12a32e3459b6aa733f) chore: update tools tag to v0.5.0
* [`98964cb`](https://github.com/talos-systems/pkgs/commit/98964cb965d104ee94845694e6894b3744fa4f64) feat: update Linux to 5.10.28
* [`009ef35`](https://github.com/talos-systems/pkgs/commit/009ef353cd868f05fd73eb20cdfc87b65dfd112d) feat: update uboot to 2021.04 stable
...
* **github.com/cosi-project/runtime**          10d6103c19ab **_new_**
...
* **github.com/vmware/govmomi**                v0.24.0 **_new_**
...
## [Talos 0.10.3](https://github.com/talos-systems/talos/releases/tag/v0.10.3) (2021-05-20)
...
## [Talos 0.10.2](https://github.com/talos-systems/talos/releases/tag/v0.10.2) (2021-05-13)
...
## [Talos 0.10.1](https://github.com/talos-systems/talos/releases/tag/v0.10.1) (2021-05-05)
...
### Changes
<details><summary>141 commits</summary>
<p>
...
## [Talos 0.10.0](https://github.com/talos-systems/talos/releases/tag/v0.10.0) (2021-04-26)
...
## [Talos 0.10.0-beta.1](https://github.com/talos-systems/talos/releases/tag/v0.10.0-beta.1) (2021-04-19)
...
## [Talos 0.10.0-beta.0](https://github.com/talos-systems/talos/releases/tag/v0.10.0-beta.0) (2021-04-13)
...
* **github.com/talos-systems/extras**          v0.2.0-1-g0db3328 -> v0.3.0
* **github.com/talos-systems/go-blockdevice**  bb3ad73f6983 -> 1d830a25f64f
* **github.com/talos-systems/pkgs**            v0.4.1-2-gd471b60 -> v0.5.0
* **github.com/talos-systems/tools**           v0.4.0-1-g3b25a7e -> v0.5.0
* **github.com/vmware/govmomi**                v0.24.0 **_new_**
* **go.etcd.io/etcd/etcdctl/v3**               v3.5.0-alpha.0 **_new_**
* **google.golang.org/grpc**                   v1.36.0 -> v1.37.0
