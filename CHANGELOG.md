...
### Changes
<details><summary>210 commits</summary>
<p>

* [`e61c275e`](https://github.com/talos-systems/talos/commit/e61c275e538dc0484709a784f8d5087d74ef88ae) feat: update containerd to 1.5.5, runc to 1.0.1
* [`64259fd0`](https://github.com/talos-systems/talos/commit/64259fd0ad431a6ad475f36cd655f73295493e7d) fix: preserve PMBR bootable, align partitions with minimal I/O size
* [`f0e3609c`](https://github.com/talos-systems/talos/commit/f0e3609c7bc1841b18f856d5ca8e257e3b6a9594) release(v0.11.3): prepare release
* [`ddf63dfd`](https://github.com/talos-systems/talos/commit/ddf63dfdabfabba44756177e1911f22baa5907a4) fix: bump pkgs for new kernel 5.10.52
* [`29b10f9b`](https://github.com/talos-systems/talos/commit/29b10f9b01facfaa28af06a9eaeba8d90b783ac0) release(v0.11.2): prepare release
* [`671c00c4`](https://github.com/talos-systems/talos/commit/671c00c41aa04dd076807b69321ace3f2d417b06) fix: make ethtool optional in link status controller
* [`96555878`](https://github.com/talos-systems/talos/commit/965558787734c9001e89334788c0588a580339d6) feat: update Kubernetes to 1.21.3
* [`239f6d8c`](https://github.com/talos-systems/talos/commit/239f6d8c324aa4ec5f94254dd22d36331554462b) release(v0.11.1): prepare release
* [`27133766`](https://github.com/talos-systems/talos/commit/27133766dfd960d6cb32ff46ea7f709e437494d3) fix: correctly pick route scope for link-local destination
* [`a7bbefe5`](https://github.com/talos-systems/talos/commit/a7bbefe562ea5def458ceca1208d48ed9f9b2b21) fix: workaround issues when IPv6 is fully or partially disabled
* [`8442a289`](https://github.com/talos-systems/talos/commit/8442a289b790c62f40bc975b966f6c685f7bc24f) feat: update Go to 1.16.6
* [`3f6b56c6`](https://github.com/talos-systems/talos/commit/3f6b56c68646795bb8595bc8e79a866fdec606ba) release(v0.11.0): prepare release
* [`4a54fe00`](https://github.com/talos-systems/talos/commit/4a54fe00d859f9adae76c35dc50689ed283ba782) chore: ignore tags which don't look like semantic version
* [`1a40f379`](https://github.com/talos-systems/talos/commit/1a40f379fefeec7a94dfd22e191b86971e4aecfc) release(v0.11.0-beta.3): prepare release
* [`673b2716`](https://github.com/talos-systems/talos/commit/673b27160d288c17886fef1b816c7b7f6ac1fc2b) fix: validate bond slaves addressing
* [`f3f646fd`](https://github.com/talos-systems/talos/commit/f3f646fdefcbc687242ba7c5c5d6138121883c99) chore: ignore future pkg/machinery/vX.Y.Z tags
* [`5c640cd5`](https://github.com/talos-systems/talos/commit/5c640cd52fb2827d94d7487fa2a984e521482ef2) fix: ignore DeadlineExceeded error correctly on bootstrap
* [`17edc883`](https://github.com/talos-systems/talos/commit/17edc883cffe79c4e8fe933b8628960385f0c0f6) fix: make forfeit leadership connect to the right node
* [`08c9a2e5`](https://github.com/talos-systems/talos/commit/08c9a2e584b202be8c5bdf10da2fd9342d171f58) feat: implement `talosctl config info` command
* [`f6892dba`](https://github.com/talos-systems/talos/commit/f6892dba73c75e5754c467030184375a94c9609b) fix: close Kubernetes API client
* [`06aa24fb`](https://github.com/talos-systems/talos/commit/06aa24fb967fb46b8997124cfadae3e9e0a29f1a) fix: ignore 'not a leader' error on forfeit leadership
* [`9075fc41`](https://github.com/talos-systems/talos/commit/9075fc41c410fdd7508c3326db303bc988f3d0b9) fix: workaround 'Unauthorized' errors when accessing Kubernetes API
* [`1179d6ba`](https://github.com/talos-systems/talos/commit/1179d6bafc9d07dc2e0b472415ca88248aa8fc4f) release(v0.11.0-beta.2): prepare release
* [`8aed6c2e`](https://github.com/talos-systems/talos/commit/8aed6c2e17645db4bbaf86c016c1a1e6acc19e1b) fix: fill uuid argument correctly in the config download URL
* [`d6c5e500`](https://github.com/talos-systems/talos/commit/d6c5e5004cedecb7f6e36e04964e38ff7623878f) fix: make output of `upgrade-k8s` command less scary
* [`452e096e`](https://github.com/talos-systems/talos/commit/452e096e1fa487669373b28ff8aebd4f5cd159e5) fix: restart the merge controllers on conflict
* [`79f4f1aa`](https://github.com/talos-systems/talos/commit/79f4f1aa87fea75c602f569d3ffd2611308e50de) fix: ignore deadline exceeded errors on bootstrap
* [`8904009f`](https://github.com/talos-systems/talos/commit/8904009f08d9f19ba9287c478a6c8162350f8956) feat: update pkgs version
* [`223abaab`](https://github.com/talos-systems/talos/commit/223abaab043df7e69c61e645aeaf3d2d37fed447) release(v0.11.0-beta.1): prepare release
* [`7abadf72`](https://github.com/talos-systems/talos/commit/7abadf72642d1f49d455f02d3ab16231973b90cf) fix: issue worker apid certs properly on renewal
* [`33d73189`](https://github.com/talos-systems/talos/commit/33d73189e57d070e5e90d62e9e4afb7e11a3cad8) fix: don't set bond delay options if miimon is not enabled
* [`de7db38e`](https://github.com/talos-systems/talos/commit/de7db38e3e09abf9588703dbb613c9bf0d360ae0) release(v0.11.0-beta.0): prepare release
* [`74111d7b`](https://github.com/talos-systems/talos/commit/74111d7b64d33260f5010431fd28976c7b692730) feat: add RBAC to `talosctl version` output
* [`728ad5c6`](https://github.com/talos-systems/talos/commit/728ad5c6f06e25507f2630a19e5ed9af1d6af1a8) fix: handle cases when merged resource re-appears before being destroyed
* [`283e9f02`](https://github.com/talos-systems/talos/commit/283e9f026315605cde81c3a1e929175bfeb88d2f) chore: add CAPI version to CI setup
* [`01a196ea`](https://github.com/talos-systems/talos/commit/01a196ea4b04a8ed605ed336ff02bb124c8446cf) chore: small RBAC improvements
* [`829e54f1`](https://github.com/talos-systems/talos/commit/829e54f1a473b71acc4fe9538a1405834a6561dc) fix: limit apid access to COSI runtime resources
* [`f9e01d02`](https://github.com/talos-systems/talos/commit/f9e01d0274f9d6a2f8d6060316f102cea1ea0593) fix: ignore EINVAL on `unmount` operations
* [`7672435e`](https://github.com/talos-systems/talos/commit/7672435e16c77b65bd9deb79716d5244d0c116fe) feat: add a method to get gRPC connection from the client
* [`b5244bf1`](https://github.com/talos-systems/talos/commit/b5244bf1827b1c7b8988ae9cb76b3053a66785d4) chore: bump go.mod dependencies, fix netaddr API changes
* [`c7e62256`](https://github.com/talos-systems/talos/commit/c7e62256716b323cc40cec2cc8093b0f148a6323) chore: update coredns to 1.8.4
* [`3a34f1a5`](https://github.com/talos-systems/talos/commit/3a34f1a51d7d65d4c162dfe3d3634926b493fbc8) chore: bump Talos Go modules to release versions
* [`8d60abff`](https://github.com/talos-systems/talos/commit/8d60abff7a9fe6699ba2acd7f3ac271c491e55e9) chore: use tagged versions of bldr dependencies for 0.11
* [`8ef68a6f`](https://github.com/talos-systems/talos/commit/8ef68a6fb8cd436da0d16abc1dbdb873aeff3bff) feat: remove go-runner in staticpods
* [`a650531f`](https://github.com/talos-systems/talos/commit/a650531fab688bb0c60a785c3ec03d748e0e81c9) release(v0.11.0-alpha.2): prepare release
* [`71fff02f`](https://github.com/talos-systems/talos/commit/71fff02ff0e120f3d05a681a101b805efa0863f0) fix: revert back resource.proto order
* [`d3f4e600`](https://github.com/talos-systems/talos/commit/d3f4e6006f412342f1b9b71983b89d7cdc7d780a) fix: replace tabs with spaces in console output
* [`1990ad25`](https://github.com/talos-systems/talos/commit/1990ad25256d939cb889abc8eeddd5236bd769eb) feat: add created and updated timestamps to the resource metadata
...
* [`0f96c53`](https://github.com/talos-systems/extras/commit/0f96c533349646ae83447775d7c1b46a4b46e37d) feat: update Go to 1.16.6
* [`918e161`](https://github.com/talos-systems/extras/commit/918e1615e9800ac881f81d2d262ea3fab3fae3c4) chore: update deps to final release versions
...
* [`752c90e`](https://github.com/talos-systems/pkgs/commit/752c90e4021050fedaa3fecf83a867e29f81310c) feat: update containerd and runc versions
* [`5e6def3`](https://github.com/talos-systems/pkgs/commit/5e6def357a0bd0ad0112fc6bdfd9b4af285e6dc7) feat: update kernel to latest 5.10.52
* [`f8d83b4`](https://github.com/talos-systems/pkgs/commit/f8d83b451b01e2b0d0e8c403f26badeed742965d) feat: update Go to 1.16.6
* [`7b2e126`](https://github.com/talos-systems/pkgs/commit/7b2e126e254212e471af2831963270fdcd140512) feat: add support for hotplug of PCIE devices
* [`f499062`](https://github.com/talos-systems/pkgs/commit/f4990623a809628fb1def704f2d9bc67f38f3a72) chore: bump tools to final release 0.6.0
...
* [`545d839`](https://github.com/talos-systems/tools/commit/545d839e7fb9e16c7579ce24d00737d29189273d) feat: update Go to 1.16.6
...
* **github.com/aws/aws-sdk-go**                     v1.38.66 **_new_**
...
* **github.com/spf13/viper**                        v1.8.0 **_new_**
...
* **github.com/talos-systems/go-debug**             v0.2.1 **_new_**
* **github.com/talos-systems/go-kmsg**              v0.1.1 **_new_**
...
* **golang.org/x/oauth2**                           a8dc77f794b6 **_new_**
...
* **inet.af/netaddr**                               bf05d8b52dda **_new_**
...
* **k8s.io/utils**                                  6fdb442a123b **_new_**

Previous release can be found at [v0.10.0](https://github.com/talos-systems/talos/releases/tag/v0.10.0)

## [Talos 0.11.3](https://github.com/talos-systems/talos/releases/tag/v0.11.3) (2021-07-22)
...
### Changes
<details><summary>207 commits</summary>
<p>

* [`a7bad494`](https://github.com/talos-systems/talos/commit/a7bad4945ae349e3c509ae5755b72925f8e8ef25) fix: bump pkgs for new kernel 5.10.52
* [`29b10f9b`](https://github.com/talos-systems/talos/commit/29b10f9b01facfaa28af06a9eaeba8d90b783ac0) release(v0.11.2): prepare release
* [`671c00c4`](https://github.com/talos-systems/talos/commit/671c00c41aa04dd076807b69321ace3f2d417b06) fix: make ethtool optional in link status controller
* [`96555878`](https://github.com/talos-systems/talos/commit/965558787734c9001e89334788c0588a580339d6) feat: update Kubernetes to 1.21.3
* [`239f6d8c`](https://github.com/talos-systems/talos/commit/239f6d8c324aa4ec5f94254dd22d36331554462b) release(v0.11.1): prepare release
...
## [Talos 0.11.2](https://github.com/talos-systems/talos/releases/tag/v0.11.2) (2021-07-16)
...
## [Talos 0.11.1](https://github.com/talos-systems/talos/releases/tag/v0.11.1) (2021-07-14)
...
### Changes
<details><summary>202 commits</summary>
<p>
...
## [Talos 0.11.0](https://github.com/talos-systems/talos/releases/tag/v0.11.0) (2021-07-08)
...
### Changes
<details><summary>198 commits</summary>
<p>
...
## [Talos 0.11.0-beta.3](https://github.com/talos-systems/talos/releases/tag/v0.11.0-beta.3) (2021-07-07)

Welcome to the v0.11.0-beta.3 release of Talos!  
...
### Changes
<details><summary>196 commits</summary>
<p>
...
## [Talos 0.11.0-beta.2](https://github.com/talos-systems/talos/releases/tag/v0.11.0-beta.2) (2021-07-01)
...
### Changes
<details><summary>187 commits</summary>
<p>
...
## [Talos 0.11.0-beta.1](https://github.com/talos-systems/talos/releases/tag/v0.11.0-beta.1) (2021-06-29)
...
## [Talos 0.11.0-beta.0](https://github.com/talos-systems/talos/releases/tag/v0.11.0-beta.0) (2021-06-28)
