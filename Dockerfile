...
COPY --from=docker.io/andrewrynhard/kernel:v0.2.0-11-gad14414 /boot/vmlinuz /vmlinuz
COPY --from=docker.io/andrewrynhard/kernel:v0.2.0-11-gad14414 /boot/vmlinux /vmlinux

# The rootfs target provides the Talos rootfs.

FROM build AS rootfs-base
COPY --from=docker.io/andrewrynhard/fhs:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/ca-certificates:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/containerd:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/dosfstools:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/eudev:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/iptables:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/libressl:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/libseccomp:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/linux-firmware:v0.2.0-11-gad14414 /lib/firmware/bnx2 /rootfs/lib/firmware/bnx2
COPY --from=docker.io/andrewrynhard/linux-firmware:v0.2.0-11-gad14414 /lib/firmware/bnx2x /rootfs/lib/firmware/bnx2x
COPY --from=docker.io/andrewrynhard/lvm2:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/libaio:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/musl:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/runc:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/socat:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/syslinux:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/xfsprogs:v0.2.0-11-gad14414 / /rootfs
COPY --from=docker.io/andrewrynhard/util-linux:v0.2.0-11-gad14414 /lib/libblkid.* /rootfs/lib
COPY --from=docker.io/andrewrynhard/util-linux:v0.2.0-11-gad14414 /lib/libuuid.* /rootfs/lib
COPY --from=docker.io/andrewrynhard/kmod:v0.2.0-11-gad14414 /usr/lib/libkmod.* /rootfs/lib
COPY --from=docker.io/andrewrynhard/kernel:v0.2.0-11-gad14414 /lib/modules /rootfs/lib/modules
