...
COPY --from=docker.io/autonomy/kernel:v0.2.0-2-g81c1e5c /boot/vmlinuz /vmlinuz
COPY --from=docker.io/autonomy/kernel:v0.2.0-2-g81c1e5c /boot/vmlinux /vmlinux

# The rootfs target provides the Talos rootfs.

FROM build AS rootfs-base
COPY --from=docker.io/autonomy/fhs:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/ca-certificates:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/containerd:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/dosfstools:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/eudev:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/iptables:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/libressl:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/libseccomp:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/linux-firmware:v0.2.0-2-g81c1e5c /lib/firmware/bnx2 /rootfs/lib/firmware/bnx2
COPY --from=docker.io/autonomy/linux-firmware:v0.2.0-2-g81c1e5c /lib/firmware/bnx2x /rootfs/lib/firmware/bnx2x
COPY --from=docker.io/autonomy/musl:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/runc:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/socat:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/syslinux:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/xfsprogs:v0.2.0-2-g81c1e5c / /rootfs
COPY --from=docker.io/autonomy/util-linux:v0.2.0-2-g81c1e5c /lib/libblkid.* /rootfs/lib
COPY --from=docker.io/autonomy/util-linux:v0.2.0-2-g81c1e5c /lib/libuuid.* /rootfs/lib
COPY --from=docker.io/autonomy/kmod:v0.2.0-2-g81c1e5c /usr/lib/libkmod.* /rootfs/lib
COPY --from=docker.io/autonomy/kernel:v0.2.0-2-g81c1e5c /lib/modules /rootfs/lib/modules
