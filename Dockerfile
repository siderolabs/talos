...
# We do not need reproducible timestamps here, as we only use VEX for scanning
# FIXME: add an output option to not require a shell in this step
...
COPY ./tools ./tools
# TODO: should we cache DB, how often is it updated?
