...
FROM ${PKGS_PREFIX}/kernel:${PKGS} AS pkg-kernel
FROM --platform=amd64 ${PKGS_PREFIX}/kernel:${PKGS} AS pkg-kernel-amd64
FROM --platform=arm64 ${PKGS_PREFIX}/kernel:${PKGS} AS pkg-kernel-arm64
...
FROM alpine:3.17.1 AS unicode-pf2
