...
require (
	...
	k8s.io/apiextensions-apiserver v0.37.0-rc.1
	...
	k8s.io/cri-api v0.37.0-rc.1
	k8s.io/kube-proxy v0.37.0-rc.1
	k8s.io/kube-scheduler v0.37.0-rc.1
	k8s.io/kubectl v0.37.0-rc.1
	k8s.io/kubelet v0.37.0-rc.1
	k8s.io/pod-security-admission v0.37.0-rc.1
)
...
require (
	...
	k8s.io/cli-runtime v0.37.0-rc.1 // indirect
