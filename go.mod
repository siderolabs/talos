...
replace github.com/containerd/containerd/v2 => github.com/smira/containerd/v2 v2.0.0-20251113120816-51ecd22de074
...
require (
	...
	github.com/siderolabs/go-blockdevice/v2 v2.0.20
