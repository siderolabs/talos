...
replace (
	...
	cloud.google.com/go => cloud.google.com/go v0.121.4
...
require (
	...
	k8s.io/cri-api v0.34.0-rc.0
	k8s.io/kube-scheduler v0.34.0-rc.0
	k8s.io/kubectl v0.34.0-rc.0
	k8s.io/kubelet v0.34.0-rc.0
	k8s.io/pod-security-admission v0.34.0-rc.0
)
