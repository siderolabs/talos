...
require (
	...
	github.com/talos-systems/talos/pkg/machinery v0.13.5
	...
	golang.zx2c4.com/wireguard/wgctrl v0.0.0-20210927125730-0a2f4901cba6
	...
	k8s.io/apiserver v0.22.3 // indirect; use the same version as other k8s deps
