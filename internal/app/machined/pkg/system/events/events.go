...
// AsEventProto returns protobuf representation of respective machined evet.
func (event *ServiceEvent) AsEventProto(service string) *machineapi.ServiceStateEvent {
