...
import (
	...
	"github.com/siderolabs/talos/pkg/algorithm"
...
func (ctrl *EndpointController) ensureTalosEndpointSlicesTyped(
	...
	for {
		...
		newEndpointSlice.Endpoints = algorithm.Deduplicate(newEndpointSlice.Endpoints, func(e discoveryv1.Endpoint) string {
