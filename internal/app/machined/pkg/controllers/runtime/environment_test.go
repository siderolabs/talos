...
func (suite *EnvironmentSuite) TestEnvironmentNone() {
	...
	rtestutils.AssertResource[*runtime.Environment](suite.Ctx(), suite.T(), suite.State(), runtime.EnvironmentID,
...
func (suite *EnvironmentSuite) TestEnvironmentMachineConfig() {
	...
	rtestutils.AssertResources[*runtime.Environment](suite.Ctx(), suite.T(), suite.State(), []resource.ID{runtime.EnvironmentID},
