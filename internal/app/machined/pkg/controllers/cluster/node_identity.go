...
import (
	...
	"github.com/siderolabs/talos/internal/app/machined/pkg/machine/blockmachine"
...
type NodeIdentityController struct {
	stateMachine blockmachine.VolumeMounterMachine
}
...
func (ctrl *NodeIdentityController) Run(ctx context.Context, r controller.Runtime, logger *zap.Logger) error {
	for {
		...
		if ctrl.stateMachine == nil {
			ctrl.stateMachine = blockmachine.NewVolumeMounter(ctrl.Name(), constants.StatePartitionLabel, ctrl.establishNodeIdentity)
		}
