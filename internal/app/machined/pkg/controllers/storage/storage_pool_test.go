...
func TestStoragePoolRetryWithoutPolling(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		fixture := &StoragePoolSuite{DefaultSuite: ctest.DefaultSuite{Timeout: time.Minute}}
		fixture.SetT(t)
		fixture.SetupTest()
...
func TestStoragePoolRetargetOrdering(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		fixture := &StoragePoolSuite{DefaultSuite: ctest.DefaultSuite{Timeout: 10 * time.Second}}
		fixture.SetT(t)
		fixture.SetupTest()
...
func TestStoragePoolSuite(t *testing.T) {
	...
	suite.Run(t, &StoragePoolSuite{
		DefaultSuite: ctest.DefaultSuite{Timeout: 10 * time.Second},
	})
}
