...
// ExtensionsSuiteLibvirt verifies the libvirt extension on QEMU.
type ExtensionsSuiteLibvirt struct {
	base.APISuite
...
// SuiteName ...
func (suite *ExtensionsSuiteLibvirt) SuiteName() string {
	return "api.ExtensionsSuiteLibvirt"
}

// SetupTest ...
func (suite *ExtensionsSuiteLibvirt) SetupTest() {
...
// TearDownTest ...
func (suite *ExtensionsSuiteLibvirt) TearDownTest() {
...
func (suite *ExtensionsSuiteLibvirt) TestDomain() {
...
func (suite *ExtensionsSuiteLibvirt) runVirsh(node string, args ...string) string {
...
func (suite *ExtensionsSuiteLibvirt) libvirtDomainPID(ctx context.Context) (int32, error) {
...
func init() {
	allSuites = append(allSuites, &ExtensionsSuiteLibvirt{})
}
