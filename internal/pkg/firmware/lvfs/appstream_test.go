...
func TestParseComponents(t *testing.T) {
	...
	assert.Equal(t, "https://fwupd.org/downloads/b7514665fca835af4dbeb637893d0cee4407c613-20200012_v2.cab", release.CabURL())
	assert.Equal(t, "d0e6101bb95ef165a0aed6c5857c5d9f4d08f355e08ca0a17eaa3de74790c017", release.CabSHA256())
	...
	assert.Equal(t, "https://fwupd.org/downloads/example.cab", release.CabURL())
	assert.Equal(t, "2222222222222222222222222222222222222222222222222222222222222222", release.CabSHA256())
}
