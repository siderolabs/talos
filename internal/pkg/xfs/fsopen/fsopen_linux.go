...
// Interface guard.
var (
	_ xfs.Creator = (*FS)(nil)
	_ xfs.Mounter = (*FS)(nil)
)
...
// Create initializes the filesystem and returns the file descriptor for the mounted filesystem.
