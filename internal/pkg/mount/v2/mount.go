...
func WithProjectQuota() NewPointOption {
	return func(p *Point) {
		if len(p.data) > 0 {
			p.data += ","
		}
...
// MountOptions are mount options.
...
func WithSkipIfMounted() MountOption {
...
func WithMountPrinter(printer func(string, ...any)) MountOption {
	return func(o *MountOptions) {
		o.Printer = printer
	}
}
...
func (p *Point) Mount(opts ...MountOption) (unmounter func() error, err error) {
