...
func NewResolver(config runtime.Registries) remotes.Resolver {
...
func RegistryHosts(config runtime.Registries) docker.RegistryHosts {
...
func RegistryEndpoints(config runtime.Registries, host string) ([]string, error) {
