...
// NewKeyHandler creates a new KeyHandler that wraps the provided key handler and uses the provided salt getter.
func NewKeyHandler(wrapped Handler, saltGetter helpers.SaltGetter) Handler {
