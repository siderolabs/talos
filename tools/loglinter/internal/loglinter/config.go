...
type Rules struct {
	StdlibLogCalls       StdlibLogCallsRule       `json:"stdlib_log_calls"`
	SlogImports          SlogImportsRule          `json:"slog_imports"`
	ZapMessageFormatting ZapMessageFormattingRule `json:"zap_message_formatting"`
	ZapMessageSprintf    ZapMessageSprintfRule    `json:"zap_message_sprintf"`
	ZapRootComponent     ZapRootComponentRule     `json:"zap_root_component"`
}
...
type ZapRootComponentRule struct {
	...
	ComponentCalls []string `json:"component_calls"`
}
