...
func (m *ProbeHTTPRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TimeoutMillis != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.TimeoutMillis))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Path) > 0 {
...
func (m *ProbeHTTPResponse_Failure) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Failure)
	copy(dAtA[i:], m.Failure)
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Failure)))
	i--
	dAtA[i] = 0x12
	return len(dAtA) - i, nil
}
...
func (m *ProbeHTTPRequest) SizeVT() (n int) {
	...
	if m.TimeoutMillis != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.TimeoutMillis))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *SyncBootArtifactsRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SyncBootArtifactsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncBootArtifactsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SyncBootArtifactsResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SyncBootArtifactsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncBootArtifactsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Changed == nil {
				m.Changed = make(map[string]bool)
			}
			var mapkey string
			var mapvalue bool
			for iNdEx < postIndex {
...
func (m *ProbeHTTPRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProbeHTTPRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProbeHTTPRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ProbeHTTPResult) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProbeHTTPResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProbeHTTPResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ProbeHTTPResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProbeHTTPResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProbeHTTPResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if oneof, ok := m.Outcome.(*ProbeHTTPResponse_Result); ok {
				...
				m.Outcome = &ProbeHTTPResponse_Result{Result: v}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Outcome = &ProbeHTTPResponse_Failure{Failure: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
