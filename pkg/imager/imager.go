...
func (i *Imager) handleProf() error {
	...
	i.prof.Output.FillDefaults(i.prof.Version, i.prof.SecureBootEnabled())
	i.prof.Customization.FillDefaults(i.prof.Output.Kind, i.prof.Version, i.prof.SecureBootEnabled())
