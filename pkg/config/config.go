...
func NewConfigBundle(opts ...BundleOption) (*v1alpha1.ConfigBundle, error) {
	...
	if options.ExistingConfigs != "" {
		...
		for _, configType := range []runtime.MachineType{runtime.MachineTypeBootstrap, runtime.MachineTypeControlPlane, runtime.MachineTypeWorker} {
			...
			case runtime.MachineTypeWorker:
