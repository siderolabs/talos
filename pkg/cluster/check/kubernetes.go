...
func K8sAllNodesReportedAssertion(ctx context.Context, cl ClusterInfo) error {
	...
	expectedNodeInfos, err := cl.Nodes()
	if err != nil {
		return err
	}
...
func K8sFullControlPlaneAssertion(ctx context.Context, cl ClusterInfo) error {
	...
	var expectedNodes []cluster.NodeInfo
	...
	expectedNodes = append(expectedNodes, initNodes...)
	...
	expectedNodes = append(expectedNodes, controlPlaneNodes...)
