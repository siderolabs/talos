	...
	env, err := cel.NewEnv(
		slices.Concat(
			[]cel.EnvOption{
				...
				cel.Variable("qos_memory_some_avg_10", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_some_avg_60", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_some_avg_300", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_some_total", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_full_avg_10", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_full_avg_60", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("qos_memory_full_avg_300", types.NewMapType(types.IntType, types.DoubleType)),
				...
				cel.Variable("d_qos_memory_some_avg_10", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_some_avg_60", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_some_avg_300", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_some_total", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_full_avg_10", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_full_avg_60", types.NewMapType(types.IntType, types.DoubleType)),
				cel.Variable("d_qos_memory_full_avg_300", types.NewMapType(types.IntType, types.DoubleType)),
