// Code generated by "enumer -type=ARPAllTargets,ARPValidate,AddressFlag,AddressSortAlgorithm,ADSelect,ADLACPActive,AutoHostnameKind,BGPSessionState,BondMode,BondXmitHashPolicy,ClientIdentifier,ConntrackState,DefaultAction,DNSProtocol,Duplex,Family,LACPRate,LinkFlag,LinkType,MacvlanMode,MatchOperator,NfTablesChainHook,NfTablesChainPriority,NfTablesVerdict,OperationalState,Port,PrimaryReselect,Protocol,RouteFlag,RouteProtocol,RouteType,RoutingRuleAction,RoutingTable,Scope,Status,VLANProtocol,WOLMode -linecomment -text"; DO NOT EDIT.
...
const _BGPSessionStateName = "UNKNOWNIDLECONNECTACTIVEOPEN_SENTOPEN_CONFIRMESTABLISHED"

var _BGPSessionStateIndex = [...]uint8{0, 7, 11, 18, 24, 33, 45, 56}

const _BGPSessionStateLowerName = "unknownidleconnectactiveopen_sentopen_confirmestablished"

func (i BGPSessionState) String() string {
	if i >= BGPSessionState(len(_BGPSessionStateIndex)-1) {
		return fmt.Sprintf("BGPSessionState(%d)", i)
	}
	return _BGPSessionStateName[_BGPSessionStateIndex[i]:_BGPSessionStateIndex[i+1]]
}

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the stringer command to generate them again.
func _BGPSessionStateNoOp() {
	var x [1]struct{}
	_ = x[BGPSessionStateUnknown-(0)]
	_ = x[BGPSessionStateIdle-(1)]
	_ = x[BGPSessionStateConnect-(2)]
	_ = x[BGPSessionStateActive-(3)]
	_ = x[BGPSessionStateOpenSent-(4)]
	_ = x[BGPSessionStateOpenConfirm-(5)]
	_ = x[BGPSessionStateEstablished-(6)]
}

var _BGPSessionStateValues = []BGPSessionState{BGPSessionStateUnknown, BGPSessionStateIdle, BGPSessionStateConnect, BGPSessionStateActive, BGPSessionStateOpenSent, BGPSessionStateOpenConfirm, BGPSessionStateEstablished}

var _BGPSessionStateNameToValueMap = map[string]BGPSessionState{
	_BGPSessionStateName[0:7]:        BGPSessionStateUnknown,
	_BGPSessionStateLowerName[0:7]:   BGPSessionStateUnknown,
	_BGPSessionStateName[7:11]:       BGPSessionStateIdle,
	_BGPSessionStateLowerName[7:11]:  BGPSessionStateIdle,
	_BGPSessionStateName[11:18]:      BGPSessionStateConnect,
	_BGPSessionStateLowerName[11:18]: BGPSessionStateConnect,
	_BGPSessionStateName[18:24]:      BGPSessionStateActive,
	_BGPSessionStateLowerName[18:24]: BGPSessionStateActive,
	_BGPSessionStateName[24:33]:      BGPSessionStateOpenSent,
	_BGPSessionStateLowerName[24:33]: BGPSessionStateOpenSent,
	_BGPSessionStateName[33:45]:      BGPSessionStateOpenConfirm,
	_BGPSessionStateLowerName[33:45]: BGPSessionStateOpenConfirm,
	_BGPSessionStateName[45:56]:      BGPSessionStateEstablished,
	_BGPSessionStateLowerName[45:56]: BGPSessionStateEstablished,
}

var _BGPSessionStateNames = []string{
	_BGPSessionStateName[0:7],
	_BGPSessionStateName[7:11],
	_BGPSessionStateName[11:18],
	_BGPSessionStateName[18:24],
	_BGPSessionStateName[24:33],
	_BGPSessionStateName[33:45],
	_BGPSessionStateName[45:56],
}

// BGPSessionStateString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func BGPSessionStateString(s string) (BGPSessionState, error) {
	if val, ok := _BGPSessionStateNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _BGPSessionStateNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to BGPSessionState values", s)
}

// BGPSessionStateValues returns all values of the enum
func BGPSessionStateValues() []BGPSessionState {
	return _BGPSessionStateValues
}

// BGPSessionStateStrings returns a slice of all String values of the enum
func BGPSessionStateStrings() []string {
	strs := make([]string, len(_BGPSessionStateNames))
	copy(strs, _BGPSessionStateNames)
	return strs
}

// IsABGPSessionState returns "true" if the value is listed in the enum definition. "false" otherwise
func (i BGPSessionState) IsABGPSessionState() bool {
	for _, v := range _BGPSessionStateValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for BGPSessionState
func (i BGPSessionState) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for BGPSessionState
func (i *BGPSessionState) UnmarshalText(text []byte) error {
	var err error
	*i, err = BGPSessionStateString(string(text))
	return err
}
...
const (
	_MacvlanModeName_0      = "privatevepa"
	_MacvlanModeLowerName_0 = "privatevepa"
	_MacvlanModeName_1      = "bridge"
	_MacvlanModeLowerName_1 = "bridge"
	_MacvlanModeName_2      = "passthru"
	_MacvlanModeLowerName_2 = "passthru"
	_MacvlanModeName_3      = "source"
	_MacvlanModeLowerName_3 = "source"
)

var (
	_MacvlanModeIndex_0 = [...]uint8{0, 7, 11}
	_MacvlanModeIndex_1 = [...]uint8{0, 6}
	_MacvlanModeIndex_2 = [...]uint8{0, 8}
	_MacvlanModeIndex_3 = [...]uint8{0, 6}
)

func (i MacvlanMode) String() string {
	switch {
	case 1 <= i && i <= 2:
		i -= 1
		return _MacvlanModeName_0[_MacvlanModeIndex_0[i]:_MacvlanModeIndex_0[i+1]]
	case i == 4:
		return _MacvlanModeName_1
	case i == 8:
		return _MacvlanModeName_2
	case i == 16:
		return _MacvlanModeName_3
	default:
		return fmt.Sprintf("MacvlanMode(%d)", i)
	}
}

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the stringer command to generate them again.
func _MacvlanModeNoOp() {
	var x [1]struct{}
	_ = x[MacvlanModePrivate-(1)]
	_ = x[MacvlanModeVEPA-(2)]
	_ = x[MacvlanModeBridge-(4)]
	_ = x[MacvlanModePassthru-(8)]
	_ = x[MacvlanModeSource-(16)]
}

var _MacvlanModeValues = []MacvlanMode{MacvlanModePrivate, MacvlanModeVEPA, MacvlanModeBridge, MacvlanModePassthru, MacvlanModeSource}

var _MacvlanModeNameToValueMap = map[string]MacvlanMode{
	_MacvlanModeName_0[0:7]:       MacvlanModePrivate,
	_MacvlanModeLowerName_0[0:7]:  MacvlanModePrivate,
	_MacvlanModeName_0[7:11]:      MacvlanModeVEPA,
	_MacvlanModeLowerName_0[7:11]: MacvlanModeVEPA,
	_MacvlanModeName_1[0:6]:       MacvlanModeBridge,
	_MacvlanModeLowerName_1[0:6]:  MacvlanModeBridge,
	_MacvlanModeName_2[0:8]:       MacvlanModePassthru,
	_MacvlanModeLowerName_2[0:8]:  MacvlanModePassthru,
	_MacvlanModeName_3[0:6]:       MacvlanModeSource,
	_MacvlanModeLowerName_3[0:6]:  MacvlanModeSource,
}

var _MacvlanModeNames = []string{
	_MacvlanModeName_0[0:7],
	_MacvlanModeName_0[7:11],
	_MacvlanModeName_1[0:6],
	_MacvlanModeName_2[0:8],
	_MacvlanModeName_3[0:6],
}

// MacvlanModeString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func MacvlanModeString(s string) (MacvlanMode, error) {
	if val, ok := _MacvlanModeNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _MacvlanModeNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to MacvlanMode values", s)
}

// MacvlanModeValues returns all values of the enum
func MacvlanModeValues() []MacvlanMode {
	return _MacvlanModeValues
}

// MacvlanModeStrings returns a slice of all String values of the enum
func MacvlanModeStrings() []string {
	strs := make([]string, len(_MacvlanModeNames))
	copy(strs, _MacvlanModeNames)
	return strs
}

// IsAMacvlanMode returns "true" if the value is listed in the enum definition. "false" otherwise
func (i MacvlanMode) IsAMacvlanMode() bool {
	for _, v := range _MacvlanModeValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for MacvlanMode
func (i MacvlanMode) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for MacvlanMode
func (i *MacvlanMode) UnmarshalText(text []byte) error {
	var err error
	*i, err = MacvlanModeString(string(text))
	return err
}
