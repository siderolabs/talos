...
func (ImageServicePullLayerProgress_Status) EnumDescriptor() ([]byte, []int) {
	return file_machine_image_proto_rawDescGZIP(), []int{7, 0}
}

type ContainerdInstance struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Containerd instance to use.
	Driver common.ContainerDriver `protobuf:"varint,1,opt,name=driver,proto3,enum=common.ContainerDriver" json:"driver,omitempty"`
	// Containerd namespace to use.
	Namespace     common.ContainerdNamespace `protobuf:"varint,2,opt,name=namespace,proto3,enum=common.ContainerdNamespace" json:"namespace,omitempty"`
...
func (x *ContainerdInstance) GetDriver() common.ContainerDriver {
	if x != nil {
		return x.Driver
	}
...
func (x *ContainerdInstance) GetNamespace() common.ContainerdNamespace {
	if x != nil {
		return x.Namespace
	}
...
type ImageServiceListRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Containerd    *ContainerdInstance    `protobuf:"bytes,1,opt,name=containerd,proto3" json:"containerd,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ImageServiceListRequest) GetContainerd() *ContainerdInstance {
	if x != nil {
		return x.Containerd
	}
	return nil
...
func (x *ImageServicePullRequest) GetContainerd() *ContainerdInstance {
	if x != nil {
		return x.Containerd
	}
	return nil
...
func (x *ImageServiceImportRequest) GetContainerd() *ContainerdInstance {
	if x != nil {
...
type ImageServiceImportRequest_Containerd struct {
	// Containerd instance to use.
	Containerd *ContainerdInstance `protobuf:"bytes,1,opt,name=containerd,proto3,oneof"`
}
...
const file_machine_image_proto_rawDesc = "" +
	"\n" +
	"\x13machine/image.proto\x12\amachine\x1a\x13common/common.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x80\x01\n" +
	"\x12ContainerdInstance\x12/\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x17.common.ContainerDriverR\x06driver\x129\n" +
	"\tnamespace\x18\x02 \x01(\x0e2\x1b.common.ContainerdNamespaceR\tnamespace\"V\n" +
	"\x17ImageServiceListRequest\x12;\n" +
	"\n" +
	"containerd\x18\x01 \x01(\v2\x1b.machine.ContainerdInstanceR\n" +
	"containerd\"\x95\x01\n" +
	...
	"\n" +
	"containerd\x18\x01 \x01(\v2\x1b.machine.ContainerdInstanceH\x00R\n" +
	"containerd\x12/\n" +
	...
	"\bprogress\x18\x02 \x01(\v2&.machine.ImageServicePullLayerProgressR\bprogress2\x81\x02\n" +
	"\fImageService\x12M\n" +
	...
	"\x06Import\x12\".machine.ImageServiceImportRequest\x1a#.machine.ImageServiceImportResponse(\x01BN\n" +
...
var file_machine_image_proto_goTypes = []any{
	...
	(*ContainerdInstance)(nil),                // 1: machine.ContainerdInstance
	(*ImageServiceListRequest)(nil),           // 2: machine.ImageServiceListRequest
	(*ImageServiceListResponse)(nil),          // 3: machine.ImageServiceListResponse
	(*ImageServicePullRequest)(nil),           // 4: machine.ImageServicePullRequest
	(*ImageServicePullResponse)(nil),          // 5: machine.ImageServicePullResponse
	(*ImageServiceImportRequest)(nil),         // 6: machine.ImageServiceImportRequest
	(*ImageServiceImportResponse)(nil),        // 7: machine.ImageServiceImportResponse
	(*ImageServicePullLayerProgress)(nil),     // 8: machine.ImageServicePullLayerProgress
	(*ImageServicePullProgress)(nil),          // 9: machine.ImageServicePullProgress
	(common.ContainerDriver)(0),               // 10: common.ContainerDriver
	(common.ContainerdNamespace)(0),           // 11: common.ContainerdNamespace
	(*timestamppb.Timestamp)(nil),             // 12: google.protobuf.Timestamp
	(*common.Data)(nil),                       // 13: common.Data
	(*durationpb.Duration)(nil),               // 14: google.protobuf.Duration
}
var file_machine_image_proto_depIdxs = []int32{
	10, // 0: machine.ContainerdInstance.driver:type_name -> common.ContainerDriver
	11, // 1: machine.ContainerdInstance.namespace:type_name -> common.ContainerdNamespace
	1,  // 2: machine.ImageServiceListRequest.containerd:type_name -> machine.ContainerdInstance
	12, // 3: machine.ImageServiceListResponse.created_at:type_name -> google.protobuf.Timestamp
	1,  // 4: machine.ImageServicePullRequest.containerd:type_name -> machine.ContainerdInstance
	9,  // 5: machine.ImageServicePullResponse.pull_progress:type_name -> machine.ImageServicePullProgress
	1,  // 6: machine.ImageServiceImportRequest.containerd:type_name -> machine.ContainerdInstance
	13, // 7: machine.ImageServiceImportRequest.image_chunk:type_name -> common.Data
	0,  // 8: machine.ImageServicePullLayerProgress.status:type_name -> machine.ImageServicePullLayerProgress.Status
	14, // 9: machine.ImageServicePullLayerProgress.elapsed:type_name -> google.protobuf.Duration
	8,  // 10: machine.ImageServicePullProgress.progress:type_name -> machine.ImageServicePullLayerProgress
	2,  // 11: machine.ImageService.List:input_type -> machine.ImageServiceListRequest
	4,  // 12: machine.ImageService.Pull:input_type -> machine.ImageServicePullRequest
	6,  // 13: machine.ImageService.Import:input_type -> machine.ImageServiceImportRequest
	3,  // 14: machine.ImageService.List:output_type -> machine.ImageServiceListResponse
	5,  // 15: machine.ImageService.Pull:output_type -> machine.ImageServicePullResponse
	7,  // 16: machine.ImageService.Import:output_type -> machine.ImageServiceImportResponse
...
func file_machine_image_proto_init() {
	...
	file_machine_image_proto_msgTypes[5].OneofWrappers = []any{
