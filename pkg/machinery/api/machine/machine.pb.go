...
import (
	...
	storage "github.com/talos-systems/talos/pkg/machinery/api/storage"
)
...
var file_machine_machine_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x15,
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x19, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x43, 0x6f,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x42, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x43,
	...
	0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x55, 0x0a, 0x1a, 0x41, 0x70,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x12, 0x0a, 0x10, 0x42, 0x6f, 0x6f, 0x74,
	0x73, 0x74, 0x72, 0x61, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x39, 0x0a, 0x09,
	...
	0x08, 0x0a, 0x04, 0x53, 0x54, 0x4f, 0x50, 0x10, 0x01, 0x22, 0xfb, 0x01, 0x0a, 0x11, 0x53, 0x65,
	...
	0x49, 0x50, 0x50, 0x45, 0x44, 0x10, 0x07, 0x22, 0x6c, 0x0a, 0x0d, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x63, 0x6f, 0x6e, 0x64, 0x73, 0x22, 0x6f, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x2c,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x42, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x65, 0x74, 0x52,
	...
	0x65, 0x70, 0x74, 0x68, 0x22, 0x81, 0x01, 0x0a, 0x10, 0x44, 0x69, 0x73, 0x6b, 0x55, 0x73, 0x61,
	...
	0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x17, 0x0a, 0x15, 0x45, 0x74, 0x63,
	0x64, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x22, 0x58, 0x0a, 0x0e, 0x45, 0x74, 0x63, 0x64, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	...
	0x74, 0x61, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x22, 0x4d, 0x0a, 0x16,
	...
	0x74, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x32, 0xac, 0x01, 0x0a, 0x12,
	...
	0x6b, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xbf, 0x12, 0x0a, 0x0e, 0x4d,
	...
	0x68, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x08, 0x48,
...
var (
	...
	file_machine_machine_proto_goTypes   = []interface{}{
		...
		(*storage.DisksResponse)(nil),         // 117: storage.DisksResponse
		(*common.Data)(nil),                   // 118: common.Data
	}
)
...
var file_machine_machine_proto_depIdxs = []int32{
	...
	116, // 92: machine.MaintenanceService.Disks:input_type -> google.protobuf.Empty
	5,   // 93: machine.MachineService.ApplyConfiguration:input_type -> machine.ApplyConfigurationRequest
	10,  // 94: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	66,  // 95: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	49,  // 96: machine.MachineService.Copy:input_type -> machine.CopyRequest
	116, // 97: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	116, // 98: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	70,  // 99: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	17,  // 100: machine.MachineService.Events:input_type -> machine.EventsRequest
	108, // 101: machine.MachineService.EtcdMemberList:input_type -> machine.EtcdMemberListRequest
	102, // 102: machine.MachineService.EtcdLeaveCluster:input_type -> machine.EtcdLeaveClusterRequest
	105, // 103: machine.MachineService.EtcdForfeitLeadership:input_type -> machine.EtcdForfeitLeadershipRequest
	116, // 104: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	116, // 105: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	50,  // 106: machine.MachineService.List:input_type -> machine.ListRequest
	51,  // 107: machine.MachineService.DiskUsage:input_type -> machine.DiskUsageRequest
	116, // 108: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	61,  // 109: machine.MachineService.Logs:input_type -> machine.LogsRequest
	116, // 110: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	116, // 111: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	116, // 112: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	116, // 113: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	62,  // 114: machine.MachineService.Read:input_type -> machine.ReadRequest
	116, // 115: machine.MachineService.Reboot:input_type -> google.protobuf.Empty
	75,  // 116: machine.MachineService.Restart:input_type -> machine.RestartRequest
	63,  // 117: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	19,  // 118: machine.MachineService.Reset:input_type -> machine.ResetRequest
	22,  // 119: machine.MachineService.Recover:input_type -> machine.RecoverRequest
	116, // 120: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	42,  // 121: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	36,  // 122: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	39,  // 123: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	116, // 124: machine.MachineService.Shutdown:input_type -> google.protobuf.Empty
	78,  // 125: machine.MachineService.Stats:input_type -> machine.StatsRequest
	116, // 126: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	27,  // 127: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	116, // 128: machine.MachineService.Version:input_type -> google.protobuf.Empty
	7,   // 129: machine.MaintenanceService.ApplyConfiguration:output_type -> machine.ApplyConfigurationResponse
	117, // 130: machine.MaintenanceService.Disks:output_type -> storage.DisksResponse
	7,   // 131: machine.MachineService.ApplyConfiguration:output_type -> machine.ApplyConfigurationResponse
	12,  // 132: machine.MachineService.Bootstrap:output_type -> machine.BootstrapResponse
	69,  // 133: machine.MachineService.Containers:output_type -> machine.ContainersResponse
	118, // 134: machine.MachineService.Copy:output_type -> common.Data
	93,  // 135: machine.MachineService.CPUInfo:output_type -> machine.CPUInfoResponse
	99,  // 136: machine.MachineService.DiskStats:output_type -> machine.DiskStatsResponse
	118, // 137: machine.MachineService.Dmesg:output_type -> common.Data
	18,  // 138: machine.MachineService.Events:output_type -> machine.Event
	110, // 139: machine.MachineService.EtcdMemberList:output_type -> machine.EtcdMemberListResponse
	104, // 140: machine.MachineService.EtcdLeaveCluster:output_type -> machine.EtcdLeaveClusterResponse
	107, // 141: machine.MachineService.EtcdForfeitLeadership:output_type -> machine.EtcdForfeitLeadershipResponse
	85,  // 142: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	118, // 143: machine.MachineService.Kubeconfig:output_type -> common.Data
	52,  // 144: machine.MachineService.List:output_type -> machine.FileInfo
	53,  // 145: machine.MachineService.DiskUsage:output_type -> machine.DiskUsageInfo
	87,  // 146: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	118, // 147: machine.MachineService.Logs:output_type -> common.Data
	83,  // 148: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	55,  // 149: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	96,  // 150: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	72,  // 151: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	118, // 152: machine.MachineService.Read:output_type -> common.Data
	9,   // 153: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	77,  // 154: machine.MachineService.Restart:output_type -> machine.RestartResponse
	65,  // 155: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	21,  // 156: machine.MachineService.Reset:output_type -> machine.ResetResponse
	24,  // 157: machine.MachineService.Recover:output_type -> machine.RecoverResponse
	31,  // 158: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	44,  // 159: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	38,  // 160: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	41,  // 161: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	26,  // 162: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	80,  // 163: machine.MachineService.Stats:output_type -> machine.StatsResponse
	89,  // 164: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	29,  // 165: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	58,  // 166: machine.MachineService.Version:output_type -> machine.VersionResponse
...
type MaintenanceServiceClient interface {
	...
	Disks(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*storage.DisksResponse, error)
}
...
func (c *maintenanceServiceClient) Disks(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*storage.DisksResponse, error) {
	out := new(storage.DisksResponse)
	err := c.cc.Invoke(ctx, "/machine.MaintenanceService/Disks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MaintenanceServiceServer interface {
	...
	Disks(context.Context, *empty.Empty) (*storage.DisksResponse, error)
}
...
func (*UnimplementedMaintenanceServiceServer) Disks(context.Context, *empty.Empty) (*storage.DisksResponse, error) {
...
func _MaintenanceService_Disks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MaintenanceServiceServer).Disks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/machine.MaintenanceService/Disks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServiceServer).Disks(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MaintenanceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Disks",
			Handler:    _MaintenanceService_Disks_Handler,
		},
	},
