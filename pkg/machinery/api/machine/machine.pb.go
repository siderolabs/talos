...
const file_machine_machine_proto_rawDesc = "" +
	...
	"termResizeB\t\n" +
	"\arequest\"\x98\x01\n" +
	"\x12DebugContainerSpec\x12\x12\n" +
	"\x04args\x18\x01 \x03(\tR\x04args\x126\n" +
	"\x03env\x18\x02 \x03(\v2$.machine.DebugContainerSpec.EnvEntryR\x03env\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"L\n" +
	"\x1cDebugContainerTerminalResize\x12\x14\n" +
	"\x05width\x18\x01 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x02 \x01(\x05R\x06height\"\x87\x01\n" +
...
var file_machine_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 186)
var file_machine_machine_proto_goTypes = []any{
	...
	(*MachineStatusEvent_MachineStatus)(nil),                // 194: machine.MachineStatusEvent.MachineStatus
	(*MachineStatusEvent_MachineStatus_UnmetCondition)(nil), // 195: machine.MachineStatusEvent.MachineStatus.UnmetCondition
	(*NetstatRequest_Feature)(nil),                          // 196: machine.NetstatRequest.Feature
	(*NetstatRequest_L4Proto)(nil),                          // 197: machine.NetstatRequest.L4proto
	(*NetstatRequest_NetNS)(nil),                            // 198: machine.NetstatRequest.NetNS
	(*ConnectRecord_Process)(nil),                           // 199: machine.ConnectRecord.Process
	nil,                                                     // 200: machine.DebugContainerSpec.EnvEntry
	(*durationpb.Duration)(nil),                             // 201: google.protobuf.Duration
	(*common.Metadata)(nil),                                 // 202: common.Metadata
	(*common.Error)(nil),                                    // 203: common.Error
	(*anypb.Any)(nil),                                       // 204: google.protobuf.Any
	(*timestamppb.Timestamp)(nil),                           // 205: google.protobuf.Timestamp
	(common.ContainerDriver)(0),                             // 206: common.ContainerDriver
	(common.ContainerdNamespace)(0),                         // 207: common.ContainerdNamespace
	(*common.Data)(nil),                                     // 208: common.Data
...
var file_machine_machine_proto_depIdxs = []int32{
	...
	201, // 1: machine.ApplyConfigurationRequest.try_mode_timeout:type_name -> google.protobuf.Duration
	202, // 2: machine.ApplyConfiguration.metadata:type_name -> common.Metadata
	...
	202, // 6: machine.Reboot.metadata:type_name -> common.Metadata
	19,  // 7: machine.RebootResponse.messages:type_name -> machine.Reboot
	202, // 8: machine.Bootstrap.metadata:type_name -> common.Metadata
	...
	203, // 11: machine.SequenceEvent.error:type_name -> common.Error
	...
	194, // 17: machine.MachineStatusEvent.status:type_name -> machine.MachineStatusEvent.MachineStatus
	202, // 18: machine.Event.metadata:type_name -> common.Metadata
	204, // 19: machine.Event.data:type_name -> google.protobuf.Any
	...
	202, // 22: machine.Reset.metadata:type_name -> common.Metadata
	37,  // 23: machine.ResetResponse.messages:type_name -> machine.Reset
	202, // 24: machine.Shutdown.metadata:type_name -> common.Metadata
	...
	202, // 27: machine.Upgrade.metadata:type_name -> common.Metadata
	43,  // 28: machine.UpgradeResponse.messages:type_name -> machine.Upgrade
	202, // 29: machine.ServiceList.metadata:type_name -> common.Metadata
	...
	205, // 35: machine.ServiceEvent.ts:type_name -> google.protobuf.Timestamp
	205, // 36: machine.ServiceHealth.last_change:type_name -> google.protobuf.Timestamp
	202, // 37: machine.ServiceStart.metadata:type_name -> common.Metadata
	52,  // 38: machine.ServiceStartResponse.messages:type_name -> machine.ServiceStart
	202, // 39: machine.ServiceStop.metadata:type_name -> common.Metadata
	55,  // 40: machine.ServiceStopResponse.messages:type_name -> machine.ServiceStop
	202, // 41: machine.ServiceRestart.metadata:type_name -> common.Metadata
	...
	202, // 44: machine.FileInfo.metadata:type_name -> common.Metadata
	64,  // 45: machine.FileInfo.xattrs:type_name -> machine.Xattr
	202, // 46: machine.DiskUsageInfo.metadata:type_name -> common.Metadata
	202, // 47: machine.Mounts.metadata:type_name -> common.Metadata
	68,  // 48: machine.Mounts.stats:type_name -> machine.MountStat
	66,  // 49: machine.MountsResponse.messages:type_name -> machine.Mounts
	202, // 50: machine.Version.metadata:type_name -> common.Metadata
	...
	206, // 55: machine.LogsRequest.driver:type_name -> common.ContainerDriver
	202, // 56: machine.LogsContainer.metadata:type_name -> common.Metadata
	76,  // 57: machine.LogsContainersResponse.messages:type_name -> machine.LogsContainer
	202, // 58: machine.Rollback.metadata:type_name -> common.Metadata
	79,  // 59: machine.RollbackResponse.messages:type_name -> machine.Rollback
	206, // 60: machine.ContainersRequest.driver:type_name -> common.ContainerDriver
	202, // 61: machine.Container.metadata:type_name -> common.Metadata
	...
	202, // 65: machine.Process.metadata:type_name -> common.Metadata
	88,  // 66: machine.Process.processes:type_name -> machine.ProcessInfo
	206, // 67: machine.RestartRequest.driver:type_name -> common.ContainerDriver
	202, // 68: machine.Restart.metadata:type_name -> common.Metadata
	90,  // 69: machine.RestartResponse.messages:type_name -> machine.Restart
	206, // 70: machine.StatsRequest.driver:type_name -> common.ContainerDriver
	202, // 71: machine.Stats.metadata:type_name -> common.Metadata
	95,  // 72: machine.Stats.stats:type_name -> machine.Stat
	93,  // 73: machine.StatsResponse.messages:type_name -> machine.Stats
	202, // 74: machine.Memory.metadata:type_name -> common.Metadata
	...
	202, // 78: machine.Hostname.metadata:type_name -> common.Metadata
	102, // 79: machine.LoadAvgResponse.messages:type_name -> machine.LoadAvg
	202, // 80: machine.LoadAvg.metadata:type_name -> common.Metadata
	104, // 81: machine.SystemStatResponse.messages:type_name -> machine.SystemStat
	202, // 82: machine.SystemStat.metadata:type_name -> common.Metadata
	...
	202, // 87: machine.CPUsFreqStats.metadata:type_name -> common.Metadata
	...
	202, // 90: machine.CPUsInfo.metadata:type_name -> common.Metadata
	...
	202, // 93: machine.NetworkDeviceStats.metadata:type_name -> common.Metadata
	...
	202, // 111: machine.EtcdRecover.metadata:type_name -> common.Metadata
	...
	202, // 114: machine.EtcdAlarm.metadata:type_name -> common.Metadata
	...
	202, // 118: machine.EtcdAlarmDisarm.metadata:type_name -> common.Metadata
	...
	202, // 121: machine.EtcdDefragment.metadata:type_name -> common.Metadata
	146, // 122: machine.EtcdStatusResponse.messages:type_name -> machine.EtcdStatus
	202, // 123: machine.EtcdStatus.metadata:type_name -> common.Metadata
	...
	202, // 126: machine.EtcdDowngradeValidate.metadata:type_name -> common.Metadata
	...
	202, // 129: machine.EtcdDowngradeEnable.metadata:type_name -> common.Metadata
	...
	202, // 132: machine.EtcdDowngradeCancel.metadata:type_name -> common.Metadata
	...
	205, // 145: machine.GenerateConfigurationRequest.override_time:type_name -> google.protobuf.Timestamp
	202, // 146: machine.GenerateConfiguration.metadata:type_name -> common.Metadata
	168, // 147: machine.GenerateConfigurationResponse.messages:type_name -> machine.GenerateConfiguration
	201, // 148: machine.GenerateClientConfigurationRequest.crt_ttl:type_name -> google.protobuf.Duration
	202, // 149: machine.GenerateClientConfiguration.metadata:type_name -> common.Metadata
	...
	196, // 153: machine.NetstatRequest.feature:type_name -> machine.NetstatRequest.Feature
	197, // 154: machine.NetstatRequest.l4proto:type_name -> machine.NetstatRequest.L4proto
	198, // 155: machine.NetstatRequest.netns:type_name -> machine.NetstatRequest.NetNS
	...
	199, // 158: machine.ConnectRecord.process:type_name -> machine.ConnectRecord.Process
	202, // 159: machine.Netstat.metadata:type_name -> common.Metadata
	...
	202, // 162: machine.MetaWrite.metadata:type_name -> common.Metadata
	180, // 163: machine.MetaWriteResponse.messages:type_name -> machine.MetaWrite
	202, // 164: machine.MetaDelete.metadata:type_name -> common.Metadata
	183, // 165: machine.MetaDeleteResponse.messages:type_name -> machine.MetaDelete
	207, // 166: machine.ImageListRequest.namespace:type_name -> common.ContainerdNamespace
	202, // 167: machine.ImageListResponse.metadata:type_name -> common.Metadata
	205, // 168: machine.ImageListResponse.created_at:type_name -> google.protobuf.Timestamp
	207, // 169: machine.ImagePullRequest.namespace:type_name -> common.ContainerdNamespace
	202, // 170: machine.ImagePull.metadata:type_name -> common.Metadata
	...
	208, // 173: machine.DebugContainerRequest.image_chunk:type_name -> common.Data
	192, // 174: machine.DebugContainerRequest.term_resize:type_name -> machine.DebugContainerTerminalResize
	200, // 175: machine.DebugContainerSpec.env:type_name -> machine.DebugContainerSpec.EnvEntry
	195, // 176: machine.MachineStatusEvent.MachineStatus.unmet_conditions:type_name -> machine.MachineStatusEvent.MachineStatus.UnmetCondition
	15,  // 177: machine.MachineService.ApplyConfiguration:input_type -> machine.ApplyConfigurationRequest
	21,  // 178: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	81,  // 179: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	60,  // 180: machine.MachineService.Copy:input_type -> machine.CopyRequest
	209, // 181: machine.MachineService.CPUFreqStats:input_type -> google.protobuf.Empty
	209, // 182: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	209, // 183: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	85,  // 184: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	33,  // 185: machine.MachineService.Events:input_type -> machine.EventsRequest
	131, // 186: machine.MachineService.EtcdMemberList:input_type -> machine.EtcdMemberListRequest
	125, // 187: machine.MachineService.EtcdRemoveMemberByID:input_type -> machine.EtcdRemoveMemberByIDRequest
	119, // 188: machine.MachineService.EtcdLeaveCluster:input_type -> machine.EtcdLeaveClusterRequest
	128, // 189: machine.MachineService.EtcdForfeitLeadership:input_type -> machine.EtcdForfeitLeadershipRequest
	208, // 190: machine.MachineService.EtcdRecover:input_type -> common.Data
	135, // 191: machine.MachineService.EtcdSnapshot:input_type -> machine.EtcdSnapshotRequest
	209, // 192: machine.MachineService.EtcdAlarmList:input_type -> google.protobuf.Empty
	209, // 193: machine.MachineService.EtcdAlarmDisarm:input_type -> google.protobuf.Empty
	209, // 194: machine.MachineService.EtcdDefragment:input_type -> google.protobuf.Empty
	209, // 195: machine.MachineService.EtcdStatus:input_type -> google.protobuf.Empty
	148, // 196: machine.MachineService.EtcdDowngradeValidate:input_type -> machine.EtcdDowngradeValidateRequest
	151, // 197: machine.MachineService.EtcdDowngradeEnable:input_type -> machine.EtcdDowngradeEnableRequest
	209, // 198: machine.MachineService.EtcdDowngradeCancel:input_type -> google.protobuf.Empty
	167, // 199: machine.MachineService.GenerateConfiguration:input_type -> machine.GenerateConfigurationRequest
	209, // 200: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	209, // 201: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	61,  // 202: machine.MachineService.List:input_type -> machine.ListRequest
	62,  // 203: machine.MachineService.DiskUsage:input_type -> machine.DiskUsageRequest
	209, // 204: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	74,  // 205: machine.MachineService.Logs:input_type -> machine.LogsRequest
	209, // 206: machine.MachineService.LogsContainers:input_type -> google.protobuf.Empty
	209, // 207: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	209, // 208: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	209, // 209: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	209, // 210: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	75,  // 211: machine.MachineService.Read:input_type -> machine.ReadRequest
	18,  // 212: machine.MachineService.Reboot:input_type -> machine.RebootRequest
	89,  // 213: machine.MachineService.Restart:input_type -> machine.RestartRequest
	78,  // 214: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	36,  // 215: machine.MachineService.Reset:input_type -> machine.ResetRequest
	209, // 216: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	57,  // 217: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	51,  // 218: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	54,  // 219: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	40,  // 220: machine.MachineService.Shutdown:input_type -> machine.ShutdownRequest
	92,  // 221: machine.MachineService.Stats:input_type -> machine.StatsRequest
	209, // 222: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	42,  // 223: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	209, // 224: machine.MachineService.Version:input_type -> google.protobuf.Empty
	170, // 225: machine.MachineService.GenerateClientConfiguration:input_type -> machine.GenerateClientConfigurationRequest
	173, // 226: machine.MachineService.PacketCapture:input_type -> machine.PacketCaptureRequest
	175, // 227: machine.MachineService.Netstat:input_type -> machine.NetstatRequest
	179, // 228: machine.MachineService.MetaWrite:input_type -> machine.MetaWriteRequest
	182, // 229: machine.MachineService.MetaDelete:input_type -> machine.MetaDeleteRequest
	185, // 230: machine.MachineService.ImageList:input_type -> machine.ImageListRequest
	187, // 231: machine.MachineService.ImagePull:input_type -> machine.ImagePullRequest
	190, // 232: machine.MachineService.DebugContainer:input_type -> machine.DebugContainerRequest
	...
	208, // 236: machine.MachineService.Copy:output_type -> common.Data
	...
	208, // 240: machine.MachineService.Dmesg:output_type -> common.Data
	...
	208, // 247: machine.MachineService.EtcdSnapshot:output_type -> common.Data
	...
	169, // 255: machine.MachineService.GenerateConfiguration:output_type -> machine.GenerateConfigurationResponse
	99,  // 256: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	208, // 257: machine.MachineService.Kubeconfig:output_type -> common.Data
	63,  // 258: machine.MachineService.List:output_type -> machine.FileInfo
	65,  // 259: machine.MachineService.DiskUsage:output_type -> machine.DiskUsageInfo
	101, // 260: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	208, // 261: machine.MachineService.Logs:output_type -> common.Data
	77,  // 262: machine.MachineService.LogsContainers:output_type -> machine.LogsContainersResponse
	97,  // 263: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	67,  // 264: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	113, // 265: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	86,  // 266: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	208, // 267: machine.MachineService.Read:output_type -> common.Data
	20,  // 268: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	91,  // 269: machine.MachineService.Restart:output_type -> machine.RestartResponse
	80,  // 270: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	38,  // 271: machine.MachineService.Reset:output_type -> machine.ResetResponse
	46,  // 272: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	59,  // 273: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	53,  // 274: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	56,  // 275: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	41,  // 276: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	94,  // 277: machine.MachineService.Stats:output_type -> machine.StatsResponse
	103, // 278: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	44,  // 279: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	70,  // 280: machine.MachineService.Version:output_type -> machine.VersionResponse
	172, // 281: machine.MachineService.GenerateClientConfiguration:output_type -> machine.GenerateClientConfigurationResponse
	208, // 282: machine.MachineService.PacketCapture:output_type -> common.Data
	178, // 283: machine.MachineService.Netstat:output_type -> machine.NetstatResponse
	181, // 284: machine.MachineService.MetaWrite:output_type -> machine.MetaWriteResponse
	184, // 285: machine.MachineService.MetaDelete:output_type -> machine.MetaDeleteResponse
	186, // 286: machine.MachineService.ImageList:output_type -> machine.ImageListResponse
	189, // 287: machine.MachineService.ImagePull:output_type -> machine.ImagePullResponse
	193, // 288: machine.MachineService.DebugContainer:output_type -> machine.DebugContainerResponse
	233, // [233:289] is the sub-list for method output_type
	177, // [177:233] is the sub-list for method input_type
