...
var file_machine_machine_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x22, 0x84, 0x02, 0x0a, 0x1c, 0x47, 0x65, 0x6e, 0x65, 0x72,
	...
	0x0c, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x83, 0x01,
	...
	0x66, 0x69, 0x67, 0x32, 0xa7, 0x13, 0x0a, 0x0e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x53,
...
var file_machine_machine_proto_depIdxs = []int32{
	...
	124, // 99: machine.GenerateConfigurationRequest.override_time:type_name -> google.protobuf.Timestamp
	121, // 100: machine.GenerateConfigurationResponse.metadata:type_name -> common.Metadata
	6,   // 101: machine.MachineService.ApplyConfiguration:input_type -> machine.ApplyConfigurationRequest
	11,  // 102: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	67,  // 103: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	50,  // 104: machine.MachineService.Copy:input_type -> machine.CopyRequest
	126, // 105: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	126, // 106: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	71,  // 107: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	18,  // 108: machine.MachineService.Events:input_type -> machine.EventsRequest
	109, // 109: machine.MachineService.EtcdMemberList:input_type -> machine.EtcdMemberListRequest
	103, // 110: machine.MachineService.EtcdLeaveCluster:input_type -> machine.EtcdLeaveClusterRequest
	106, // 111: machine.MachineService.EtcdForfeitLeadership:input_type -> machine.EtcdForfeitLeadershipRequest
	119, // 112: machine.MachineService.GenerateConfiguration:input_type -> machine.GenerateConfigurationRequest
	126, // 113: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	126, // 114: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	51,  // 115: machine.MachineService.List:input_type -> machine.ListRequest
	52,  // 116: machine.MachineService.DiskUsage:input_type -> machine.DiskUsageRequest
	126, // 117: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	62,  // 118: machine.MachineService.Logs:input_type -> machine.LogsRequest
	126, // 119: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	126, // 120: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	126, // 121: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	126, // 122: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	63,  // 123: machine.MachineService.Read:input_type -> machine.ReadRequest
	126, // 124: machine.MachineService.Reboot:input_type -> google.protobuf.Empty
	76,  // 125: machine.MachineService.Restart:input_type -> machine.RestartRequest
	64,  // 126: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	20,  // 127: machine.MachineService.Reset:input_type -> machine.ResetRequest
	23,  // 128: machine.MachineService.Recover:input_type -> machine.RecoverRequest
	126, // 129: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	43,  // 130: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	37,  // 131: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	40,  // 132: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	126, // 133: machine.MachineService.Shutdown:input_type -> google.protobuf.Empty
	79,  // 134: machine.MachineService.Stats:input_type -> machine.StatsRequest
	126, // 135: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	28,  // 136: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	126, // 137: machine.MachineService.Version:input_type -> google.protobuf.Empty
	8,   // 138: machine.MachineService.ApplyConfiguration:output_type -> machine.ApplyConfigurationResponse
	13,  // 139: machine.MachineService.Bootstrap:output_type -> machine.BootstrapResponse
	70,  // 140: machine.MachineService.Containers:output_type -> machine.ContainersResponse
	127, // 141: machine.MachineService.Copy:output_type -> common.Data
	94,  // 142: machine.MachineService.CPUInfo:output_type -> machine.CPUInfoResponse
	100, // 143: machine.MachineService.DiskStats:output_type -> machine.DiskStatsResponse
	127, // 144: machine.MachineService.Dmesg:output_type -> common.Data
	19,  // 145: machine.MachineService.Events:output_type -> machine.Event
	111, // 146: machine.MachineService.EtcdMemberList:output_type -> machine.EtcdMemberListResponse
	105, // 147: machine.MachineService.EtcdLeaveCluster:output_type -> machine.EtcdLeaveClusterResponse
	108, // 148: machine.MachineService.EtcdForfeitLeadership:output_type -> machine.EtcdForfeitLeadershipResponse
	120, // 149: machine.MachineService.GenerateConfiguration:output_type -> machine.GenerateConfigurationResponse
	86,  // 150: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	127, // 151: machine.MachineService.Kubeconfig:output_type -> common.Data
	53,  // 152: machine.MachineService.List:output_type -> machine.FileInfo
	54,  // 153: machine.MachineService.DiskUsage:output_type -> machine.DiskUsageInfo
	88,  // 154: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	127, // 155: machine.MachineService.Logs:output_type -> common.Data
	84,  // 156: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	56,  // 157: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	97,  // 158: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	73,  // 159: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	127, // 160: machine.MachineService.Read:output_type -> common.Data
	10,  // 161: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	78,  // 162: machine.MachineService.Restart:output_type -> machine.RestartResponse
	66,  // 163: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	22,  // 164: machine.MachineService.Reset:output_type -> machine.ResetResponse
	25,  // 165: machine.MachineService.Recover:output_type -> machine.RecoverResponse
	32,  // 166: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	45,  // 167: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	39,  // 168: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	42,  // 169: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	27,  // 170: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	81,  // 171: machine.MachineService.Stats:output_type -> machine.StatsResponse
	90,  // 172: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	30,  // 173: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	59,  // 174: machine.MachineService.Version:output_type -> machine.VersionResponse
