...
func (x *ApplyConfigurationResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_machine_machine_proto_rawDesc = []byte{
	...
	0x41, 0x0a, 0x1a, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72,
	...
	0x6f, 0x72, 0x22, 0x36, 0x0a, 0x06, 0x52, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x12, 0x2c, 0x0a, 0x08,
	...
	0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x12, 0x0a, 0x10, 0x42, 0x6f, 0x6f,
	0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x39, 0x0a,
	...
	0x12, 0x08, 0x0a, 0x04, 0x53, 0x54, 0x4f, 0x50, 0x10, 0x01, 0x22, 0xfb, 0x01, 0x0a, 0x11, 0x53,
	...
	0x4b, 0x49, 0x50, 0x50, 0x45, 0x44, 0x10, 0x07, 0x22, 0x6c, 0x0a, 0x0d, 0x45, 0x76, 0x65, 0x6e,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x42, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x65, 0x74,
	...
	0x01, 0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x22, 0x35, 0x0a, 0x05, 0x52,
	...
	0x67, 0x65, 0x73, 0x22, 0x42, 0x0a, 0x0e, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65,
	...
	0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x22, 0x49, 0x0a, 0x07, 0x55, 0x70, 0x67, 0x72, 0x61,
	...
	0x64, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12,
	...
	0x44, 0x65, 0x70, 0x74, 0x68, 0x22, 0xf6, 0x01, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e,
	...
	0x64, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x32, 0xe9, 0x0f, 0x0a, 0x0e, 0x4d, 0x61, 0x63, 0x68,
	...
	0x6e, 0x74, 0x30, 0x01, 0x12, 0x3d, 0x0a, 0x08, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x65, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x07,
...
var (
	...
	file_machine_machine_proto_goTypes   = []interface{}{
		...
		(*common.Error)(nil),               // 99: common.Error
...
var file_machine_machine_proto_depIdxs = []int32{
	99,  // 0: machine.ApplyConfigurationResponse.error:type_name -> common.Error
	100, // 1: machine.Reboot.metadata:type_name -> common.Metadata
	7,   // 2: machine.RebootResponse.messages:type_name -> machine.Reboot
	100, // 3: machine.Bootstrap.metadata:type_name -> common.Metadata
	10,  // 4: machine.BootstrapResponse.messages:type_name -> machine.Bootstrap
	0,   // 5: machine.SequenceEvent.action:type_name -> machine.SequenceEvent.Action
	99,  // 6: machine.SequenceEvent.error:type_name -> common.Error
	1,   // 7: machine.PhaseEvent.action:type_name -> machine.PhaseEvent.Action
	2,   // 8: machine.TaskEvent.action:type_name -> machine.TaskEvent.Action
	3,   // 9: machine.ServiceStateEvent.action:type_name -> machine.ServiceStateEvent.Action
	100, // 10: machine.Event.metadata:type_name -> common.Metadata
	101, // 11: machine.Event.data:type_name -> google.protobuf.Any
	100, // 12: machine.Reset.metadata:type_name -> common.Metadata
	19,  // 13: machine.ResetResponse.messages:type_name -> machine.Reset
	4,   // 14: machine.RecoverRequest.source:type_name -> machine.RecoverRequest.Source
	100, // 15: machine.Recover.metadata:type_name -> common.Metadata
	22,  // 16: machine.RecoverResponse.messages:type_name -> machine.Recover
	100, // 17: machine.Shutdown.metadata:type_name -> common.Metadata
	24,  // 18: machine.ShutdownResponse.messages:type_name -> machine.Shutdown
	100, // 19: machine.Upgrade.metadata:type_name -> common.Metadata
	27,  // 20: machine.UpgradeResponse.messages:type_name -> machine.Upgrade
	100, // 21: machine.ServiceList.metadata:type_name -> common.Metadata
	31,  // 22: machine.ServiceList.services:type_name -> machine.ServiceInfo
	29,  // 23: machine.ServiceListResponse.messages:type_name -> machine.ServiceList
	32,  // 24: machine.ServiceInfo.events:type_name -> machine.ServiceEvents
	34,  // 25: machine.ServiceInfo.health:type_name -> machine.ServiceHealth
	33,  // 26: machine.ServiceEvents.events:type_name -> machine.ServiceEvent
	102, // 27: machine.ServiceEvent.ts:type_name -> google.protobuf.Timestamp
	102, // 28: machine.ServiceHealth.last_change:type_name -> google.protobuf.Timestamp
	100, // 29: machine.ServiceStart.metadata:type_name -> common.Metadata
	36,  // 30: machine.ServiceStartResponse.messages:type_name -> machine.ServiceStart
	100, // 31: machine.ServiceStop.metadata:type_name -> common.Metadata
	39,  // 32: machine.ServiceStopResponse.messages:type_name -> machine.ServiceStop
	100, // 33: machine.ServiceRestart.metadata:type_name -> common.Metadata
	42,  // 34: machine.ServiceRestartResponse.messages:type_name -> machine.ServiceRestart
	100, // 35: machine.FileInfo.metadata:type_name -> common.Metadata
	100, // 36: machine.Mounts.metadata:type_name -> common.Metadata
	53,  // 37: machine.Mounts.stats:type_name -> machine.MountStat
	51,  // 38: machine.MountsResponse.messages:type_name -> machine.Mounts
	100, // 39: machine.Version.metadata:type_name -> common.Metadata
	56,  // 40: machine.Version.version:type_name -> machine.VersionInfo
	57,  // 41: machine.Version.platform:type_name -> machine.PlatformInfo
	54,  // 42: machine.VersionResponse.messages:type_name -> machine.Version
	103, // 43: machine.LogsRequest.driver:type_name -> common.ContainerDriver
	100, // 44: machine.Rollback.metadata:type_name -> common.Metadata
	61,  // 45: machine.RollbackResponse.messages:type_name -> machine.Rollback
	103, // 46: machine.ContainersRequest.driver:type_name -> common.ContainerDriver
	100, // 47: machine.Container.metadata:type_name -> common.Metadata
	64,  // 48: machine.Container.containers:type_name -> machine.ContainerInfo
	65,  // 49: machine.ContainersResponse.messages:type_name -> machine.Container
	70,  // 50: machine.ProcessesResponse.messages:type_name -> machine.Process
	100, // 51: machine.Process.metadata:type_name -> common.Metadata
	71,  // 52: machine.Process.processes:type_name -> machine.ProcessInfo
	103, // 53: machine.RestartRequest.driver:type_name -> common.ContainerDriver
	100, // 54: machine.Restart.metadata:type_name -> common.Metadata
	73,  // 55: machine.RestartResponse.messages:type_name -> machine.Restart
	103, // 56: machine.StatsRequest.driver:type_name -> common.ContainerDriver
	100, // 57: machine.Stats.metadata:type_name -> common.Metadata
	78,  // 58: machine.Stats.stats:type_name -> machine.Stat
	76,  // 59: machine.StatsResponse.messages:type_name -> machine.Stats
	100, // 60: machine.Memory.metadata:type_name -> common.Metadata
	81,  // 61: machine.Memory.meminfo:type_name -> machine.MemInfo
	79,  // 62: machine.MemoryResponse.messages:type_name -> machine.Memory
	83,  // 63: machine.HostnameResponse.messages:type_name -> machine.Hostname
	100, // 64: machine.Hostname.metadata:type_name -> common.Metadata
	85,  // 65: machine.LoadAvgResponse.messages:type_name -> machine.LoadAvg
	100, // 66: machine.LoadAvg.metadata:type_name -> common.Metadata
	87,  // 67: machine.SystemStatResponse.messages:type_name -> machine.SystemStat
	100, // 68: machine.SystemStat.metadata:type_name -> common.Metadata
	88,  // 69: machine.SystemStat.cpu_total:type_name -> machine.CPUStat
	88,  // 70: machine.SystemStat.cpu:type_name -> machine.CPUStat
	89,  // 71: machine.SystemStat.soft_irq:type_name -> machine.SoftIRQStat
	91,  // 72: machine.CPUInfoResponse.messages:type_name -> machine.CPUsInfo
	100, // 73: machine.CPUsInfo.metadata:type_name -> common.Metadata
	92,  // 74: machine.CPUsInfo.cpu_info:type_name -> machine.CPUInfo
	94,  // 75: machine.NetworkDeviceStatsResponse.messages:type_name -> machine.NetworkDeviceStats
	100, // 76: machine.NetworkDeviceStats.metadata:type_name -> common.Metadata
	95,  // 77: machine.NetworkDeviceStats.total:type_name -> machine.NetDev
	95,  // 78: machine.NetworkDeviceStats.devices:type_name -> machine.NetDev
	97,  // 79: machine.DiskStatsResponse.messages:type_name -> machine.DiskStats
	100, // 80: machine.DiskStats.metadata:type_name -> common.Metadata
	98,  // 81: machine.DiskStats.total:type_name -> machine.DiskStat
	98,  // 82: machine.DiskStats.devices:type_name -> machine.DiskStat
	5,   // 83: machine.MachineService.ApplyConfiguration:input_type -> machine.ApplyConfigurationRequest
	9,   // 84: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	63,  // 85: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	48,  // 86: machine.MachineService.Copy:input_type -> machine.CopyRequest
	104, // 87: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	104, // 88: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	67,  // 89: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	16,  // 90: machine.MachineService.Events:input_type -> machine.EventsRequest
	104, // 91: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	104, // 92: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	49,  // 93: machine.MachineService.List:input_type -> machine.ListRequest
	104, // 94: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	58,  // 95: machine.MachineService.Logs:input_type -> machine.LogsRequest
	104, // 96: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	104, // 97: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	104, // 98: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	104, // 99: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	59,  // 100: machine.MachineService.Read:input_type -> machine.ReadRequest
	104, // 101: machine.MachineService.Reboot:input_type -> google.protobuf.Empty
	72,  // 102: machine.MachineService.Restart:input_type -> machine.RestartRequest
	60,  // 103: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	18,  // 104: machine.MachineService.Reset:input_type -> machine.ResetRequest
	21,  // 105: machine.MachineService.Recover:input_type -> machine.RecoverRequest
	104, // 106: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	41,  // 107: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	35,  // 108: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	38,  // 109: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	104, // 110: machine.MachineService.Shutdown:input_type -> google.protobuf.Empty
	75,  // 111: machine.MachineService.Stats:input_type -> machine.StatsRequest
	104, // 112: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	26,  // 113: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	104, // 114: machine.MachineService.Version:input_type -> google.protobuf.Empty
	6,   // 115: machine.MachineService.ApplyConfiguration:output_type -> machine.ApplyConfigurationResponse
	11,  // 116: machine.MachineService.Bootstrap:output_type -> machine.BootstrapResponse
	66,  // 117: machine.MachineService.Containers:output_type -> machine.ContainersResponse
	105, // 118: machine.MachineService.Copy:output_type -> common.Data
	90,  // 119: machine.MachineService.CPUInfo:output_type -> machine.CPUInfoResponse
	96,  // 120: machine.MachineService.DiskStats:output_type -> machine.DiskStatsResponse
	105, // 121: machine.MachineService.Dmesg:output_type -> common.Data
	17,  // 122: machine.MachineService.Events:output_type -> machine.Event
	82,  // 123: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	105, // 124: machine.MachineService.Kubeconfig:output_type -> common.Data
	50,  // 125: machine.MachineService.List:output_type -> machine.FileInfo
	84,  // 126: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	105, // 127: machine.MachineService.Logs:output_type -> common.Data
	80,  // 128: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	52,  // 129: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	93,  // 130: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	69,  // 131: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	105, // 132: machine.MachineService.Read:output_type -> common.Data
	8,   // 133: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	74,  // 134: machine.MachineService.Restart:output_type -> machine.RestartResponse
	62,  // 135: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	20,  // 136: machine.MachineService.Reset:output_type -> machine.ResetResponse
	23,  // 137: machine.MachineService.Recover:output_type -> machine.RecoverResponse
	30,  // 138: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	43,  // 139: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	37,  // 140: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	40,  // 141: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	25,  // 142: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	77,  // 143: machine.MachineService.Stats:output_type -> machine.StatsResponse
	86,  // 144: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	28,  // 145: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	55,  // 146: machine.MachineService.Version:output_type -> machine.VersionResponse
	115, // [115:147] is the sub-list for method output_type
	83,  // [83:115] is the sub-list for method input_type
