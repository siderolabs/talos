...
var file_machine_machine_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x73, 0x32, 0xbf, 0x12, 0x0a, 0x0e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65,
	...
	0x73, 0x65, 0x12, 0x43, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x59, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x61,
	0x63, 0x68, 0x69, 0x6e, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x0a, 0x4d, 0x61, 0x63, 0x68, 0x69,
	0x6e, 0x65, 0x41, 0x70, 0x69, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_machine_machine_proto_depIdxs = []int32{
	...
	5,   // 91: machine.MachineService.ApplyConfiguration:input_type -> machine.ApplyConfigurationRequest
	10,  // 92: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	66,  // 93: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	49,  // 94: machine.MachineService.Copy:input_type -> machine.CopyRequest
	116, // 95: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	116, // 96: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	70,  // 97: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	17,  // 98: machine.MachineService.Events:input_type -> machine.EventsRequest
	108, // 99: machine.MachineService.EtcdMemberList:input_type -> machine.EtcdMemberListRequest
	102, // 100: machine.MachineService.EtcdLeaveCluster:input_type -> machine.EtcdLeaveClusterRequest
	105, // 101: machine.MachineService.EtcdForfeitLeadership:input_type -> machine.EtcdForfeitLeadershipRequest
	116, // 102: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	116, // 103: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	50,  // 104: machine.MachineService.List:input_type -> machine.ListRequest
	51,  // 105: machine.MachineService.DiskUsage:input_type -> machine.DiskUsageRequest
	116, // 106: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	61,  // 107: machine.MachineService.Logs:input_type -> machine.LogsRequest
	116, // 108: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	116, // 109: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	116, // 110: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	116, // 111: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	62,  // 112: machine.MachineService.Read:input_type -> machine.ReadRequest
	116, // 113: machine.MachineService.Reboot:input_type -> google.protobuf.Empty
	75,  // 114: machine.MachineService.Restart:input_type -> machine.RestartRequest
	63,  // 115: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	19,  // 116: machine.MachineService.Reset:input_type -> machine.ResetRequest
	22,  // 117: machine.MachineService.Recover:input_type -> machine.RecoverRequest
	116, // 118: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	42,  // 119: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	36,  // 120: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	39,  // 121: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	116, // 122: machine.MachineService.Shutdown:input_type -> google.protobuf.Empty
	78,  // 123: machine.MachineService.Stats:input_type -> machine.StatsRequest
	116, // 124: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	27,  // 125: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	116, // 126: machine.MachineService.Version:input_type -> google.protobuf.Empty
	7,   // 127: machine.MachineService.ApplyConfiguration:output_type -> machine.ApplyConfigurationResponse
	12,  // 128: machine.MachineService.Bootstrap:output_type -> machine.BootstrapResponse
	69,  // 129: machine.MachineService.Containers:output_type -> machine.ContainersResponse
	117, // 130: machine.MachineService.Copy:output_type -> common.Data
	93,  // 131: machine.MachineService.CPUInfo:output_type -> machine.CPUInfoResponse
	99,  // 132: machine.MachineService.DiskStats:output_type -> machine.DiskStatsResponse
	117, // 133: machine.MachineService.Dmesg:output_type -> common.Data
	18,  // 134: machine.MachineService.Events:output_type -> machine.Event
	110, // 135: machine.MachineService.EtcdMemberList:output_type -> machine.EtcdMemberListResponse
	104, // 136: machine.MachineService.EtcdLeaveCluster:output_type -> machine.EtcdLeaveClusterResponse
	107, // 137: machine.MachineService.EtcdForfeitLeadership:output_type -> machine.EtcdForfeitLeadershipResponse
	85,  // 138: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	117, // 139: machine.MachineService.Kubeconfig:output_type -> common.Data
	52,  // 140: machine.MachineService.List:output_type -> machine.FileInfo
	53,  // 141: machine.MachineService.DiskUsage:output_type -> machine.DiskUsageInfo
	87,  // 142: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	117, // 143: machine.MachineService.Logs:output_type -> common.Data
	83,  // 144: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	55,  // 145: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	96,  // 146: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	72,  // 147: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	117, // 148: machine.MachineService.Read:output_type -> common.Data
	9,   // 149: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	77,  // 150: machine.MachineService.Restart:output_type -> machine.RestartResponse
	65,  // 151: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	21,  // 152: machine.MachineService.Reset:output_type -> machine.ResetResponse
	24,  // 153: machine.MachineService.Recover:output_type -> machine.RecoverResponse
	31,  // 154: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	44,  // 155: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	38,  // 156: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	41,  // 157: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	26,  // 158: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	80,  // 159: machine.MachineService.Stats:output_type -> machine.StatsResponse
	89,  // 160: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	29,  // 161: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	58,  // 162: machine.MachineService.Version:output_type -> machine.VersionResponse
	127, // [127:163] is the sub-list for method output_type
	91,  // [91:127] is the sub-list for method input_type
