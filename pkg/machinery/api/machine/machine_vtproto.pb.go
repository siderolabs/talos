...
func (m *ApplyConfigurationRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TryModeTimeout != nil {
		if vtmsg, ok := interface{}(m.TryModeTimeout).(interface {
...
func (m *ResetRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.UserDisksToWipe) > 0 {
		for iNdEx := len(m.UserDisksToWipe) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarint(dAtA, i, uint64(len(m.UserDisksToWipe[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *ServiceHealth) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastChange != nil {
		if vtmsg, ok := interface{}(m.LastChange).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *EtcdMemberStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ProtocolVersion) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ProtocolVersion)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GenerateConfigurationRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.OverrideTime != nil {
		if vtmsg, ok := interface{}(m.OverrideTime).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *GenerateClientConfigurationRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CrtTtl != nil {
		if vtmsg, ok := interface{}(m.CrtTtl).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
...
func (m *NetstatRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Filter != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Filter))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ConnectRecord) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Podpid != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Podpid))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if m.Pointer != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Pointer))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.Ref != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Ref))
		i--
		dAtA[i] = 0x78
	}
	if m.Inode != 0 {
	...
	if m.Retrnsmt != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Retrnsmt))
		i--
		dAtA[i] = 0x58
	}
	if m.Timerwhen != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Timerwhen))
		i--
		dAtA[i] = 0x50
	}
	if m.Tr != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Tr))
		i--
		dAtA[i] = 0x48
	}
	if m.Rxqueue != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Rxqueue))
		i--
		dAtA[i] = 0x40
	}
	if m.Txqueue != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Txqueue))
		i--
		dAtA[i] = 0x38
	}
	if m.State != 0 {
	...
	if m.Remoteport != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Remoteport))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Remoteip) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Remoteip)))
		i--
		dAtA[i] = 0x22
	}
	if m.Localport != 0 {
	...
	if len(m.L4Proto) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.L4Proto)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ConnectRecord) SizeVT() (n int) {
	...
	if m.Remoteport != 0 {
		n += 1 + sov(uint64(m.Remoteport))
	}
	if m.State != 0 {
		n += 1 + sov(uint64(m.State))
	}
	if m.Txqueue != 0 {
		n += 1 + sov(uint64(m.Txqueue))
	}
	if m.Rxqueue != 0 {
		n += 1 + sov(uint64(m.Rxqueue))
	}
	if m.Tr != 0 {
		n += 1 + sov(uint64(m.Tr))
	}
	if m.Timerwhen != 0 {
		n += 1 + sov(uint64(m.Timerwhen))
	}
	if m.Retrnsmt != 0 {
		n += 1 + sov(uint64(m.Retrnsmt))
	}
	if m.Uid != 0 {
		n += 1 + sov(uint64(m.Uid))
	}
	...
	if m.Ref != 0 {
		n += 1 + sov(uint64(m.Ref))
	}
	if m.Pointer != 0 {
		n += 2 + sov(uint64(m.Pointer))
	}
	if m.Process != nil {
		l = m.Process.SizeVT()
		n += 2 + l + sov(uint64(l))
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Podpids) == 0 {
					m.Podpids = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field Podpids", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *ConnectRecord) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Podpid", wireType)
			}
			m.Podpid = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
