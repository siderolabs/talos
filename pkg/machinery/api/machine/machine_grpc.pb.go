...
const (
	...
	MachineService_EncryptionRecoveryKeySupply_FullMethodName = "/machine.MachineService/EncryptionRecoveryKeySupply"
	MachineService_EncryptionRecoveryKeyVerify_FullMethodName = "/machine.MachineService/EncryptionRecoveryKeyVerify"
	MachineService_EncryptionRecoveryKeyFetch_FullMethodName  = "/machine.MachineService/EncryptionRecoveryKeyFetch"
...
type MachineServiceClient interface {
	...
	// EncryptionRecoveryKeySupply supplies the disk encryption recovery key for encrypted volumes.
	EncryptionRecoveryKeySupply(ctx context.Context, in *EncryptionRecoveryKeySupplyRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeySupplyResponse, error)
	// EncryptionRecoveryKeyVerify verifies the disk encryption recovery key against encrypted volumes.
	EncryptionRecoveryKeyVerify(ctx context.Context, in *EncryptionRecoveryKeyVerifyRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeyVerifyResponse, error)
	...
	EncryptionRecoveryKeyFetch(ctx context.Context, in *EncryptionRecoveryKeyFetchRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeyFetchResponse, error)
	// Deprecated: Do not use.
...
func (c *machineServiceClient) EncryptionRecoveryKeySupply(ctx context.Context, in *EncryptionRecoveryKeySupplyRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeySupplyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EncryptionRecoveryKeySupplyResponse)
	err := c.cc.Invoke(ctx, MachineService_EncryptionRecoveryKeySupply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machineServiceClient) EncryptionRecoveryKeyVerify(ctx context.Context, in *EncryptionRecoveryKeyVerifyRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeyVerifyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EncryptionRecoveryKeyVerifyResponse)
	err := c.cc.Invoke(ctx, MachineService_EncryptionRecoveryKeyVerify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machineServiceClient) EncryptionRecoveryKeyFetch(ctx context.Context, in *EncryptionRecoveryKeyFetchRequest, opts ...grpc.CallOption) (*EncryptionRecoveryKeyFetchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EncryptionRecoveryKeyFetchResponse)
	err := c.cc.Invoke(ctx, MachineService_EncryptionRecoveryKeyFetch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MachineServiceServer interface {
	...
	// EncryptionRecoveryKeySupply supplies the disk encryption recovery key for encrypted volumes.
	EncryptionRecoveryKeySupply(context.Context, *EncryptionRecoveryKeySupplyRequest) (*EncryptionRecoveryKeySupplyResponse, error)
	// EncryptionRecoveryKeyVerify verifies the disk encryption recovery key against encrypted volumes.
	EncryptionRecoveryKeyVerify(context.Context, *EncryptionRecoveryKeyVerifyRequest) (*EncryptionRecoveryKeyVerifyResponse, error)
	// EncryptionRecoveryKeyFetch fetches the disk encryption recovery keys generated by the node.
	//
	// Each key is returned once: the node drops it after it was fetched.
	EncryptionRecoveryKeyFetch(context.Context, *EncryptionRecoveryKeyFetchRequest) (*EncryptionRecoveryKeyFetchResponse, error)
	// Deprecated: Do not use.
	// ImageList lists images in the CRI.
	//
	// Use ImageService List RPC instead.
...
func (UnimplementedMachineServiceServer) EncryptionRecoveryKeySupply(context.Context, *EncryptionRecoveryKeySupplyRequest) (*EncryptionRecoveryKeySupplyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EncryptionRecoveryKeySupply not implemented")
}
func (UnimplementedMachineServiceServer) EncryptionRecoveryKeyVerify(context.Context, *EncryptionRecoveryKeyVerifyRequest) (*EncryptionRecoveryKeyVerifyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EncryptionRecoveryKeyVerify not implemented")
}
func (UnimplementedMachineServiceServer) EncryptionRecoveryKeyFetch(context.Context, *EncryptionRecoveryKeyFetchRequest) (*EncryptionRecoveryKeyFetchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EncryptionRecoveryKeyFetch not implemented")
}
...
func _MachineService_EncryptionRecoveryKeySupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EncryptionRecoveryKeySupplyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MachineServiceServer).EncryptionRecoveryKeySupply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MachineService_EncryptionRecoveryKeySupply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineServiceServer).EncryptionRecoveryKeySupply(ctx, req.(*EncryptionRecoveryKeySupplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MachineService_EncryptionRecoveryKeyVerify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EncryptionRecoveryKeyVerifyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MachineServiceServer).EncryptionRecoveryKeyVerify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MachineService_EncryptionRecoveryKeyVerify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineServiceServer).EncryptionRecoveryKeyVerify(ctx, req.(*EncryptionRecoveryKeyVerifyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MachineService_EncryptionRecoveryKeyFetch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EncryptionRecoveryKeyFetchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MachineServiceServer).EncryptionRecoveryKeyFetch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MachineService_EncryptionRecoveryKeyFetch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MachineServiceServer).EncryptionRecoveryKeyFetch(ctx, req.(*EncryptionRecoveryKeyFetchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MachineService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EncryptionRecoveryKeySupply",
			Handler:    _MachineService_EncryptionRecoveryKeySupply_Handler,
		},
		{
			MethodName: "EncryptionRecoveryKeyVerify",
			Handler:    _MachineService_EncryptionRecoveryKeyVerify_Handler,
		},
		{
			MethodName: "EncryptionRecoveryKeyFetch",
			Handler:    _MachineService_EncryptionRecoveryKeyFetch_Handler,
		},
		{
