...
func (m *MemoryModuleSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ProductName) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ProductName)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.AssetTag) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.AssetTag)))
		i--
		dAtA[i] = 0x3a
	}
	...
	if m.Speed != 0 {
		i = encodeVarint(dAtA, i, uint64(m.Speed))
		i--
		dAtA[i] = 0x20
	}
	if len(m.BankLocator) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.BankLocator)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.DeviceLocator) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.DeviceLocator)))
		i--
		dAtA[i] = 0x12
	}
	if m.Size != 0 {
...
func (m *ProcessorSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CoreEnabled != 0 {
		i = encodeVarint(dAtA, i, uint64(m.CoreEnabled))
		i--
		dAtA[i] = 0x58
	}
	if m.CoreCount != 0 {
	...
	if len(m.PartNumber) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.PartNumber)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.AssetTag) > 0 {
	...
	if m.BootSpeed != 0 {
		i = encodeVarint(dAtA, i, uint64(m.BootSpeed))
		i--
		dAtA[i] = 0x28
	}
	if m.MaxSpeed != 0 {
		i = encodeVarint(dAtA, i, uint64(m.MaxSpeed))
		i--
		dAtA[i] = 0x20
	}
	if len(m.ProductName) > 0 {
	...
	if len(m.Socket) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Socket)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SystemInformationSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.SkuNumber) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SkuNumber)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.WakeUpType) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.WakeUpType)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Uuid) > 0 {
...
func (m *ProcessorSpec) SizeVT() (n int) {
	...
	if m.MaxSpeed != 0 {
		n += 1 + sov(uint64(m.MaxSpeed))
	}
	if m.BootSpeed != 0 {
		n += 1 + sov(uint64(m.BootSpeed))
	}
	if m.Status != 0 {
