...
const (
	...
	BlockFilesystemType_FILESYSTEM_TYPE_NFS      BlockFilesystemType = 6
	BlockFilesystemType_FILESYSTEM_TYPE_VIRTIOFS BlockFilesystemType = 7
)
...
var (
	BlockFilesystemType_name = map[int32]string{
		...
		6: "FILESYSTEM_TYPE_NFS",
		7: "FILESYSTEM_TYPE_VIRTIOFS",
	}
...
type BlockNFSVersionType int32

const (
	BlockNFSVersionType_NFS_VERSION_TYPE4_2 BlockNFSVersionType = 0
	BlockNFSVersionType_NFS_VERSION_TYPE4_1 BlockNFSVersionType = 1
	BlockNFSVersionType_NFS_VERSION_TYPE4   BlockNFSVersionType = 2
	BlockNFSVersionType_NFS_VERSION_TYPE3   BlockNFSVersionType = 3
	BlockNFSVersionType_NFS_VERSION_TYPE2   BlockNFSVersionType = 4
)

// Enum value maps for BlockNFSVersionType.
var (
	BlockNFSVersionType_name = map[int32]string{
		0: "NFS_VERSION_TYPE4_2",
		1: "NFS_VERSION_TYPE4_1",
		2: "NFS_VERSION_TYPE4",
		3: "NFS_VERSION_TYPE3",
		4: "NFS_VERSION_TYPE2",
	}
	BlockNFSVersionType_value = map[string]int32{
...
func (x BlockNFSVersionType) Enum() *BlockNFSVersionType {
	p := new(BlockNFSVersionType)
	*p = x
	return p
}

func (x BlockNFSVersionType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BlockNFSVersionType) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_definitions_enums_enums_proto_enumTypes[40].Descriptor()
}

func (BlockNFSVersionType) Type() protoreflect.EnumType {
	return &file_resource_definitions_enums_enums_proto_enumTypes[40]
}

func (x BlockNFSVersionType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BlockNFSVersionType.Descriptor instead.
func (BlockNFSVersionType) EnumDescriptor() ([]byte, []int) {
	return file_resource_definitions_enums_enums_proto_rawDescGZIP(), []int{40}
}

// BlockNFSProtocolType describes NFS protocol type.
type BlockNFSProtocolType int32

const (
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_TCP   BlockNFSProtocolType = 0
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_TCP6  BlockNFSProtocolType = 1
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_UDP   BlockNFSProtocolType = 2
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_UDP6  BlockNFSProtocolType = 3
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_RDMA  BlockNFSProtocolType = 4
	BlockNFSProtocolType_NFS_PROTOCOL_TYPE_RDMA6 BlockNFSProtocolType = 5
)

// Enum value maps for BlockNFSProtocolType.
var (
	BlockNFSProtocolType_name = map[int32]string{
		0: "NFS_PROTOCOL_TYPE_TCP",
		1: "NFS_PROTOCOL_TYPE_TCP6",
		2: "NFS_PROTOCOL_TYPE_UDP",
		3: "NFS_PROTOCOL_TYPE_UDP6",
		4: "NFS_PROTOCOL_TYPE_RDMA",
		5: "NFS_PROTOCOL_TYPE_RDMA6",
	}
	BlockNFSProtocolType_value = map[string]int32{
...
func (x BlockNFSProtocolType) Enum() *BlockNFSProtocolType {
	p := new(BlockNFSProtocolType)
	*p = x
	return p
}

func (x BlockNFSProtocolType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BlockNFSProtocolType) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_definitions_enums_enums_proto_enumTypes[41].Descriptor()
}

func (BlockNFSProtocolType) Type() protoreflect.EnumType {
	return &file_resource_definitions_enums_enums_proto_enumTypes[41]
}

func (x BlockNFSProtocolType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BlockNFSProtocolType.Descriptor instead.
func (BlockNFSProtocolType) EnumDescriptor() ([]byte, []int) {
...
const file_resource_definitions_enums_enums_proto_rawDesc = "" +
	...
	"\x11NFS_VERSION_TYPE2\x10\x04*\xbd\x01\n" +
	"\x14BlockNFSProtocolType\x12\x19\n" +
	"\x15NFS_PROTOCOL_TYPE_TCP\x10\x00\x12\x1a\n" +
	"\x16NFS_PROTOCOL_TYPE_TCP6\x10\x01\x12\x19\n" +
	"\x15NFS_PROTOCOL_TYPE_UDP\x10\x02\x12\x1a\n" +
	"\x16NFS_PROTOCOL_TYPE_UDP6\x10\x03\x12\x1a\n" +
	"\x16NFS_PROTOCOL_TYPE_RDMA\x10\x04\x12\x1b\n" +
	"\x17NFS_PROTOCOL_TYPE_RDMA6\x10\x05*\xe3\x01\n" +
...
var file_resource_definitions_enums_enums_proto_goTypes = []any{
	...
	(BlockNFSVersionType)(0),             // 40: talos.resource.definitions.enums.BlockNFSVersionType
	(BlockNFSProtocolType)(0),            // 41: talos.resource.definitions.enums.BlockNFSProtocolType
