...
const file_resource_definitions_block_block_proto_rawDesc = "" +
	...
	"mountpoint\x121\n" +
	"\x06period\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x06period\"\xa3\x01\n" +
	"\x13FSScrubScheduleSpec\x12\x1e\n" +
	"\n" +
	"mountpoint\x18\x01 \x01(\tR\n" +
	"mountpoint\x121\n" +
	"\x06period\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x06period\x129\n" +
	"\n" +
	"start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\"\xe5\x01\n" +
...
var file_resource_definitions_block_block_proto_depIdxs = []int32{
	...
	33, // 4: talos.resource.definitions.block.FSScrubConfigSpec.period:type_name -> google.protobuf.Duration
	33, // 5: talos.resource.definitions.block.FSScrubScheduleSpec.period:type_name -> google.protobuf.Duration
	34, // 6: talos.resource.definitions.block.FSScrubScheduleSpec.start_time:type_name -> google.protobuf.Timestamp
	33, // 7: talos.resource.definitions.block.FSScrubStatusSpec.period:type_name -> google.protobuf.Duration
	34, // 8: talos.resource.definitions.block.FSScrubStatusSpec.time:type_name -> google.protobuf.Timestamp
	33, // 9: talos.resource.definitions.block.FSScrubStatusSpec.duration:type_name -> google.protobuf.Duration
	...
	38, // 27: talos.resource.definitions.block.VolumeStatusSpec.phase:type_name -> talos.resource.definitions.enums.BlockVolumePhase
	38, // 28: talos.resource.definitions.block.VolumeStatusSpec.pre_fail_phase:type_name -> talos.resource.definitions.enums.BlockVolumePhase
	35, // 29: talos.resource.definitions.block.VolumeStatusSpec.filesystem:type_name -> talos.resource.definitions.enums.BlockFilesystemType
	32, // 30: talos.resource.definitions.block.VolumeStatusSpec.encryption_provider:type_name -> talos.resource.definitions.enums.BlockEncryptionProviderType
	14, // 31: talos.resource.definitions.block.VolumeStatusSpec.mount_spec:type_name -> talos.resource.definitions.block.MountSpec
	37, // 32: talos.resource.definitions.block.VolumeStatusSpec.type:type_name -> talos.resource.definitions.enums.BlockVolumeType
	20, // 33: talos.resource.definitions.block.VolumeStatusSpec.symlink_spec:type_name -> talos.resource.definitions.block.SymlinkProvisioningSpec
	23, // 34: talos.resource.definitions.block.VolumeStatusSpec.tpm_encryption_options:type_name -> talos.resource.definitions.block.TPMEncryptionOptionsInfo
