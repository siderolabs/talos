...
type EncryptionKey struct {
	...
	TpmLockToSecureBootState         bool                         `protobuf:"varint,7,opt,name=tpm_lock_to_secure_boot_state,json=tpmLockToSecureBootState,proto3" json:"tpm_lock_to_secure_boot_state,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *EncryptionKey) GetTpmLockToSecureBootState() bool {
	if x != nil {
		return x.TpmLockToSecureBootState
	}
	return false
}
...
const file_resource_definitions_block_block_proto_rawDesc = "" +
	...
	"\bsymlinks\x18\x12 \x03(\tR\bsymlinks\"\xf7\x02\n" +
	...
	"\rlock_to_state\x18\x06 \x01(\bR\vlockToState\x12?\n" +
	"\x1dtpm_lock_to_secure_boot_state\x18\a \x01(\bR\x18tpmLockToSecureBootState\"\xa5\x02\n" +
