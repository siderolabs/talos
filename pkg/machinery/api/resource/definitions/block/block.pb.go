...
func (x *SMARTStatusSpec) GetDeviceType() string {
	if x != nil {
		return x.DeviceType
	}
	return ""
...
const file_resource_definitions_block_block_proto_rawDesc = "" +
	...
	"\afailing\x18\a \x01(\bR\afailing\"\xf9\x03\n" +
	"\x0fSMARTStatusSpec\x12\x19\n" +
	"\bdev_path\x18\x01 \x01(\tR\adevPath\x12\x1f\n" +
...
var file_resource_definitions_block_block_proto_goTypes = []any{
	...
	(*SMARTAttribute)(nil),                 // 16: talos.resource.definitions.block.SMARTAttribute
	(*SMARTStatusSpec)(nil),                // 17: talos.resource.definitions.block.SMARTStatusSpec
	...
	(enums.BlockFSParameterType)(0),        // 34: talos.resource.definitions.enums.BlockFSParameterType
	(enums.BlockVolumeType)(0),             // 35: talos.resource.definitions.enums.BlockVolumeType
...
var file_resource_definitions_block_block_proto_depIdxs = []int32{
	...
	33, // 9: talos.resource.definitions.block.MountStatusSpec.filesystem:type_name -> talos.resource.definitions.enums.BlockFilesystemType
	32, // 10: talos.resource.definitions.block.MountStatusSpec.encryption_provider:type_name -> talos.resource.definitions.enums.BlockEncryptionProviderType
	34, // 11: talos.resource.definitions.block.ParameterSpec.type:type_name -> talos.resource.definitions.enums.BlockFSParameterType
	...
	16, // 15: talos.resource.definitions.block.SMARTStatusSpec.attributes:type_name -> talos.resource.definitions.block.SMARTAttribute
	35, // 16: talos.resource.definitions.block.VolumeConfigSpec.type:type_name -> talos.resource.definitions.enums.BlockVolumeType
	15, // 17: talos.resource.definitions.block.VolumeConfigSpec.provisioning:type_name -> talos.resource.definitions.block.ProvisioningSpec
	9,  // 18: talos.resource.definitions.block.VolumeConfigSpec.locator:type_name -> talos.resource.definitions.block.LocatorSpec
	11, // 19: talos.resource.definitions.block.VolumeConfigSpec.mount:type_name -> talos.resource.definitions.block.MountSpec
	...
	36, // 22: talos.resource.definitions.block.VolumeConfigSpec.trim_interval:type_name -> google.protobuf.Duration
	37, // 23: talos.resource.definitions.block.VolumeStatusSpec.phase:type_name -> talos.resource.definitions.enums.BlockVolumePhase
	37, // 24: talos.resource.definitions.block.VolumeStatusSpec.pre_fail_phase:type_name -> talos.resource.definitions.enums.BlockVolumePhase
	33, // 25: talos.resource.definitions.block.VolumeStatusSpec.filesystem:type_name -> talos.resource.definitions.enums.BlockFilesystemType
	32, // 26: talos.resource.definitions.block.VolumeStatusSpec.encryption_provider:type_name -> talos.resource.definitions.enums.BlockEncryptionProviderType
	11, // 27: talos.resource.definitions.block.VolumeStatusSpec.mount_spec:type_name -> talos.resource.definitions.block.MountSpec
	35, // 28: talos.resource.definitions.block.VolumeStatusSpec.type:type_name -> talos.resource.definitions.enums.BlockVolumeType
	19, // 29: talos.resource.definitions.block.VolumeStatusSpec.symlink_spec:type_name -> talos.resource.definitions.block.SymlinkProvisioningSpec
	22, // 30: talos.resource.definitions.block.VolumeStatusSpec.tpm_encryption_options:type_name -> talos.resource.definitions.block.TPMEncryptionOptionsInfo
	36, // 31: talos.resource.definitions.block.VolumeStatusSpec.trim_interval:type_name -> google.protobuf.Duration
	33, // 32: talos.resource.definitions.block.VolumeTrimScheduleSpec.filesystem:type_name -> talos.resource.definitions.enums.BlockFilesystemType
	36, // 33: talos.resource.definitions.block.VolumeTrimScheduleSpec.interval:type_name -> google.protobuf.Duration
	38, // 34: talos.resource.definitions.block.VolumeTrimScheduleSpec.next_trim:type_name -> google.protobuf.Timestamp
