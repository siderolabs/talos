...
func (x *MountRequestSpec) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
func (x *MountSpec) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
type MountStatusSpec struct {
	...
	Fd                  int64                             `protobuf:"varint,9,opt,name=fd,proto3" json:"fd,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *MountStatusSpec) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
func (x *MountStatusSpec) GetFd() int64 {
	if x != nil {
		return x.Fd
	}
	return 0
...
func (x *VolumeMountRequestSpec) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
type VolumeMountStatusSpec struct {
	...
	Fd            int64                  `protobuf:"varint,6,opt,name=fd,proto3" json:"fd,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VolumeMountStatusSpec) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
func (x *VolumeMountStatusSpec) GetFd() int64 {
	if x != nil {
		return x.Fd
	}
	return 0
...
const file_resource_definitions_block_block_proto_rawDesc = "" +
	...
	"\vLocatorSpec\x12;\n" +
	"\x05match\x18\x01 \x01(\v2%.google.api.expr.v1alpha1.CheckedExprR\x05match\"\xd8\x01\n" +
	...
	"\tread_only\x18\x05 \x01(\bR\breadOnly\x12\x1c\n" +
	"\tanonymous\x18\x06 \x01(\bR\tanonymous\"\xae\x02\n" +
	"\tMountSpec\x12\x1f\n" +
	...
	"\x11recursive_relabel\x18\b \x01(\bR\x10recursiveRelabel\x12\x1c\n" +
	"\tanonymous\x18\t \x01(\bR\tanonymous\"\xcf\x03\n" +
	...
	"\x13encryption_provider\x18\a \x01(\x0e2=.talos.resource.definitions.enums.BlockEncryptionProviderTypeR\x12encryptionProvider\x12\x1c\n" +
	"\tanonymous\x18\b \x01(\bR\tanonymous\x12\x0e\n" +
	"\x02fd\x18\t \x01(\x03R\x02fd\"\x8c\x01\n" +
	...
	"encryption\x12S\n" +
	"\asymlink\x18\a \x01(\v29.talos.resource.definitions.block.SymlinkProvisioningSpecR\asymlink\"\x8e\x01\n" +
	...
	"\tanonymous\x18\x04 \x01(\bR\tanonymous\"\xb5\x01\n" +
	"\x15VolumeMountStatusSpec\x12\x1b\n" +
	"\tvolume_id\x18\x01 \x01(\tR\bvolumeId\x12\x1c\n" +
	"\trequester\x18\x02 \x01(\tR\trequester\x12\x16\n" +
	"\x06target\x18\x03 \x01(\tR\x06target\x12\x1b\n" +
	"\tread_only\x18\x04 \x01(\bR\breadOnly\x12\x1c\n" +
	"\tanonymous\x18\x05 \x01(\bR\tanonymous\x12\x0e\n" +
	"\x02fd\x18\x06 \x01(\x03R\x02fd\"\xab\b\n" +
