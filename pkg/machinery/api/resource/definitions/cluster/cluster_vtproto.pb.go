...
func (m *ConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ServiceEndpoints) > 0 {
		for iNdEx := len(m.ServiceEndpoints) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.ServiceEndpoints[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ServiceEndpoint) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ServiceEndpoint) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ServiceEndpoint) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ServiceEndpoint) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfigSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if err := m.ServiceEndpoints[len(m.ServiceEndpoints)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ServiceEndpoint) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
