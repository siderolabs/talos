...
var file_resource_definitions_files_files_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x63, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x4a, 0x5a, 0x48, 0x67, 0x69,
...
func file_resource_definitions_files_files_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resource_definitions_files_files_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resource_definitions_files_files_proto_msgTypes[1].Exporter = func(v any, i int) any {
