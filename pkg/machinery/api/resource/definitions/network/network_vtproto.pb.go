...
func (m *BGPBFDConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BGPBFDConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BGPBFDConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.DetectMultiplier != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.DetectMultiplier))
		i--
		dAtA[i] = 0x18
	}
	if m.ReceiveInterval != nil {
		size, err := (*durationpb.Duration)(m.ReceiveInterval).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.TransmitInterval != nil {
		size, err := (*durationpb.Duration)(m.TransmitInterval).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *BGPImportRouteSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BGPImportRouteSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BGPImportRouteSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.Prefixes) > 0 {
		for iNdEx := len(m.Prefixes) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.Prefixes[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.Prefixes[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
	...
	if len(m.BgpInstance) > 0 {
		i -= len(m.BgpInstance)
		copy(dAtA[i:], m.BgpInstance)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.BgpInstance)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *BGPInstanceConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BGPInstanceConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BGPInstanceConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.ImportRoutes) > 0 {
		for iNdEx := len(m.ImportRoutes) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.ImportRoutes[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.VrfTable != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.VrfTable))
		i--
		dAtA[i] = 0x48
	}
	if len(m.Vrf) > 0 {
	...
	if m.MaxPaths != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MaxPaths))
		i--
		dAtA[i] = 0x30
	}
	if m.Multipath {
	...
	if len(m.AdvertiseLinks) > 0 {
		for iNdEx := len(m.AdvertiseLinks) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AdvertiseLinks[iNdEx])
			copy(dAtA[i:], m.AdvertiseLinks[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AdvertiseLinks[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if m.RouteSource != nil {
		if vtmsg, ok := interface{}(m.RouteSource).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.RouteSource)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
	...
	if m.RouterId != nil {
		if vtmsg, ok := interface{}(m.RouterId).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.RouterId)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
	...
	if m.LocalAsn != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.LocalAsn))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BGPNeighborConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BGPNeighborConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BGPNeighborConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.Bfd != nil {
		size, err := m.Bfd.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.HoldTime != nil {
		size, err := (*durationpb.Duration)(m.HoldTime).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.PeerAsn != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.PeerAsn))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Link) > 0 {
...
func (m *BGPPeerStatusSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BGPPeerStatusSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BGPPeerStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.BfdState) > 0 {
		i -= len(m.BfdState)
		copy(dAtA[i:], m.BfdState)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.BfdState)))
		i--
		dAtA[i] = 0x52
	}
	if m.Accepted != 0 {
	...
	if m.Advertised != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Advertised))
		i--
		dAtA[i] = 0x40
	}
	if m.Received != 0 {
...
func (m *RouteNextHop) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RouteNextHop) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RouteNextHop) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *StaticHostSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *StaticHostSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *StaticHostSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *VethSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VethSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BGPBFDConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.TransmitInterval != nil {
		l = (*durationpb.Duration)(m.TransmitInterval).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.ReceiveInterval != nil {
		l = (*durationpb.Duration)(m.ReceiveInterval).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.DetectMultiplier != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.DetectMultiplier))
	}
	n += len(m.unknownFields)
	return n
}

func (m *BGPImportRouteSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BGPInstanceConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.LocalAsn != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.LocalAsn))
	}
	if m.RouterId != nil {
		if size, ok := interface{}(m.RouterId).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.RouterId)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.RouteSource != nil {
		if size, ok := interface{}(m.RouteSource).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.RouteSource)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if len(m.AdvertiseLinks) > 0 {
		for _, s := range m.AdvertiseLinks {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
	...
	if m.MaxPaths != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MaxPaths))
	}
	if len(m.Neighbors) > 0 {
	...
	if m.VrfTable != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.VrfTable))
	}
	if len(m.ImportRoutes) > 0 {
		for _, e := range m.ImportRoutes {
			l = e.SizeVT()
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *BGPNeighborConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.PeerAsn != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.PeerAsn))
	}
	if m.HoldTime != nil {
		l = (*durationpb.Duration)(m.HoldTime).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.Bfd != nil {
		l = m.Bfd.SizeVT()
...
func (m *BGPPeerStatusSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Advertised != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Advertised))
	}
	if m.Accepted != 0 {
...
func (m *RouteNextHop) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StaticHostSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BGPBFDConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BGPBFDConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BGPBFDConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransmitInterval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TransmitInterval == nil {
				m.TransmitInterval = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.TransmitInterval).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceiveInterval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReceiveInterval == nil {
				m.ReceiveInterval = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.ReceiveInterval).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DetectMultiplier |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BGPImportRouteSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BGPImportRouteSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BGPImportRouteSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BgpInstance", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BgpInstance = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Prefixes = append(m.Prefixes, &common.NetIPPrefix{})
			if unmarshal, ok := interface{}(m.Prefixes[len(m.Prefixes)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Prefixes[len(m.Prefixes)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *BGPInstanceConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BGPInstanceConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BGPInstanceConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			if m.RouterId == nil {
				m.RouterId = &common.NetIP{}
			}
			if unmarshal, ok := interface{}(m.RouterId).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.RouterId); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 3:
			...
			if m.RouteSource == nil {
				m.RouteSource = &common.NetIP{}
			}
			if unmarshal, ok := interface{}(m.RouteSource).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.RouteSource); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdvertiseLinks", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AdvertiseLinks = append(m.AdvertiseLinks, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
			...
			m.Multipath = bool(v != 0)
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxPaths", wireType)
			}
			m.MaxPaths = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxPaths |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			m.Neighbors = append(m.Neighbors, &BGPNeighborConfigSpec{})
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VrfTable", wireType)
			}
			m.VrfTable = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VrfTable |= enums.NethelpersRoutingTable(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImportRoutes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ImportRoutes = append(m.ImportRoutes, &BGPImportRouteSpec{})
			if err := m.ImportRoutes[len(m.ImportRoutes)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstallRoutes", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *BGPNeighborConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BGPNeighborConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BGPNeighborConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			if m.HoldTime == nil {
				m.HoldTime = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.HoldTime).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			if m.Bfd == nil {
				m.Bfd = &BGPBFDConfigSpec{}
			}
			if err := m.Bfd.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *BGPPeerStatusSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BGPPeerStatusSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BGPPeerStatusSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= enums.NethelpersBGPSessionState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BfdState", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BfdState = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
...
func (m *LinkSpecSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Veth", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RouteNextHop) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RouteNextHop: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RouteNextHop: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RouteSpecSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.NextHops = append(m.NextHops, &RouteNextHop{})
...
func (m *StaticHostSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StaticHostSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StaticHostSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VethSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VethSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VethSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
