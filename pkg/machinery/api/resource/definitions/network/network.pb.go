...
const file_resource_definitions_network_network_proto_rawDesc = "" +
	...
	"\bpriority\x18\v \x01(\rR\bpriority\"\x85\x03\n" +
...
var file_resource_definitions_network_network_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_resource_definitions_network_network_proto_goTypes = []any{
	...
	(*BGPPeerStatusSpec)(nil),                  // 2: talos.resource.definitions.network.BGPPeerStatusSpec
	(*BondMasterSpec)(nil),                     // 3: talos.resource.definitions.network.BondMasterSpec
	(*BondSlave)(nil),                          // 4: talos.resource.definitions.network.BondSlave
	(*BridgeMasterSpec)(nil),                   // 5: talos.resource.definitions.network.BridgeMasterSpec
	(*BridgeSlave)(nil),                        // 6: talos.resource.definitions.network.BridgeSlave
	(*BridgeVLANSpec)(nil),                     // 7: talos.resource.definitions.network.BridgeVLANSpec
	(*ClientIdentifierSpec)(nil),               // 8: talos.resource.definitions.network.ClientIdentifierSpec
	(*DHCP4OperatorSpec)(nil),                  // 9: talos.resource.definitions.network.DHCP4OperatorSpec
	(*DHCP6OperatorSpec)(nil),                  // 10: talos.resource.definitions.network.DHCP6OperatorSpec
	(*DNSResolveCacheSpec)(nil),                // 11: talos.resource.definitions.network.DNSResolveCacheSpec
	(*EthernetChannelsSpec)(nil),               // 12: talos.resource.definitions.network.EthernetChannelsSpec
	(*EthernetChannelsStatus)(nil),             // 13: talos.resource.definitions.network.EthernetChannelsStatus
	(*EthernetFeatureStatus)(nil),              // 14: talos.resource.definitions.network.EthernetFeatureStatus
	(*EthernetRingsSpec)(nil),                  // 15: talos.resource.definitions.network.EthernetRingsSpec
	(*EthernetRingsStatus)(nil),                // 16: talos.resource.definitions.network.EthernetRingsStatus
	(*EthernetSpecSpec)(nil),                   // 17: talos.resource.definitions.network.EthernetSpecSpec
	(*EthernetStatusSpec)(nil),                 // 18: talos.resource.definitions.network.EthernetStatusSpec
	(*HTTPProbeSpec)(nil),                      // 19: talos.resource.definitions.network.HTTPProbeSpec
	(*HardwareAddrSpec)(nil),                   // 20: talos.resource.definitions.network.HardwareAddrSpec
	(*HostDNSConfigSpec)(nil),                  // 21: talos.resource.definitions.network.HostDNSConfigSpec
	(*HostnameSpecSpec)(nil),                   // 22: talos.resource.definitions.network.HostnameSpecSpec
	(*HostnameStatusSpec)(nil),                 // 23: talos.resource.definitions.network.HostnameStatusSpec
	(*LinkAliasSpecSpec)(nil),                  // 24: talos.resource.definitions.network.LinkAliasSpecSpec
	(*LinkRefreshSpec)(nil),                    // 25: talos.resource.definitions.network.LinkRefreshSpec
	(*LinkSpecSpec)(nil),                       // 26: talos.resource.definitions.network.LinkSpecSpec
	(*LinkStatusSpec)(nil),                     // 27: talos.resource.definitions.network.LinkStatusSpec
	(*NameServerSpec)(nil),                     // 28: talos.resource.definitions.network.NameServerSpec
	(*NfTablesAddressMatch)(nil),               // 29: talos.resource.definitions.network.NfTablesAddressMatch
	(*NfTablesChainSpec)(nil),                  // 30: talos.resource.definitions.network.NfTablesChainSpec
	(*NfTablesClampMSS)(nil),                   // 31: talos.resource.definitions.network.NfTablesClampMSS
	(*NfTablesConntrackStateMatch)(nil),        // 32: talos.resource.definitions.network.NfTablesConntrackStateMatch
	(*NfTablesICMPTypeMatch)(nil),              // 33: talos.resource.definitions.network.NfTablesICMPTypeMatch
	(*NfTablesIfNameMatch)(nil),                // 34: talos.resource.definitions.network.NfTablesIfNameMatch
	(*NfTablesLayer4Match)(nil),                // 35: talos.resource.definitions.network.NfTablesLayer4Match
	(*NfTablesLimitMatch)(nil),                 // 36: talos.resource.definitions.network.NfTablesLimitMatch
	(*NfTablesMark)(nil),                       // 37: talos.resource.definitions.network.NfTablesMark
	(*NfTablesPortMatch)(nil),                  // 38: talos.resource.definitions.network.NfTablesPortMatch
	(*NfTablesRule)(nil),                       // 39: talos.resource.definitions.network.NfTablesRule
	(*NodeAddressFilterSpec)(nil),              // 40: talos.resource.definitions.network.NodeAddressFilterSpec
	(*NodeAddressSortAlgorithmSpec)(nil),       // 41: talos.resource.definitions.network.NodeAddressSortAlgorithmSpec
	(*NodeAddressSpec)(nil),                    // 42: talos.resource.definitions.network.NodeAddressSpec
	(*OperatorSpecSpec)(nil),                   // 43: talos.resource.definitions.network.OperatorSpecSpec
	(*PlatformConfigSpec)(nil),                 // 44: talos.resource.definitions.network.PlatformConfigSpec
	(*PortRange)(nil),                          // 45: talos.resource.definitions.network.PortRange
	(*ProbeSpecSpec)(nil),                      // 46: talos.resource.definitions.network.ProbeSpecSpec
	(*ProbeStatusSpec)(nil),                    // 47: talos.resource.definitions.network.ProbeStatusSpec
	(*ResolverSpecSpec)(nil),                   // 48: talos.resource.definitions.network.ResolverSpecSpec
	(*ResolverStatusSpec)(nil),                 // 49: talos.resource.definitions.network.ResolverStatusSpec
	(*RouteNextHop)(nil),                       // 50: talos.resource.definitions.network.RouteNextHop
	(*RouteSpecSpec)(nil),                      // 51: talos.resource.definitions.network.RouteSpecSpec
	(*RouteStatusSpec)(nil),                    // 52: talos.resource.definitions.network.RouteStatusSpec
	(*RoutingRuleSpecSpec)(nil),                // 53: talos.resource.definitions.network.RoutingRuleSpecSpec
	(*RoutingRuleStatusSpec)(nil),              // 54: talos.resource.definitions.network.RoutingRuleStatusSpec
	(*STPSpec)(nil),                            // 55: talos.resource.definitions.network.STPSpec
	(*StaticHostSpec)(nil),                     // 56: talos.resource.definitions.network.StaticHostSpec
	(*StatusSpec)(nil),                         // 57: talos.resource.definitions.network.StatusSpec
	(*TCPProbeSpec)(nil),                       // 58: talos.resource.definitions.network.TCPProbeSpec
	(*TimeServerSpecSpec)(nil),                 // 59: talos.resource.definitions.network.TimeServerSpecSpec
	(*TimeServerStatusSpec)(nil),               // 60: talos.resource.definitions.network.TimeServerStatusSpec
	(*VIPEquinixMetalSpec)(nil),                // 61: talos.resource.definitions.network.VIPEquinixMetalSpec
	(*VIPHCloudSpec)(nil),                      // 62: talos.resource.definitions.network.VIPHCloudSpec
	(*VIPOperatorSpec)(nil),                    // 63: talos.resource.definitions.network.VIPOperatorSpec
	(*VLANSpec)(nil),                           // 64: talos.resource.definitions.network.VLANSpec
	(*VRFMasterSpec)(nil),                      // 65: talos.resource.definitions.network.VRFMasterSpec
	(*VRFSlave)(nil),                           // 66: talos.resource.definitions.network.VRFSlave
	(*WireguardPeer)(nil),                      // 67: talos.resource.definitions.network.WireguardPeer
	(*WireguardSpec)(nil),                      // 68: talos.resource.definitions.network.WireguardSpec
	nil,                                        // 69: talos.resource.definitions.network.EthernetSpecSpec.FeaturesEntry
	(*common.NetIPPrefix)(nil),                 // 70: common.NetIPPrefix
	(enums.NethelpersFamily)(0),                // 71: talos.resource.definitions.enums.NethelpersFamily
	(enums.NethelpersScope)(0),                 // 72: talos.resource.definitions.enums.NethelpersScope
	(enums.NetworkConfigLayer)(0),              // 73: talos.resource.definitions.enums.NetworkConfigLayer
	(*common.NetIP)(nil),                       // 74: common.NetIP
	(enums.NethelpersBGPSessionState)(0),       // 75: talos.resource.definitions.enums.NethelpersBGPSessionState
	(*timestamppb.Timestamp)(nil),              // 76: google.protobuf.Timestamp
	(enums.NethelpersBondMode)(0),              // 77: talos.resource.definitions.enums.NethelpersBondMode
	(enums.NethelpersBondXmitHashPolicy)(0),    // 78: talos.resource.definitions.enums.NethelpersBondXmitHashPolicy
	(enums.NethelpersLACPRate)(0),              // 79: talos.resource.definitions.enums.NethelpersLACPRate
	(enums.NethelpersARPValidate)(0),           // 80: talos.resource.definitions.enums.NethelpersARPValidate
	(enums.NethelpersARPAllTargets)(0),         // 81: talos.resource.definitions.enums.NethelpersARPAllTargets
	(enums.NethelpersPrimaryReselect)(0),       // 82: talos.resource.definitions.enums.NethelpersPrimaryReselect
	(enums.NethelpersFailOverMAC)(0),           // 83: talos.resource.definitions.enums.NethelpersFailOverMAC
	(enums.NethelpersADSelect)(0),              // 84: talos.resource.definitions.enums.NethelpersADSelect
	(enums.NethelpersADLACPActive)(0),          // 85: talos.resource.definitions.enums.NethelpersADLACPActive
	(enums.NethelpersClientIdentifier)(0),      // 86: talos.resource.definitions.enums.NethelpersClientIdentifier
	(enums.NethelpersWOLMode)(0),               // 87: talos.resource.definitions.enums.NethelpersWOLMode
	(enums.NethelpersPort)(0),                  // 88: talos.resource.definitions.enums.NethelpersPort
	(enums.NethelpersDuplex)(0),                // 89: talos.resource.definitions.enums.NethelpersDuplex
	(*common.URL)(nil),                         // 90: common.URL
	(*durationpb.Duration)(nil),                // 91: google.protobuf.Duration
	(*common.NetIPPort)(nil),                   // 92: common.NetIPPort
	(enums.NethelpersLinkType)(0),              // 93: talos.resource.definitions.enums.NethelpersLinkType
	(enums.NethelpersOperationalState)(0),      // 94: talos.resource.definitions.enums.NethelpersOperationalState
	(enums.NethelpersDNSProtocol)(0),           // 95: talos.resource.definitions.enums.NethelpersDNSProtocol
	(enums.NethelpersNfTablesChainHook)(0),     // 96: talos.resource.definitions.enums.NethelpersNfTablesChainHook
	(enums.NethelpersNfTablesChainPriority)(0), // 97: talos.resource.definitions.enums.NethelpersNfTablesChainPriority
	(enums.NethelpersNfTablesVerdict)(0),       // 98: talos.resource.definitions.enums.NethelpersNfTablesVerdict
	(enums.NethelpersConntrackState)(0),        // 99: talos.resource.definitions.enums.NethelpersConntrackState
	(enums.NethelpersICMPType)(0),              // 100: talos.resource.definitions.enums.NethelpersICMPType
	(enums.NethelpersMatchOperator)(0),         // 101: talos.resource.definitions.enums.NethelpersMatchOperator
	(enums.NethelpersProtocol)(0),              // 102: talos.resource.definitions.enums.NethelpersProtocol
	(enums.NethelpersAddressSortAlgorithm)(0),  // 103: talos.resource.definitions.enums.NethelpersAddressSortAlgorithm
	(enums.NetworkOperator)(0),                 // 104: talos.resource.definitions.enums.NetworkOperator
	(*runtime.PlatformMetadataSpec)(nil),       // 105: talos.resource.definitions.runtime.PlatformMetadataSpec
	(enums.NethelpersRoutingTable)(0),          // 106: talos.resource.definitions.enums.NethelpersRoutingTable
	(enums.NethelpersRouteType)(0),             // 107: talos.resource.definitions.enums.NethelpersRouteType
	(enums.NethelpersRouteProtocol)(0),         // 108: talos.resource.definitions.enums.NethelpersRouteProtocol
	(enums.NethelpersRoutingRuleAction)(0),     // 109: talos.resource.definitions.enums.NethelpersRoutingRuleAction
	(enums.NethelpersVLANProtocol)(0),          // 110: talos.resource.definitions.enums.NethelpersVLANProtocol
}
var file_resource_definitions_network_network_proto_depIdxs = []int32{
	70,  // 0: talos.resource.definitions.network.AddressSpecSpec.address:type_name -> common.NetIPPrefix
	71,  // 1: talos.resource.definitions.network.AddressSpecSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	72,  // 2: talos.resource.definitions.network.AddressSpecSpec.scope:type_name -> talos.resource.definitions.enums.NethelpersScope
	73,  // 3: talos.resource.definitions.network.AddressSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	70,  // 4: talos.resource.definitions.network.AddressStatusSpec.address:type_name -> common.NetIPPrefix
	74,  // 5: talos.resource.definitions.network.AddressStatusSpec.local:type_name -> common.NetIP
	74,  // 6: talos.resource.definitions.network.AddressStatusSpec.broadcast:type_name -> common.NetIP
	74,  // 7: talos.resource.definitions.network.AddressStatusSpec.anycast:type_name -> common.NetIP
	74,  // 8: talos.resource.definitions.network.AddressStatusSpec.multicast:type_name -> common.NetIP
	71,  // 9: talos.resource.definitions.network.AddressStatusSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	72,  // 10: talos.resource.definitions.network.AddressStatusSpec.scope:type_name -> talos.resource.definitions.enums.NethelpersScope
	75,  // 11: talos.resource.definitions.network.BGPPeerStatusSpec.state:type_name -> talos.resource.definitions.enums.NethelpersBGPSessionState
	74,  // 12: talos.resource.definitions.network.BGPPeerStatusSpec.router_id:type_name -> common.NetIP
	76,  // 13: talos.resource.definitions.network.BGPPeerStatusSpec.since:type_name -> google.protobuf.Timestamp
	77,  // 14: talos.resource.definitions.network.BondMasterSpec.mode:type_name -> talos.resource.definitions.enums.NethelpersBondMode
	78,  // 15: talos.resource.definitions.network.BondMasterSpec.hash_policy:type_name -> talos.resource.definitions.enums.NethelpersBondXmitHashPolicy
	79,  // 16: talos.resource.definitions.network.BondMasterSpec.lacp_rate:type_name -> talos.resource.definitions.enums.NethelpersLACPRate
	80,  // 17: talos.resource.definitions.network.BondMasterSpec.arp_validate:type_name -> talos.resource.definitions.enums.NethelpersARPValidate
	81,  // 18: talos.resource.definitions.network.BondMasterSpec.arp_all_targets:type_name -> talos.resource.definitions.enums.NethelpersARPAllTargets
	82,  // 19: talos.resource.definitions.network.BondMasterSpec.primary_reselect:type_name -> talos.resource.definitions.enums.NethelpersPrimaryReselect
	83,  // 20: talos.resource.definitions.network.BondMasterSpec.fail_over_mac:type_name -> talos.resource.definitions.enums.NethelpersFailOverMAC
	84,  // 21: talos.resource.definitions.network.BondMasterSpec.ad_select:type_name -> talos.resource.definitions.enums.NethelpersADSelect
	74,  // 22: talos.resource.definitions.network.BondMasterSpec.arpip_targets:type_name -> common.NetIP
	74,  // 23: talos.resource.definitions.network.BondMasterSpec.nsip6_targets:type_name -> common.NetIP
	85,  // 24: talos.resource.definitions.network.BondMasterSpec.adlacp_active:type_name -> talos.resource.definitions.enums.NethelpersADLACPActive
	55,  // 25: talos.resource.definitions.network.BridgeMasterSpec.stp:type_name -> talos.resource.definitions.network.STPSpec
	7,   // 26: talos.resource.definitions.network.BridgeMasterSpec.vlan:type_name -> talos.resource.definitions.network.BridgeVLANSpec
	86,  // 27: talos.resource.definitions.network.ClientIdentifierSpec.client_identifier:type_name -> talos.resource.definitions.enums.NethelpersClientIdentifier
	8,   // 28: talos.resource.definitions.network.DHCP4OperatorSpec.client_identifier:type_name -> talos.resource.definitions.network.ClientIdentifierSpec
	8,   // 29: talos.resource.definitions.network.DHCP6OperatorSpec.client_identifier:type_name -> talos.resource.definitions.network.ClientIdentifierSpec
	15,  // 30: talos.resource.definitions.network.EthernetSpecSpec.rings:type_name -> talos.resource.definitions.network.EthernetRingsSpec
	69,  // 31: talos.resource.definitions.network.EthernetSpecSpec.features:type_name -> talos.resource.definitions.network.EthernetSpecSpec.FeaturesEntry
	12,  // 32: talos.resource.definitions.network.EthernetSpecSpec.channels:type_name -> talos.resource.definitions.network.EthernetChannelsSpec
	87,  // 33: talos.resource.definitions.network.EthernetSpecSpec.wake_on_lan:type_name -> talos.resource.definitions.enums.NethelpersWOLMode
	88,  // 34: talos.resource.definitions.network.EthernetStatusSpec.port:type_name -> talos.resource.definitions.enums.NethelpersPort
	89,  // 35: talos.resource.definitions.network.EthernetStatusSpec.duplex:type_name -> talos.resource.definitions.enums.NethelpersDuplex
	16,  // 36: talos.resource.definitions.network.EthernetStatusSpec.rings:type_name -> talos.resource.definitions.network.EthernetRingsStatus
	14,  // 37: talos.resource.definitions.network.EthernetStatusSpec.features:type_name -> talos.resource.definitions.network.EthernetFeatureStatus
	13,  // 38: talos.resource.definitions.network.EthernetStatusSpec.channels:type_name -> talos.resource.definitions.network.EthernetChannelsStatus
	87,  // 39: talos.resource.definitions.network.EthernetStatusSpec.wake_on_lan:type_name -> talos.resource.definitions.enums.NethelpersWOLMode
	90,  // 40: talos.resource.definitions.network.HTTPProbeSpec.url:type_name -> common.URL
	91,  // 41: talos.resource.definitions.network.HTTPProbeSpec.timeout:type_name -> google.protobuf.Duration
	92,  // 42: talos.resource.definitions.network.HostDNSConfigSpec.listen_addresses:type_name -> common.NetIPPort
	74,  // 43: talos.resource.definitions.network.HostDNSConfigSpec.service_host_dns_address:type_name -> common.NetIP
	74,  // 44: talos.resource.definitions.network.HostDNSConfigSpec.service_host_dns_address_v6:type_name -> common.NetIP
	73,  // 45: talos.resource.definitions.network.HostnameSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	93,  // 46: talos.resource.definitions.network.LinkSpecSpec.type:type_name -> talos.resource.definitions.enums.NethelpersLinkType
	4,   // 47: talos.resource.definitions.network.LinkSpecSpec.bond_slave:type_name -> talos.resource.definitions.network.BondSlave
	6,   // 48: talos.resource.definitions.network.LinkSpecSpec.bridge_slave:type_name -> talos.resource.definitions.network.BridgeSlave
	64,  // 49: talos.resource.definitions.network.LinkSpecSpec.vlan:type_name -> talos.resource.definitions.network.VLANSpec
	3,   // 50: talos.resource.definitions.network.LinkSpecSpec.bond_master:type_name -> talos.resource.definitions.network.BondMasterSpec
	5,   // 51: talos.resource.definitions.network.LinkSpecSpec.bridge_master:type_name -> talos.resource.definitions.network.BridgeMasterSpec
	68,  // 52: talos.resource.definitions.network.LinkSpecSpec.wireguard:type_name -> talos.resource.definitions.network.WireguardSpec
	73,  // 53: talos.resource.definitions.network.LinkSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	65,  // 54: talos.resource.definitions.network.LinkSpecSpec.vrf_master:type_name -> talos.resource.definitions.network.VRFMasterSpec
	66,  // 55: talos.resource.definitions.network.LinkSpecSpec.vrf_slave:type_name -> talos.resource.definitions.network.VRFSlave
	93,  // 56: talos.resource.definitions.network.LinkStatusSpec.type:type_name -> talos.resource.definitions.enums.NethelpersLinkType
	94,  // 57: talos.resource.definitions.network.LinkStatusSpec.operational_state:type_name -> talos.resource.definitions.enums.NethelpersOperationalState
	88,  // 58: talos.resource.definitions.network.LinkStatusSpec.port:type_name -> talos.resource.definitions.enums.NethelpersPort
	89,  // 59: talos.resource.definitions.network.LinkStatusSpec.duplex:type_name -> talos.resource.definitions.enums.NethelpersDuplex
	64,  // 60: talos.resource.definitions.network.LinkStatusSpec.vlan:type_name -> talos.resource.definitions.network.VLANSpec
	5,   // 61: talos.resource.definitions.network.LinkStatusSpec.bridge_master:type_name -> talos.resource.definitions.network.BridgeMasterSpec
	3,   // 62: talos.resource.definitions.network.LinkStatusSpec.bond_master:type_name -> talos.resource.definitions.network.BondMasterSpec
	68,  // 63: talos.resource.definitions.network.LinkStatusSpec.wireguard:type_name -> talos.resource.definitions.network.WireguardSpec
	65,  // 64: talos.resource.definitions.network.LinkStatusSpec.vrf_master:type_name -> talos.resource.definitions.network.VRFMasterSpec
	74,  // 65: talos.resource.definitions.network.NameServerSpec.addr:type_name -> common.NetIP
	95,  // 66: talos.resource.definitions.network.NameServerSpec.protocol:type_name -> talos.resource.definitions.enums.NethelpersDNSProtocol
	70,  // 67: talos.resource.definitions.network.NfTablesAddressMatch.include_subnets:type_name -> common.NetIPPrefix
	70,  // 68: talos.resource.definitions.network.NfTablesAddressMatch.exclude_subnets:type_name -> common.NetIPPrefix
	96,  // 69: talos.resource.definitions.network.NfTablesChainSpec.hook:type_name -> talos.resource.definitions.enums.NethelpersNfTablesChainHook
	97,  // 70: talos.resource.definitions.network.NfTablesChainSpec.priority:type_name -> talos.resource.definitions.enums.NethelpersNfTablesChainPriority
	39,  // 71: talos.resource.definitions.network.NfTablesChainSpec.rules:type_name -> talos.resource.definitions.network.NfTablesRule
	98,  // 72: talos.resource.definitions.network.NfTablesChainSpec.policy:type_name -> talos.resource.definitions.enums.NethelpersNfTablesVerdict
	99,  // 73: talos.resource.definitions.network.NfTablesConntrackStateMatch.states:type_name -> talos.resource.definitions.enums.NethelpersConntrackState
	100, // 74: talos.resource.definitions.network.NfTablesICMPTypeMatch.types:type_name -> talos.resource.definitions.enums.NethelpersICMPType
	101, // 75: talos.resource.definitions.network.NfTablesIfNameMatch.operator:type_name -> talos.resource.definitions.enums.NethelpersMatchOperator
	102, // 76: talos.resource.definitions.network.NfTablesLayer4Match.protocol:type_name -> talos.resource.definitions.enums.NethelpersProtocol
	38,  // 77: talos.resource.definitions.network.NfTablesLayer4Match.match_source_port:type_name -> talos.resource.definitions.network.NfTablesPortMatch
	38,  // 78: talos.resource.definitions.network.NfTablesLayer4Match.match_destination_port:type_name -> talos.resource.definitions.network.NfTablesPortMatch
	33,  // 79: talos.resource.definitions.network.NfTablesLayer4Match.match_icmp_type:type_name -> talos.resource.definitions.network.NfTablesICMPTypeMatch
	45,  // 80: talos.resource.definitions.network.NfTablesPortMatch.ranges:type_name -> talos.resource.definitions.network.PortRange
	34,  // 81: talos.resource.definitions.network.NfTablesRule.match_o_if_name:type_name -> talos.resource.definitions.network.NfTablesIfNameMatch
	98,  // 82: talos.resource.definitions.network.NfTablesRule.verdict:type_name -> talos.resource.definitions.enums.NethelpersNfTablesVerdict
	37,  // 83: talos.resource.definitions.network.NfTablesRule.match_mark:type_name -> talos.resource.definitions.network.NfTablesMark
	37,  // 84: talos.resource.definitions.network.NfTablesRule.set_mark:type_name -> talos.resource.definitions.network.NfTablesMark
	29,  // 85: talos.resource.definitions.network.NfTablesRule.match_source_address:type_name -> talos.resource.definitions.network.NfTablesAddressMatch
	29,  // 86: talos.resource.definitions.network.NfTablesRule.match_destination_address:type_name -> talos.resource.definitions.network.NfTablesAddressMatch
	35,  // 87: talos.resource.definitions.network.NfTablesRule.match_layer4:type_name -> talos.resource.definitions.network.NfTablesLayer4Match
	34,  // 88: talos.resource.definitions.network.NfTablesRule.match_i_if_name:type_name -> talos.resource.definitions.network.NfTablesIfNameMatch
	31,  // 89: talos.resource.definitions.network.NfTablesRule.clamp_mss:type_name -> talos.resource.definitions.network.NfTablesClampMSS
	36,  // 90: talos.resource.definitions.network.NfTablesRule.match_limit:type_name -> talos.resource.definitions.network.NfTablesLimitMatch
	32,  // 91: talos.resource.definitions.network.NfTablesRule.match_conntrack_state:type_name -> talos.resource.definitions.network.NfTablesConntrackStateMatch
	70,  // 92: talos.resource.definitions.network.NodeAddressFilterSpec.include_subnets:type_name -> common.NetIPPrefix
	70,  // 93: talos.resource.definitions.network.NodeAddressFilterSpec.exclude_subnets:type_name -> common.NetIPPrefix
	103, // 94: talos.resource.definitions.network.NodeAddressSortAlgorithmSpec.algorithm:type_name -> talos.resource.definitions.enums.NethelpersAddressSortAlgorithm
	70,  // 95: talos.resource.definitions.network.NodeAddressSpec.addresses:type_name -> common.NetIPPrefix
	103, // 96: talos.resource.definitions.network.NodeAddressSpec.sort_algorithm:type_name -> talos.resource.definitions.enums.NethelpersAddressSortAlgorithm
	104, // 97: talos.resource.definitions.network.OperatorSpecSpec.operator:type_name -> talos.resource.definitions.enums.NetworkOperator
	9,   // 98: talos.resource.definitions.network.OperatorSpecSpec.dhcp4:type_name -> talos.resource.definitions.network.DHCP4OperatorSpec
	10,  // 99: talos.resource.definitions.network.OperatorSpecSpec.dhcp6:type_name -> talos.resource.definitions.network.DHCP6OperatorSpec
	63,  // 100: talos.resource.definitions.network.OperatorSpecSpec.vip:type_name -> talos.resource.definitions.network.VIPOperatorSpec
	73,  // 101: talos.resource.definitions.network.OperatorSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	0,   // 102: talos.resource.definitions.network.PlatformConfigSpec.addresses:type_name -> talos.resource.definitions.network.AddressSpecSpec
	26,  // 103: talos.resource.definitions.network.PlatformConfigSpec.links:type_name -> talos.resource.definitions.network.LinkSpecSpec
	51,  // 104: talos.resource.definitions.network.PlatformConfigSpec.routes:type_name -> talos.resource.definitions.network.RouteSpecSpec
	22,  // 105: talos.resource.definitions.network.PlatformConfigSpec.hostnames:type_name -> talos.resource.definitions.network.HostnameSpecSpec
	48,  // 106: talos.resource.definitions.network.PlatformConfigSpec.resolvers:type_name -> talos.resource.definitions.network.ResolverSpecSpec
	59,  // 107: talos.resource.definitions.network.PlatformConfigSpec.time_servers:type_name -> talos.resource.definitions.network.TimeServerSpecSpec
	43,  // 108: talos.resource.definitions.network.PlatformConfigSpec.operators:type_name -> talos.resource.definitions.network.OperatorSpecSpec
	74,  // 109: talos.resource.definitions.network.PlatformConfigSpec.external_ips:type_name -> common.NetIP
	46,  // 110: talos.resource.definitions.network.PlatformConfigSpec.probes:type_name -> talos.resource.definitions.network.ProbeSpecSpec
	105, // 111: talos.resource.definitions.network.PlatformConfigSpec.metadata:type_name -> talos.resource.definitions.runtime.PlatformMetadataSpec
	91,  // 112: talos.resource.definitions.network.ProbeSpecSpec.interval:type_name -> google.protobuf.Duration
	58,  // 113: talos.resource.definitions.network.ProbeSpecSpec.tcp:type_name -> talos.resource.definitions.network.TCPProbeSpec
	73,  // 114: talos.resource.definitions.network.ProbeSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	19,  // 115: talos.resource.definitions.network.ProbeSpecSpec.http:type_name -> talos.resource.definitions.network.HTTPProbeSpec
	74,  // 116: talos.resource.definitions.network.ResolverSpecSpec.dns_servers:type_name -> common.NetIP
	73,  // 117: talos.resource.definitions.network.ResolverSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	28,  // 118: talos.resource.definitions.network.ResolverSpecSpec.name_servers:type_name -> talos.resource.definitions.network.NameServerSpec
	74,  // 119: talos.resource.definitions.network.ResolverStatusSpec.dns_servers:type_name -> common.NetIP
	28,  // 120: talos.resource.definitions.network.ResolverStatusSpec.name_servers:type_name -> talos.resource.definitions.network.NameServerSpec
	74,  // 121: talos.resource.definitions.network.RouteNextHop.gateway:type_name -> common.NetIP
	71,  // 122: talos.resource.definitions.network.RouteSpecSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	70,  // 123: talos.resource.definitions.network.RouteSpecSpec.destination:type_name -> common.NetIPPrefix
	74,  // 124: talos.resource.definitions.network.RouteSpecSpec.source:type_name -> common.NetIP
	74,  // 125: talos.resource.definitions.network.RouteSpecSpec.gateway:type_name -> common.NetIP
	106, // 126: talos.resource.definitions.network.RouteSpecSpec.table:type_name -> talos.resource.definitions.enums.NethelpersRoutingTable
	72,  // 127: talos.resource.definitions.network.RouteSpecSpec.scope:type_name -> talos.resource.definitions.enums.NethelpersScope
	107, // 128: talos.resource.definitions.network.RouteSpecSpec.type:type_name -> talos.resource.definitions.enums.NethelpersRouteType
	108, // 129: talos.resource.definitions.network.RouteSpecSpec.protocol:type_name -> talos.resource.definitions.enums.NethelpersRouteProtocol
	73,  // 130: talos.resource.definitions.network.RouteSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	50,  // 131: talos.resource.definitions.network.RouteSpecSpec.next_hops:type_name -> talos.resource.definitions.network.RouteNextHop
	71,  // 132: talos.resource.definitions.network.RouteStatusSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	70,  // 133: talos.resource.definitions.network.RouteStatusSpec.destination:type_name -> common.NetIPPrefix
	74,  // 134: talos.resource.definitions.network.RouteStatusSpec.source:type_name -> common.NetIP
	74,  // 135: talos.resource.definitions.network.RouteStatusSpec.gateway:type_name -> common.NetIP
	106, // 136: talos.resource.definitions.network.RouteStatusSpec.table:type_name -> talos.resource.definitions.enums.NethelpersRoutingTable
	72,  // 137: talos.resource.definitions.network.RouteStatusSpec.scope:type_name -> talos.resource.definitions.enums.NethelpersScope
	107, // 138: talos.resource.definitions.network.RouteStatusSpec.type:type_name -> talos.resource.definitions.enums.NethelpersRouteType
	108, // 139: talos.resource.definitions.network.RouteStatusSpec.protocol:type_name -> talos.resource.definitions.enums.NethelpersRouteProtocol
	50,  // 140: talos.resource.definitions.network.RouteStatusSpec.next_hops:type_name -> talos.resource.definitions.network.RouteNextHop
	71,  // 141: talos.resource.definitions.network.RoutingRuleSpecSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	70,  // 142: talos.resource.definitions.network.RoutingRuleSpecSpec.src:type_name -> common.NetIPPrefix
	70,  // 143: talos.resource.definitions.network.RoutingRuleSpecSpec.dst:type_name -> common.NetIPPrefix
	106, // 144: talos.resource.definitions.network.RoutingRuleSpecSpec.table:type_name -> talos.resource.definitions.enums.NethelpersRoutingTable
	109, // 145: talos.resource.definitions.network.RoutingRuleSpecSpec.action:type_name -> talos.resource.definitions.enums.NethelpersRoutingRuleAction
	73,  // 146: talos.resource.definitions.network.RoutingRuleSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	71,  // 147: talos.resource.definitions.network.RoutingRuleStatusSpec.family:type_name -> talos.resource.definitions.enums.NethelpersFamily
	70,  // 148: talos.resource.definitions.network.RoutingRuleStatusSpec.src:type_name -> common.NetIPPrefix
	70,  // 149: talos.resource.definitions.network.RoutingRuleStatusSpec.dst:type_name -> common.NetIPPrefix
	106, // 150: talos.resource.definitions.network.RoutingRuleStatusSpec.table:type_name -> talos.resource.definitions.enums.NethelpersRoutingTable
	109, // 151: talos.resource.definitions.network.RoutingRuleStatusSpec.action:type_name -> talos.resource.definitions.enums.NethelpersRoutingRuleAction
	74,  // 152: talos.resource.definitions.network.StaticHostSpec.addresses:type_name -> common.NetIP
	91,  // 153: talos.resource.definitions.network.TCPProbeSpec.timeout:type_name -> google.protobuf.Duration
	73,  // 154: talos.resource.definitions.network.TimeServerSpecSpec.config_layer:type_name -> talos.resource.definitions.enums.NetworkConfigLayer
	74,  // 155: talos.resource.definitions.network.VIPOperatorSpec.ip:type_name -> common.NetIP
	61,  // 156: talos.resource.definitions.network.VIPOperatorSpec.equinix_metal:type_name -> talos.resource.definitions.network.VIPEquinixMetalSpec
	62,  // 157: talos.resource.definitions.network.VIPOperatorSpec.h_cloud:type_name -> talos.resource.definitions.network.VIPHCloudSpec
	110, // 158: talos.resource.definitions.network.VLANSpec.protocol:type_name -> talos.resource.definitions.enums.NethelpersVLANProtocol
	106, // 159: talos.resource.definitions.network.VRFMasterSpec.table:type_name -> talos.resource.definitions.enums.NethelpersRoutingTable
	91,  // 160: talos.resource.definitions.network.WireguardPeer.persistent_keepalive_interval:type_name -> google.protobuf.Duration
	70,  // 161: talos.resource.definitions.network.WireguardPeer.allowed_ips:type_name -> common.NetIPPrefix
	67,  // 162: talos.resource.definitions.network.WireguardSpec.peers:type_name -> talos.resource.definitions.network.WireguardPeer
