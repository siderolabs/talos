...
func (m *EncryptionRecoveryKeySpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *EncryptionRecoveryKeySpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *EncryptionRecoveryKeySpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *GeneratedRecoveryKeySpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *GeneratedRecoveryKeySpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *GeneratedRecoveryKeySpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *KubeletSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.EndpointTlsServerName) > 0 {
		i -= len(m.EndpointTlsServerName)
		copy(dAtA[i:], m.EndpointTlsServerName)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EndpointTlsServerName)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.AcceptedCAs) > 0 {
...
func (m *KubernetesRootSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ApiAudiences) > 0 {
		for iNdEx := len(m.ApiAudiences) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ApiAudiences[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xaa
	...
	if len(m.AcceptedIssuers) > 0 {
		for iNdEx := len(m.AcceptedIssuers) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AcceptedIssuers[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa2
	...
	if len(m.IssuerUrl) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.IssuerUrl)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	}
	if len(m.ServiceAccountAcceptedKeys) > 0 {
		for iNdEx := len(m.ServiceAccountAcceptedKeys) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.ServiceAccountAcceptedKeys[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.ServiceAccountAcceptedKeys[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
	...
	if len(m.AcceptedAggregatorCAs) > 0 {
		for iNdEx := len(m.AcceptedAggregatorCAs) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.AcceptedAggregatorCAs[iNdEx]).(interface {
				MarshalToSizedBufferVT([]byte) (int, error)
			}); ok {
				size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
				if err != nil {
				...
				encoded, err := proto.Marshal(m.AcceptedAggregatorCAs[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
...
func (m *EncryptionRecoveryKeySpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GeneratedRecoveryKeySpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *KubernetesRootSpec) SizeVT() (n int) {
	...
	if len(m.AcceptedAggregatorCAs) > 0 {
		for _, e := range m.AcceptedAggregatorCAs {
			if size, ok := interface{}(e).(interface {
				SizeVT() int
			}); ok {
				l = size.SizeVT()
	...
	if len(m.ServiceAccountAcceptedKeys) > 0 {
		for _, e := range m.ServiceAccountAcceptedKeys {
			if size, ok := interface{}(e).(interface {
				SizeVT() int
			}); ok {
				l = size.SizeVT()
...
func (m *EncryptionRecoveryKeySpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EncryptionRecoveryKeySpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EncryptionRecoveryKeySpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GeneratedRecoveryKeySpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GeneratedRecoveryKeySpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GeneratedRecoveryKeySpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *KubeletSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndpointTlsServerName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EndpointTlsServerName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *KubernetesRootSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptedAggregatorCAs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AcceptedAggregatorCAs = append(m.AcceptedAggregatorCAs, &common.PEMEncodedCertificate{})
			if unmarshal, ok := interface{}(m.AcceptedAggregatorCAs[len(m.AcceptedAggregatorCAs)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.AcceptedAggregatorCAs[len(m.AcceptedAggregatorCAs)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServiceAccountAcceptedKeys", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ServiceAccountAcceptedKeys = append(m.ServiceAccountAcceptedKeys, &common.PEMEncodedKey{})
			if unmarshal, ok := interface{}(m.ServiceAccountAcceptedKeys[len(m.ServiceAccountAcceptedKeys)-1]).(interface {
				UnmarshalVT([]byte) error
			}); ok {
				if err := unmarshal.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.ServiceAccountAcceptedKeys[len(m.ServiceAccountAcceptedKeys)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
