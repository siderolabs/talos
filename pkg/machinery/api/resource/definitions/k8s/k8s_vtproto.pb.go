...
func (m *AuthenticationConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AuthenticationConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AuthenticationConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BootstrapManifestsConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ProxyConfigChecksum) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ProxyConfigChecksum)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xea
	}
	if m.ProxyResources != nil {
		size, err := m.ProxyResources.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.ProxyConfig != nil {
		size, err := (*structpb.Struct)(m.ProxyConfig).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EtcdEncryptionConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *EtcdEncryptionConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *EtcdEncryptionConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *KubeletStatusSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *KubeletStatusSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *KubeletStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AuthenticationConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BootstrapManifestsConfigSpec) SizeVT() (n int) {
	...
	if m.ProxyConfig != nil {
		l = (*structpb.Struct)(m.ProxyConfig).SizeVT()
		n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.ProxyResources != nil {
		l = m.ProxyResources.SizeVT()
		n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
	}
...
func (m *EtcdEncryptionConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *KubeletConfigSpec) SizeVT() (n int) {
	...
	if len(m.RegisterWithTaints) > 0 {
		for k, v := range m.RegisterWithTaints {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + protohelpers.SizeOfVarint(uint64(len(k))) + 1 + len(v) + protohelpers.SizeOfVarint(uint64(len(v)))
...
func (m *KubeletStatusSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *APIServerConfigSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartupProbesEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StartupProbesEnabled = bool(v != 0)
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseAuthenticationConfig", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UseAuthenticationConfig = bool(v != 0)
		case 16:
			if wireType != 2 {
...
func (m *AuthenticationConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *BootstrapManifestsConfigSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			if m.ProxyConfig == nil {
				m.ProxyConfig = &structpb1.Struct{}
			}
			if err := (*structpb.Struct)(m.ProxyConfig).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProxyResources", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProxyResources == nil {
				m.ProxyResources = &Resources{}
			}
			if err := m.ProxyResources.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProxyConfigChecksum", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *EtcdEncryptionConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EtcdEncryptionConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EtcdEncryptionConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *KubeletConfigSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegisterWithTaints", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RegisterWithTaints == nil {
				m.RegisterWithTaints = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
...
func (m *KubeletStatusSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KubeletStatusSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KubeletStatusSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
