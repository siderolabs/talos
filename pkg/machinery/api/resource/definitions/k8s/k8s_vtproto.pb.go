...
func (m *KubeletConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StaticPodListUrl) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.StaticPodListUrl)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *LoadBalancerStatusesSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *LoadBalancerStatusesSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *LoadBalancerStatusesSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *NodeTaintSpecSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Effect) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Effect)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Key) > 0 {
...
func (m *LoadBalancerStatusesSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LoadBalancerStatusesSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LoadBalancerStatusesSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LoadBalancerStatusesSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
