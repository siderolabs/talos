...
var file_resource_definitions_perf_perf_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x65, 0x63, 0x74, 0x4d, 0x61, 0x70, 0x31, 0x67, 0x42, 0x4c, 0x5a, 0x4a, 0x67, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x2f, 0x70, 0x65, 0x72, 0x66, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_resource_definitions_perf_perf_proto_goTypes = []interface{}{
...
func file_resource_definitions_perf_perf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resource_definitions_perf_perf_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resource_definitions_perf_perf_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resource_definitions_perf_perf_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
