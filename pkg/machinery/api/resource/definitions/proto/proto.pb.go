...
func file_resource_definitions_proto_proto_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resource_definitions_proto_proto_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resource_definitions_proto_proto_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Mount); i {
			case 0:
				return &v.state
			case 1:
