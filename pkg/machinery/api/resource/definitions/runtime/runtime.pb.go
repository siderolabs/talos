...
type PCIRebindConfigSpec struct {
	...
	Name           string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	VendorDeviceId string `protobuf:"bytes,2,opt,name=vendor_device_id,json=vendorDeviceId,proto3" json:"vendor_device_id,omitempty"`
	TargetDriver   string `protobuf:"bytes,3,opt,name=target_driver,json=targetDriver,proto3" json:"target_driver,omitempty"`
}

func (x *PCIRebindConfigSpec) Reset() {
	*x = PCIRebindConfigSpec{}
	mi := &file_resource_definitions_runtime_runtime_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PCIRebindConfigSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PCIRebindConfigSpec) ProtoMessage() {}

func (x *PCIRebindConfigSpec) ProtoReflect() protoreflect.Message {
	mi := &file_resource_definitions_runtime_runtime_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PCIRebindConfigSpec.ProtoReflect.Descriptor instead.
func (*PCIRebindConfigSpec) Descriptor() ([]byte, []int) {
	return file_resource_definitions_runtime_runtime_proto_rawDescGZIP(), []int{16}
}

func (x *PCIRebindConfigSpec) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PCIRebindConfigSpec) GetVendorDeviceId() string {
	if x != nil {
...
func (x *PCIRebindConfigSpec) GetTargetDriver() string {
	if x != nil {
...
type PCIRebindStatusSpec struct {
	...
	Name           string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	VendorDeviceId string `protobuf:"bytes,2,opt,name=vendor_device_id,json=vendorDeviceId,proto3" json:"vendor_device_id,omitempty"`
	HostDriver     string `protobuf:"bytes,3,opt,name=host_driver,json=hostDriver,proto3" json:"host_driver,omitempty"`
	TargetDriver   string `protobuf:"bytes,4,opt,name=target_driver,json=targetDriver,proto3" json:"target_driver,omitempty"`
}

func (x *PCIRebindStatusSpec) Reset() {
	*x = PCIRebindStatusSpec{}
	mi := &file_resource_definitions_runtime_runtime_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PCIRebindStatusSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PCIRebindStatusSpec) ProtoMessage() {}

func (x *PCIRebindStatusSpec) ProtoReflect() protoreflect.Message {
	mi := &file_resource_definitions_runtime_runtime_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PCIRebindStatusSpec.ProtoReflect.Descriptor instead.
func (*PCIRebindStatusSpec) Descriptor() ([]byte, []int) {
	return file_resource_definitions_runtime_runtime_proto_rawDescGZIP(), []int{17}
}

func (x *PCIRebindStatusSpec) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PCIRebindStatusSpec) GetVendorDeviceId() string {
	if x != nil {
		return x.VendorDeviceId
	}
	return ""
...
func (x *PCIRebindStatusSpec) GetHostDriver() string {
	if x != nil {
		return x.HostDriver
	}
	return ""
...
func (x *PCIRebindStatusSpec) GetTargetDriver() string {
	if x != nil {
		return x.TargetDriver
	}
	return ""
...
var file_resource_definitions_runtime_runtime_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6f, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f,
	0x64, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x44, 0x6e, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x5f, 0x64, 0x6e, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x44, 0x6e, 0x73, 0x22, 0xb2, 0x01, 0x0a, 0x11, 0x53, 0x65,
	...
	0x4b, 0x65, 0x79, 0x46, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x22, 0x2e,
	0x0a, 0x16, 0x55, 0x6e, 0x69, 0x71, 0x75, 0x65, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x70, 0x65, 0x63, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x66, 0x0a, 0x17,
	0x57, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f, 0x67, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x53, 0x70, 0x65, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63,
	...
	0x65, 0x6f, 0x75, 0x74, 0x22, 0xa6, 0x01, 0x0a, 0x17, 0x57, 0x61, 0x74, 0x63, 0x68, 0x64, 0x6f,
	0x67, 0x54, 0x69, 0x6d, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x53, 0x70, 0x65, 0x63,
	0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65,
	...
	0x0d, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0c, 0x66, 0x65, 0x65, 0x64, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x42, 0x78, 0x0a,
	0x2a, 0x64, 0x65, 0x76, 0x2e, 0x74, 0x61, 0x6c, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x5a, 0x4a, 0x67, 0x69, 0x74,
...
var file_resource_definitions_runtime_runtime_proto_goTypes = []any{
	...
	(*PCIRebindConfigSpec)(nil),              // 16: talos.resource.definitions.runtime.PCIRebindConfigSpec
	(*PCIRebindStatusSpec)(nil),              // 17: talos.resource.definitions.runtime.PCIRebindStatusSpec
...
var file_resource_definitions_runtime_runtime_proto_depIdxs = []int32{
	...
	27, // 6: talos.resource.definitions.runtime.WatchdogTimerConfigSpec.timeout:type_name -> google.protobuf.Duration
	27, // 7: talos.resource.definitions.runtime.WatchdogTimerStatusSpec.timeout:type_name -> google.protobuf.Duration
	27, // 8: talos.resource.definitions.runtime.WatchdogTimerStatusSpec.feed_interval:type_name -> google.protobuf.Duration
