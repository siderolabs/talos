...
var file_cluster_cluster_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x30, 0x01, 0x42, 0x4e, 0x0a, 0x15, 0x64, 0x65,
	0x76, 0x2e, 0x74, 0x61, 0x6c, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
func file_cluster_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cluster_cluster_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cluster_cluster_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cluster_cluster_proto_msgTypes[2].Exporter = func(v any, i int) any {
