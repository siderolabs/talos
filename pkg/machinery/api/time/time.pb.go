...
var file_time_time_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x48, 0x0a, 0x12, 0x64, 0x65, 0x76, 0x2e, 0x74, 0x61, 0x6c,
	0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x74, 0x69, 0x6d, 0x65, 0x5a, 0x32, 0x67, 0x69, 0x74,
...
func file_time_time_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_time_time_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_time_time_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Time); i {
			case 0:
				return &v.state
			case 1:
		...
		file_time_time_proto_msgTypes[2].Exporter = func(v any, i int) any {
