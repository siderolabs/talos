...
//go:generate go tool github.com/siderolabs/talos/tools/docgen -output hypervisor_doc.go hypervisor.go content_library_config.go virtual_machine_config.go
