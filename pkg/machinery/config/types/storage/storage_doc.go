		...
		Fields: []encoder.Doc{
			{
				...
				Type:        "Expression",
				Note:        "",
				Description: "CEL expression matching the member disks of the array.\n\nEvaluated against each discovered disk with the `disk` variable.",
				Comments:    [3]string{"" /* encoder.HeadComment */, "CEL expression matching the member disks of the array." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
		},
	}
