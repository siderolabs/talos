	...
	doc := &encoder.Doc{
		...
		Fields: []encoder.Doc{
			...
			},
			{
				...
				Comments:    [3]string{"" /* encoder.HeadComment */, "Require the selector to match exactly one link." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
			{
				Name:        "skipAliasedLinks",
				Type:        "bool",
				Note:        "",
				...
				Comments:    [3]string{"" /* encoder.HeadComment */, "Skip links that already have an alias assigned by a previous LinkAliasConfig." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
		},
	}
