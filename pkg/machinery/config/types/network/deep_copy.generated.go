...
// DeepCopy generates a deep copy of *WifiConfigV1Alpha1.
func (o *WifiConfigV1Alpha1) DeepCopy() *WifiConfigV1Alpha1 {
	var cp WifiConfigV1Alpha1 = *o
	if o.WifiNetworks != nil {
		cp.WifiNetworks = make([]WifiNetworkConfig, len(o.WifiNetworks))
		copy(cp.WifiNetworks, o.WifiNetworks)
	}
	return &cp
}
