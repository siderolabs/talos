...
// DeepCopy generates a deep copy of *BGPInstanceConfigV1Alpha1.
func (o *BGPInstanceConfigV1Alpha1) DeepCopy() *BGPInstanceConfigV1Alpha1 {
	var cp BGPInstanceConfigV1Alpha1 = *o
	if o.BGPAdvertise != nil {
	...
	if o.BGPNeighborConfigs != nil {
		...
		for i2 := range o.BGPNeighborConfigs {
			if o.BGPNeighborConfigs[i2].NeighborBFDConfig != nil {
				cp.BGPNeighborConfigs[i2].NeighborBFDConfig = new(BGPBFDConfig)
				*cp.BGPNeighborConfigs[i2].NeighborBFDConfig = *o.BGPNeighborConfigs[i2].NeighborBFDConfig
			}
		}
	}
	return &cp
...
// DeepCopy generates a deep copy of *VXLANConfigV1Alpha1.
func (o *VXLANConfigV1Alpha1) DeepCopy() *VXLANConfigV1Alpha1 {
	var cp VXLANConfigV1Alpha1 = *o
	if o.VXLANPort != nil {
		cp.VXLANPort = new(uint16)
		*cp.VXLANPort = *o.VXLANPort
	}
	if o.VXLANLearning != nil {
		cp.VXLANLearning = new(bool)
		*cp.VXLANLearning = *o.VXLANLearning
	}
	if o.HardwareAddressConfig != nil {
		cp.HardwareAddressConfig = make([]byte, len(o.HardwareAddressConfig))
		copy(cp.HardwareAddressConfig, o.HardwareAddressConfig)
...
// DeepCopy generates a deep copy of *MacVLANConfigV1Alpha1.
func (o *MacVLANConfigV1Alpha1) DeepCopy() *MacVLANConfigV1Alpha1 {
	var cp MacVLANConfigV1Alpha1 = *o
	if o.MacVLANMode != nil {
		cp.MacVLANMode = new(nethelpers.MacvlanMode)
		*cp.MacVLANMode = *o.MacVLANMode
	}
	if o.HardwareAddressConfig != nil {
		cp.HardwareAddressConfig = make([]byte, len(o.HardwareAddressConfig))
		copy(cp.HardwareAddressConfig, o.HardwareAddressConfig)
...
// DeepCopy generates a deep copy of *LinkIngressConfigV1Alpha1.
func (o *LinkIngressConfigV1Alpha1) DeepCopy() *LinkIngressConfigV1Alpha1 {
	var cp LinkIngressConfigV1Alpha1 = *o
	if o.DestinationAddressesConfig != nil {
		cp.DestinationAddressesConfig = make([]meta.Prefix, len(o.DestinationAddressesConfig))
		copy(cp.DestinationAddressesConfig, o.DestinationAddressesConfig)
	}
	return &cp
}
...
// DeepCopy generates a deep copy of *VethConfigV1Alpha1.
func (o *VethConfigV1Alpha1) DeepCopy() *VethConfigV1Alpha1 {
	var cp VethConfigV1Alpha1 = *o
	if o.VethPeer.CommonLinkConfig.LinkUp != nil {
		cp.VethPeer.CommonLinkConfig.LinkUp = new(bool)
		*cp.VethPeer.CommonLinkConfig.LinkUp = *o.VethPeer.CommonLinkConfig.LinkUp
	}
	if o.VethPeer.CommonLinkConfig.LinkAddresses != nil {
		cp.VethPeer.CommonLinkConfig.LinkAddresses = make([]AddressConfig, len(o.VethPeer.CommonLinkConfig.LinkAddresses))
		copy(cp.VethPeer.CommonLinkConfig.LinkAddresses, o.VethPeer.CommonLinkConfig.LinkAddresses)
		for i4 := range o.VethPeer.CommonLinkConfig.LinkAddresses {
			if o.VethPeer.CommonLinkConfig.LinkAddresses[i4].AddressPriority != nil {
				cp.VethPeer.CommonLinkConfig.LinkAddresses[i4].AddressPriority = new(uint32)
				*cp.VethPeer.CommonLinkConfig.LinkAddresses[i4].AddressPriority = *o.VethPeer.CommonLinkConfig.LinkAddresses[i4].AddressPriority
			}
		}
	}
	if o.VethPeer.CommonLinkConfig.LinkRoutes != nil {
		cp.VethPeer.CommonLinkConfig.LinkRoutes = make([]RouteConfig, len(o.VethPeer.CommonLinkConfig.LinkRoutes))
		copy(cp.VethPeer.CommonLinkConfig.LinkRoutes, o.VethPeer.CommonLinkConfig.LinkRoutes)
	}
	if o.VethPeer.CommonLinkConfig.LinkMulticast != nil {
		cp.VethPeer.CommonLinkConfig.LinkMulticast = new(bool)
		*cp.VethPeer.CommonLinkConfig.LinkMulticast = *o.VethPeer.CommonLinkConfig.LinkMulticast
	}
	if o.CommonLinkConfig.LinkUp != nil {
		cp.CommonLinkConfig.LinkUp = new(bool)
		*cp.CommonLinkConfig.LinkUp = *o.CommonLinkConfig.LinkUp
