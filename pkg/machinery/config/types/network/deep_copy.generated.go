...
// DeepCopy generates a deep copy of *NATRuleConfigV1Alpha1.
func (o *NATRuleConfigV1Alpha1) DeepCopy() *NATRuleConfigV1Alpha1 {
	var cp NATRuleConfigV1Alpha1 = *o
	if o.SourceAddress.IncludeSubnets != nil {
		cp.SourceAddress.IncludeSubnets = make([]netip.Prefix, len(o.SourceAddress.IncludeSubnets))
		copy(cp.SourceAddress.IncludeSubnets, o.SourceAddress.IncludeSubnets)
	}
	if o.OutputInterface.InterfaceNames != nil {
		cp.OutputInterface.InterfaceNames = make([]string, len(o.OutputInterface.InterfaceNames))
		copy(cp.OutputInterface.InterfaceNames, o.OutputInterface.InterfaceNames)
	}
	if o.InputInterface.InterfaceNames != nil {
		cp.InputInterface.InterfaceNames = make([]string, len(o.InputInterface.InterfaceNames))
		copy(cp.InputInterface.InterfaceNames, o.InputInterface.InterfaceNames)
	}
	if o.DestinationAddress.IncludeSubnets != nil {
		cp.DestinationAddress.IncludeSubnets = make([]netip.Prefix, len(o.DestinationAddress.IncludeSubnets))
		copy(cp.DestinationAddress.IncludeSubnets, o.DestinationAddress.IncludeSubnets)
	}
	return &cp
}
