...
// DeepCopy generates a deep copy of *ProbeConfigV1Alpha1.
func (o *ProbeConfigV1Alpha1) DeepCopy() *ProbeConfigV1Alpha1 {
	var cp ProbeConfigV1Alpha1 = *o
	if o.TCP != nil {
		cp.TCP = new(TCPProbeConfigV1Alpha1)
		*cp.TCP = *o.TCP
	}
	return &cp
}
