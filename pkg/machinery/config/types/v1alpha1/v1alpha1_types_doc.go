...
func init() {
	...
	MachineConfigDoc.Fields[4].AddExample("Kubelet definition example.", machineControlplaneExample)
	...
	MachineControlPlaneConfigDoc.AddExample("Kubelet definition example.", machineControlplaneExample)
	...
	MachineControllerManagerConfigDoc.Fields[0].Description = "Disable ControllerManager on the node."
	MachineControllerManagerConfigDoc.Fields[0].Comments[encoder.LineComment] = "Disable ControllerManager on the node."
	...
	MachineSchedulerConfigDoc.Fields[0].Description = "Disable Scheduler on the node."
	MachineSchedulerConfigDoc.Fields[0].Comments[encoder.LineComment] = "Disable Scheduler on the node."
