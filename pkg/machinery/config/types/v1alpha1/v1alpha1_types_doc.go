...
=======
	...
	ClusterConfigDoc.Fields[0].Comments[encoder.LineComment] = "Globally unique identifier for this cluster."
	ClusterConfigDoc.Fields[1].Name = "controlPlane"
	ClusterConfigDoc.Fields[1].Type = "ControlPlaneConfig"
	ClusterConfigDoc.Fields[1].Note = ""
	ClusterConfigDoc.Fields[1].Description = "Provides control plane specific configuration options."
	ClusterConfigDoc.Fields[1].Comments[encoder.LineComment] = "Provides control plane specific configuration options."

	ClusterConfigDoc.Fields[1].AddExample("Setting controlplane endpoint address to 1.2.3.4 and port to 443 example.", clusterControlPlaneExample)
	ClusterConfigDoc.Fields[2].Name = "clusterName"
	ClusterConfigDoc.Fields[2].Type = "string"
	ClusterConfigDoc.Fields[2].Note = ""
	ClusterConfigDoc.Fields[2].Description = "Configures the cluster's name."
	ClusterConfigDoc.Fields[2].Comments[encoder.LineComment] = "Configures the cluster's name."
	ClusterConfigDoc.Fields[3].Name = "network"
	ClusterConfigDoc.Fields[3].Type = "ClusterNetworkConfig"
	ClusterConfigDoc.Fields[3].Note = ""
	ClusterConfigDoc.Fields[3].Description = "Provides cluster specific network configuration options."
	ClusterConfigDoc.Fields[3].Comments[encoder.LineComment] = "Provides cluster specific network configuration options."

	ClusterConfigDoc.Fields[3].AddExample("Configuring with flannel CNI and setting up subnets.", clusterNetworkExample)
	ClusterConfigDoc.Fields[4].Name = "token"
	ClusterConfigDoc.Fields[4].Type = "string"
	ClusterConfigDoc.Fields[4].Note = ""
	ClusterConfigDoc.Fields[4].Description = "The [bootstrap token](https://kubernetes.io/docs/reference/access-authn-authz/bootstrap-tokens/) used to join the cluster."
	ClusterConfigDoc.Fields[4].Comments[encoder.LineComment] = "The [bootstrap token](https://kubernetes.io/docs/reference/access-authn-authz/bootstrap-tokens/) used to join the cluster."

	ClusterConfigDoc.Fields[4].AddExample("Bootstrap token example (do not use in production!).", "wlzjyw.bei2zfylhs2by0wd")
	ClusterConfigDoc.Fields[5].Name = "aescbcEncryptionSecret"
	ClusterConfigDoc.Fields[5].Type = "string"
	ClusterConfigDoc.Fields[5].Note = ""
	ClusterConfigDoc.Fields[5].Description = "The key used for the [encryption of secret data at rest](https://kubernetes.io/docs/tasks/administer-cluster/encrypt-data/)."
	ClusterConfigDoc.Fields[5].Comments[encoder.LineComment] = "The key used for the [encryption of secret data at rest](https://kubernetes.io/docs/tasks/administer-cluster/encrypt-data/)."

	ClusterConfigDoc.Fields[5].AddExample("Decryption secret example (do not use in production!).", "z01mye6j16bspJYtTB/5SFX8j7Ph4JXxM2Xuu4vsBPM=")
	ClusterConfigDoc.Fields[6].Name = "ca"
	ClusterConfigDoc.Fields[6].Type = "PEMEncodedCertificateAndKey"
	ClusterConfigDoc.Fields[6].Note = ""
	ClusterConfigDoc.Fields[6].Description = "The base64 encoded root certificate authority used by Kubernetes."
	ClusterConfigDoc.Fields[6].Comments[encoder.LineComment] = "The base64 encoded root certificate authority used by Kubernetes."

	ClusterConfigDoc.Fields[6].AddExample("ClusterCA example.", pemEncodedCertificateExample)
	ClusterConfigDoc.Fields[7].Name = "aggregatorCA"
	ClusterConfigDoc.Fields[7].Type = "PEMEncodedCertificateAndKey"
	ClusterConfigDoc.Fields[7].Note = ""
	ClusterConfigDoc.Fields[7].Description = "The base64 encoded aggregator certificate authority used by Kubernetes for front-proxy certificate generation.\n\nThis CA can be self-signed."
	ClusterConfigDoc.Fields[7].Comments[encoder.LineComment] = "The base64 encoded aggregator certificate authority used by Kubernetes for front-proxy certificate generation."

	ClusterConfigDoc.Fields[7].AddExample("AggregatorCA example.", pemEncodedCertificateExample)
	ClusterConfigDoc.Fields[8].Name = "serviceAccount"
	ClusterConfigDoc.Fields[8].Type = "PEMEncodedKey"
	ClusterConfigDoc.Fields[8].Note = ""
	ClusterConfigDoc.Fields[8].Description = "The base64 encoded private key for service account token generation."
	ClusterConfigDoc.Fields[8].Comments[encoder.LineComment] = "The base64 encoded private key for service account token generation."

	ClusterConfigDoc.Fields[8].AddExample("AggregatorCA example.", pemEncodedKeyExample)
	ClusterConfigDoc.Fields[9].Name = "apiServer"
	ClusterConfigDoc.Fields[9].Type = "APIServerConfig"
	ClusterConfigDoc.Fields[9].Note = ""
	ClusterConfigDoc.Fields[9].Description = "API server specific configuration options."
	ClusterConfigDoc.Fields[9].Comments[encoder.LineComment] = "API server specific configuration options."

	ClusterConfigDoc.Fields[9].AddExample("", clusterAPIServerExample)
	ClusterConfigDoc.Fields[10].Name = "controllerManager"
	ClusterConfigDoc.Fields[10].Type = "ControllerManagerConfig"
	ClusterConfigDoc.Fields[10].Note = ""
	ClusterConfigDoc.Fields[10].Description = "Controller manager server specific configuration options."
	ClusterConfigDoc.Fields[10].Comments[encoder.LineComment] = "Controller manager server specific configuration options."

	ClusterConfigDoc.Fields[10].AddExample("", clusterControllerManagerExample)
	ClusterConfigDoc.Fields[11].Name = "proxy"
	ClusterConfigDoc.Fields[11].Type = "ProxyConfig"
	ClusterConfigDoc.Fields[11].Note = ""
	ClusterConfigDoc.Fields[11].Description = "Kube-proxy server-specific configuration options"
	ClusterConfigDoc.Fields[11].Comments[encoder.LineComment] = "Kube-proxy server-specific configuration options"

	ClusterConfigDoc.Fields[11].AddExample("", clusterProxyExample)
	ClusterConfigDoc.Fields[12].Name = "scheduler"
	ClusterConfigDoc.Fields[12].Type = "SchedulerConfig"
	ClusterConfigDoc.Fields[12].Note = ""
	ClusterConfigDoc.Fields[12].Description = "Scheduler server specific configuration options."
	ClusterConfigDoc.Fields[12].Comments[encoder.LineComment] = "Scheduler server specific configuration options."

	ClusterConfigDoc.Fields[12].AddExample("", clusterSchedulerExample)
	ClusterConfigDoc.Fields[13].Name = "etcd"
	ClusterConfigDoc.Fields[13].Type = "EtcdConfig"
	ClusterConfigDoc.Fields[13].Note = ""
	ClusterConfigDoc.Fields[13].Description = "Etcd specific configuration options."
	ClusterConfigDoc.Fields[13].Comments[encoder.LineComment] = "Etcd specific configuration options."

	ClusterConfigDoc.Fields[13].AddExample("", clusterEtcdExample)
...
>>>>>>> 5d5a505e (remove dead code and old wg API)
		"true",
		"yes",
		"false",
		"no",
	...
	DeviceWireguardConfigDoc.Fields = make([]encoder.Doc, 9)
	...
	DeviceWireguardConfigDoc.Fields[1].Description = "Specifies a device's listening port.  Default is 51820."
	DeviceWireguardConfigDoc.Fields[1].Comments[encoder.LineComment] = "Specifies a device's listening port.  Default is 51820."
	...
	DeviceWireguardConfigDoc.Fields[4].Name = "enablePodNetworking"
	DeviceWireguardConfigDoc.Fields[4].Type = "bool"
	DeviceWireguardConfigDoc.Fields[4].Note = ""
	DeviceWireguardConfigDoc.Fields[4].Description = "Indicates whether this Wireguard interface should provide backup Pod-to-Pod connectivity.\nNote that this requires the Nodes to already exist as Peers, which means it generally requires enableAutomaticNodes, as well."
	DeviceWireguardConfigDoc.Fields[4].Comments[encoder.LineComment] = "Indicates whether this Wireguard interface should provide backup Pod-to-Pod connectivity."
	DeviceWireguardConfigDoc.Fields[5].Name = "enableAutomaticNodes"
	DeviceWireguardConfigDoc.Fields[5].Type = "bool"
	DeviceWireguardConfigDoc.Fields[5].Note = ""
	DeviceWireguardConfigDoc.Fields[5].Description = "Indicates whether cluster Nodes should be automatically added as Peers."
	DeviceWireguardConfigDoc.Fields[5].Comments[encoder.LineComment] = "Indicates whether cluster Nodes should be automatically added as Peers."
	DeviceWireguardConfigDoc.Fields[6].Name = "automaticNodePrefix"
	DeviceWireguardConfigDoc.Fields[6].Type = "string"
	DeviceWireguardConfigDoc.Fields[6].Note = ""
	DeviceWireguardConfigDoc.Fields[6].Description = "Indicates the IPv6 prefix to be used for automatically-added Node Peers.\nThe prefix must be at least /64.\nIf not provided, the default, 0200:1001::/64, will be used (if Automatic Nodes is enabled).\nNote that this default prefix is not routable over the public Internet and it is deprecated by the IETF.\nHowever, it _is_ used by the Yggdrasil Network, which provides similar connectivity in a public cloud.\nNote also that no IPv6 connectivity is required to use this prefix."
	DeviceWireguardConfigDoc.Fields[6].Comments[encoder.LineComment] = "Indicates the IPv6 prefix to be used for automatically-added Node Peers."
	DeviceWireguardConfigDoc.Fields[7].Name = "natDiscoveryService"
	DeviceWireguardConfigDoc.Fields[7].Type = "string"
	DeviceWireguardConfigDoc.Fields[7].Note = ""
	DeviceWireguardConfigDoc.Fields[7].Description = "Use the specified URL for the NAT discovery service."
	DeviceWireguardConfigDoc.Fields[7].Comments[encoder.LineComment] = "Use the specified URL for the NAT discovery service."
	DeviceWireguardConfigDoc.Fields[8].Name = "clusterID"
	DeviceWireguardConfigDoc.Fields[8].Type = "string"
	DeviceWireguardConfigDoc.Fields[8].Note = ""
	DeviceWireguardConfigDoc.Fields[8].Description = "Defines a cluster ID for automatic Node addition.\nIf not defined, the main cluster ID will be used."
	DeviceWireguardConfigDoc.Fields[8].Comments[encoder.LineComment] = "Defines a cluster ID for automatic Node addition."
