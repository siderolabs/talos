...
>>>>>>> 5d5a505e (remove dead code and old wg API)
	...
	DeviceWireguardConfigDoc.Fields = make([]encoder.Doc, 7)
	...
	DeviceWireguardConfigDoc.Fields[4].Name = "enableKubeSpan"
	DeviceWireguardConfigDoc.Fields[4].Type = "bool"
	DeviceWireguardConfigDoc.Fields[4].Note = ""
	DeviceWireguardConfigDoc.Fields[4].Description = "Indicates whether KubeSpan should be enabled on this interface."
	DeviceWireguardConfigDoc.Fields[4].Comments[encoder.LineComment] = "Indicates whether KubeSpan should be enabled on this interface."
	DeviceWireguardConfigDoc.Fields[5].Name = "kubeSpanPrefix"
	DeviceWireguardConfigDoc.Fields[5].Type = "string"
	DeviceWireguardConfigDoc.Fields[5].Note = ""
	DeviceWireguardConfigDoc.Fields[5].Description = "Indicates the IPv6 prefix to be used for automatically-added Node Peers.\nThe prefix must be at least /64.\nIf not provided (and it is recommended to not provide one), a cluster-unique deterministic address in the RFC4193 range will be used.\nNote also that IPv6 connectivity is NOT required to use this prefix."
	DeviceWireguardConfigDoc.Fields[5].Comments[encoder.LineComment] = "Indicates the IPv6 prefix to be used for automatically-added Node Peers."
	DeviceWireguardConfigDoc.Fields[6].Name = "kubespanDiscoveryService"
	DeviceWireguardConfigDoc.Fields[6].Type = "string"
	DeviceWireguardConfigDoc.Fields[6].Note = ""
	DeviceWireguardConfigDoc.Fields[6].Description = "Use the specified URL for the NAT discovery service."
	DeviceWireguardConfigDoc.Fields[6].Comments[encoder.LineComment] = "Use the specified URL for the NAT discovery service."
