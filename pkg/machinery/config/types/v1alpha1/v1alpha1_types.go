...
type MachineConfig struct {
	...
	MachineNodeTaints map[string]string `yaml:"nodeTaints,omitempty" docgen:"{'in':'1.6'}"`
}
...
type LinuxIDMapping struct {
	...
	ContainerID uint32 `yaml:"containerID" docgen:"{'in':'1.5'}"`

	// HostID is the starting UID/GID on the host to be mapped to 'ContainerID'.
	HostID uint32 `yaml:"hostID" docgen:"{'in':'1.5'}"`

	// Size is the number of IDs to be mapped.
	Size uint32 `yaml:"size" docgen:"{'in':'1.5'}"`
}

// ExtraMount wraps OCI Mount specification.
type ExtraMount struct {
	// Destination is the absolute path where the mount will be placed in the container.
	Destination string `yaml:"destination" docgen:"{'in':'1.5'}"`

	// Type specifies the mount kind.
	Type string `yaml:"type,omitempty" docgen:"{'in':'1.5'}"`

	// Source specifies the source path of the mount.
	Source string `yaml:"source,omitempty" docgen:"{'in':'1.5'}"`

	// Options are fstab style mount options.
	Options []string `yaml:"options,omitempty" docgen:"{'in':'1.5'}"`

	// UID/GID mappings used for changing file owners w/o calling chown, fs should support it.
	// Every mount point could have its own mapping.
	UIDMappings []LinuxIDMapping `yaml:"uidMappings,omitempty" docgen:"{'in':'1.5'}"`
	// UID/GID mappings used for changing file owners w/o calling chown, fs should support it.
	// Every mount point could have its own mapping.
	GIDMappings []LinuxIDMapping `yaml:"gidMappings,omitempty" docgen:"{'in':'1.5'}"`
}
...
type KubeletConfig struct {
	...
	KubeletImage string `yaml:"image,omitempty" docgen:"{'in':'1.5'}"`

	// Specifies an optional reference to an alternative kubelet clusterDNS IP list.
	KubeletClusterDNS []string `yaml:"clusterDNS,omitempty" docgen:"{'in':'1.5'}"`
...
type BridgePort struct {
	// Specifies the name of the bridge master interface.
	BridgePortMaster string `yaml:"master,omitempty" docgen:"{'in':'1.5'}"`
}
...
type Route struct {
	...
	RouteMetric uint32 `yaml:"metric,omitempty" docgen:"{'in':'1.5'}"`

	// The optional MTU for the route.
	RouteMTU uint32 `yaml:"mtu,omitempty" docgen:"{'in':'1.5'}"`
}
...
type RegistryConfig struct {
	...
	RegistryAuth *RegistryAuthConfig `yaml:"auth,omitempty" docgen:"{'in':'1.5'}"`
}
...
type HostDNSConfig struct {
	...
	HostDNSEnabled *bool `yaml:"enabled,omitempty" docgen:"{'in':'1.5'}"`
	...
	HostDNSForwardKubeDNSToHost *bool `yaml:"forwardKubeDNSToHost,omitempty" docgen:"{'in':'1.7'}"`
	...
	HostDNSResolveMemberNames *bool `yaml:"resolveMemberNames,omitempty" docgen:"{'in':'1.7'}"`
}
