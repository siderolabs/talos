...
func (in *APIServerBalancer) DeepCopyInto(out *APIServerBalancer) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIServerBalancer.
func (in *APIServerBalancer) DeepCopy() *APIServerBalancer {
	if in == nil {
		return nil
	}
	out := new(APIServerBalancer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Config) DeepCopyInto(out *Config) {
	*out = *in
	if in.ConfigDebug != nil {
		in, out := &in.ConfigDebug, &out.ConfigDebug
		*out = new(bool)
		**out = **in
	}
	if in.ConfigPersist != nil {
		in, out := &in.ConfigPersist, &out.ConfigPersist
		*out = new(bool)
		**out = **in
	}
...
func (in *FeaturesConfig) DeepCopyInto(out *FeaturesConfig) {
	*out = *in
	...
	if in.APIServerBalancerSupport != nil {
		in, out := &in.APIServerBalancerSupport, &out.APIServerBalancerSupport
		*out = new(APIServerBalancer)
		(*in).DeepCopyInto(*out)
	}
	return
