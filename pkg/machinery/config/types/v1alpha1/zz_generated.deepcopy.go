...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (cfg *KernelModuleConfig) DeepCopyInto(out *KernelModuleConfig) {
	*out = *cfg
	if cfg.ModuleParameters != nil {
		in, out := &cfg.ModuleParameters, &out.ModuleParameters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (cfg *KernelModuleConfig) DeepCopy() *KernelModuleConfig {
	if cfg == nil {
		return nil
	}
	out := new(KernelModuleConfig)
...
func (in *MachineConfig) DeepCopyInto(out *MachineConfig) {
	*out = *in
	...
	if in.MachinePods != nil {
		...
		*out = make([]meta.Unstructured, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
