...
// Code generated by "deep-copy -type CRIBaseRuntimeSpecConfigV1Alpha1 -type CRICustomizationConfigV1Alpha1 -type ImageCacheConfigV1Alpha1 -type RegistryAuthConfigV1Alpha1 -type RegistryMirrorConfigV1Alpha1 -type RegistryTLSConfigV1Alpha1 -pointer-receiver -header-file ../../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of *CRIBaseRuntimeSpecConfigV1Alpha1.
func (o *CRIBaseRuntimeSpecConfigV1Alpha1) DeepCopy() *CRIBaseRuntimeSpecConfigV1Alpha1 {
	var cp CRIBaseRuntimeSpecConfigV1Alpha1 = *o
	{
		retV := o.OverridesConfig.DeepCopy()
		cp.OverridesConfig = *retV
	}
	return &cp
}

// DeepCopy generates a deep copy of *CRICustomizationConfigV1Alpha1.
func (o *CRICustomizationConfigV1Alpha1) DeepCopy() *CRICustomizationConfigV1Alpha1 {
	var cp CRICustomizationConfigV1Alpha1 = *o
	return &cp
}

// DeepCopy generates a deep copy of *ImageCacheConfigV1Alpha1.
func (o *ImageCacheConfigV1Alpha1) DeepCopy() *ImageCacheConfigV1Alpha1 {
	var cp ImageCacheConfigV1Alpha1 = *o
	if o.LocalConfig.ConfigEnabled != nil {
		cp.LocalConfig.ConfigEnabled = new(bool)
		*cp.LocalConfig.ConfigEnabled = *o.LocalConfig.ConfigEnabled
	}
	return &cp
}
