...
func (o *ExistingVolumeConfigV1Alpha1) DeepCopy() *ExistingVolumeConfigV1Alpha1 {
	...
	if o.TrimSpec != nil {
		cp.TrimSpec = new(TrimConfig)
		*cp.TrimSpec = *o.TrimSpec
		if o.TrimSpec.TrimEnabled != nil {
	...
	if o.ScrubSpec != nil {
		...
		*cp.ScrubSpec = *o.ScrubSpec
		if o.ScrubSpec.ScrubEnabled != nil {
			cp.ScrubSpec.ScrubEnabled = new(bool)
			*cp.ScrubSpec.ScrubEnabled = *o.ScrubSpec.ScrubEnabled
		}
	}
	return &cp
}

// DeepCopy generates a deep copy of *FilesystemScrubConfigV1Alpha1.
func (o *FilesystemScrubConfigV1Alpha1) DeepCopy() *FilesystemScrubConfigV1Alpha1 {
	var cp FilesystemScrubConfigV1Alpha1 = *o
	return &cp
}
...
func (o *RawVolumeConfigV1Alpha1) DeepCopy() *RawVolumeConfigV1Alpha1 {
	...
	cp.ProvisioningSpec.ProvisioningMinSize = o.ProvisioningSpec.ProvisioningMinSize.DeepCopy()
	cp.ProvisioningSpec.ProvisioningMaxSize = o.ProvisioningSpec.ProvisioningMaxSize.DeepCopy()
	if o.EncryptionSpec.EncryptionKeys != nil {
		...
		for i3 := range o.EncryptionSpec.EncryptionKeys {
			...
			if o.EncryptionSpec.EncryptionKeys[i3].KeyRecovery != nil {
				cp.EncryptionSpec.EncryptionKeys[i3].KeyRecovery = new(EncryptionKeyRecovery)
				*cp.EncryptionSpec.EncryptionKeys[i3].KeyRecovery = *o.EncryptionSpec.EncryptionKeys[i3].KeyRecovery
			}
...
func (o *UserVolumeConfigV1Alpha1) DeepCopy() *UserVolumeConfigV1Alpha1 {
	...
	if o.FilesystemSpec.XFSSpec != nil {
		...
		*cp.FilesystemSpec.XFSSpec = *o.FilesystemSpec.XFSSpec
		cp.FilesystemSpec.XFSSpec.MinAllocationGroupSizeConfig = o.FilesystemSpec.XFSSpec.MinAllocationGroupSizeConfig.DeepCopy()
	}
	if o.EncryptionSpec.EncryptionKeys != nil {
		cp.EncryptionSpec.EncryptionKeys = make([]EncryptionKey, len(o.EncryptionSpec.EncryptionKeys))
		copy(cp.EncryptionSpec.EncryptionKeys, o.EncryptionSpec.EncryptionKeys)
