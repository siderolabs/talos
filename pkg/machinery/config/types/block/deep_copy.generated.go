		...
		for i3 := range o.EncryptionSpec.EncryptionKeys {
			...
			if o.EncryptionSpec.EncryptionKeys[i3].KeyTPM != nil {
				...
				*cp.EncryptionSpec.EncryptionKeys[i3].KeyTPM = *o.EncryptionSpec.EncryptionKeys[i3].KeyTPM
				...
				if o.EncryptionSpec.EncryptionKeys[i3].KeyTPM.TPMLockToSecureBootState != nil {
					cp.EncryptionSpec.EncryptionKeys[i3].KeyTPM.TPMLockToSecureBootState = new(bool)
					*cp.EncryptionSpec.EncryptionKeys[i3].KeyTPM.TPMLockToSecureBootState = *o.EncryptionSpec.EncryptionKeys[i3].KeyTPM.TPMLockToSecureBootState
				}
			}
