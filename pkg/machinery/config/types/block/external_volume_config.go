...
// NFSProtocolType is an alias for block.NFSProtocolType.
type NFSProtocolType = block.NFSProtocolType
...
type NFSMountSpec struct {
	...
	//  schema:
	//    type: string
	NFSVersion NFSVersionType `yaml:"vers"`
	...
	//  schema:
	//    type: string
	NFSProtocol NFSProtocolType `yaml:"proto"`

	//   description: |
	//     Enable or disable ACL for NFS.
	NFSACL bool `yaml:"acl"`
}
...
func exampleExternalVolumeConfigV1Alpha1NFS() *ExternalVolumeConfigV1Alpha1 {
	...
	cfg.MountSpec.MountNFS = &NFSMountSpec{
		...
		NFSProtocol: block.NFSProtocolTypeTCP,
		NFSACL:      true,
	}
...
func (s NFSMountSpec) Parameters() []block.ParameterSpec {
	// TODO(@shanduur): might need more options here in the future
	// See: https://linux.die.net/man/5/nfs | https://man7.org/linux/man-pages/man5/nfs.5.html
	m := []block.ParameterSpec{
		block.NewStringParameter("vers", s.NFSVersion.String()),
		block.NewStringParameter("proto", s.NFSProtocol.String()),
	}
	...
	m = append(m, block.NewBooleanParameter(acl))
