...
func TestFilesystemTrimConfigMarshalUnmarshal(t *testing.T) {
	t.Parallel()
	...
	for _, test := range []struct {
		...
		{
			name:     "full config",
			filename: "filesystemtrimconfig_full.yaml",
			cfg: func(t *testing.T) *block.FilesystemTrimConfigV1Alpha1 {
		...
		{
			name:     "min config",
			filename: "filesystemtrimconfig_min.yaml",
			cfg: func(t *testing.T) *block.FilesystemTrimConfigV1Alpha1 {
				c := block.NewFilesystemTrimConfigV1Alpha1()
...
func TestFilesystemTrimConfigValidate(t *testing.T) {
	t.Parallel()
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			cfg: func(t *testing.T) *block.FilesystemTrimConfigV1Alpha1 {
				return block.NewFilesystemTrimConfigV1Alpha1()
			},
		},
		{
			name: "full",
