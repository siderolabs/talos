...
// Code generated by "deep-copy -type APICertsSpec -type CertSANSpec -type EtcdCertsSpec -type EtcdRootSpec -type EncryptionRecoveryKeySpec -type EncryptionSaltSpec -type GeneratedRecoveryKeySpec -type KubeletSpec -type KubernetesCertsSpec -type KubernetesDynamicCertsSpec -type KubernetesRootSpec -type MaintenanceRootSpec -type OSRootSpec -type TrustdCertsSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of EncryptionRecoveryKeySpec.
func (o EncryptionRecoveryKeySpec) DeepCopy() EncryptionRecoveryKeySpec {
	var cp EncryptionRecoveryKeySpec = o
	if o.Key != nil {
		cp.Key = make([]byte, len(o.Key))
		copy(cp.Key, o.Key)
	}
	return cp
}
...
// DeepCopy generates a deep copy of GeneratedRecoveryKeySpec.
func (o GeneratedRecoveryKeySpec) DeepCopy() GeneratedRecoveryKeySpec {
	var cp GeneratedRecoveryKeySpec = o
	if o.Key != nil {
		cp.Key = make([]byte, len(o.Key))
		copy(cp.Key, o.Key)
	}
