...
// Code generated by "deep-copy -type LogicalCPUInfoSpec -type MemoryModuleSpec -type PCIDeviceSpec -type PCIDriverRebindConfigSpec -type PCIDriverRebindStatusSpec -type PCRStatusSpec -type ProcessorSpec -type SystemInformationSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.

package hardware

// DeepCopy generates a deep copy of LogicalCPUInfoSpec.
func (o LogicalCPUInfoSpec) DeepCopy() LogicalCPUInfoSpec {
	var cp LogicalCPUInfoSpec = o
	if o.Bugs != nil {
