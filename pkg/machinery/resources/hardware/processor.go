...
// ProcessorInfo resource holds node ProcessorInfo information.
type ProcessorInfo = typed.Resource[ProcessorSpec, ProcessorRD]
...
type ProcessorSpec struct {
	...
	MaxSpeed uint32 `yaml:"maxSpeed,omitempty"`
	// Speed is in megahertz (Mhz)
	BootSpeed    uint32 `yaml:"bootSpeed,omitempty"`
...
func NewProcessorInfo(id string) *ProcessorInfo {
