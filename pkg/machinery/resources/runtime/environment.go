...
// EnvironmentID is a resource ID for Environment.
const EnvironmentID resource.ID = "environment"
...
func NewEnvironment() *Environment {
	return typed.NewResource[EnvironmentSpec, EnvironmentExtension](
		resource.NewMetadata(NamespaceName, EnvironmentType, EnvironmentID, resource.VersionUndefined),
		EnvironmentSpec{},
	)
}
