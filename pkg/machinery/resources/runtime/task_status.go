...
//go:generate go tool github.com/dmarkham/enumer -type=TaskState -linecomment -text
...
type TaskStatusSpec struct {
	...
	TaskState TaskState     `yaml:"taskState" protobuf:"2"`
	Result    string        `yaml:"result" protobuf:"3"`
	Start     time.Time     `yaml:"start" protobuf:"4"`
	Duration  time.Duration `yaml:"duration" protobuf:"5"`
	Owner     string        `yaml:"owner" protobuf:"6"`
}
