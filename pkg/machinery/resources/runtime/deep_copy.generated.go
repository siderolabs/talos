...
// DeepCopy generates a deep copy of TaskSpec.
func (o TaskSpec) DeepCopy() TaskSpec {
	var cp TaskSpec = o
	if o.Args != nil {
...
// DeepCopy generates a deep copy of TaskStatusSpec.
func (o TaskStatusSpec) DeepCopy() TaskStatusSpec {
	var cp TaskStatusSpec = o
	return cp
}
