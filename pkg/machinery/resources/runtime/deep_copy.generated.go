...
// Code generated by "deep-copy -type DevicesStatusSpec -type DiagnosticSpec -type EventSinkConfigSpec -type ExtensionServiceConfigSpec -type ExtensionServiceConfigStatusSpec -type KernelModuleSpecSpec -type KernelParamSpecSpec -type KernelParamStatusSpec -type KmsgLogConfigSpec -type MaintenanceServiceConfigSpec -type MaintenanceServiceRequestSpec -type MachineResetSignalSpec -type MachineStatusSpec -type MetaKeySpec -type MountStatusSpec -type PlatformMetadataSpec -type SecurityStateSpec -type MetaLoadedSpec -type PCIRebindConfigSpec -type PCIRebindStatusSpec -type UniqueMachineTokenSpec -type WatchdogTimerConfigSpec -type WatchdogTimerStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of PCIRebindConfigSpec.
func (o PCIRebindConfigSpec) DeepCopy() PCIRebindConfigSpec {
	var cp PCIRebindConfigSpec = o
	return cp
}

// DeepCopy generates a deep copy of PCIRebindStatusSpec.
func (o PCIRebindStatusSpec) DeepCopy() PCIRebindStatusSpec {
	var cp PCIRebindStatusSpec = o
	return cp
}
