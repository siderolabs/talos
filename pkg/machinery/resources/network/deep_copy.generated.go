...
// DeepCopy generates a deep copy of WifiSpecSpec.
func (o WifiSpecSpec) DeepCopy() WifiSpecSpec {
	var cp WifiSpecSpec = o
	if o.Networks != nil {
		cp.Networks = make([]WifiNetwork, len(o.Networks))
		copy(cp.Networks, o.Networks)
	}
	return cp
}
