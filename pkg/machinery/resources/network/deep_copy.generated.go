...
// DeepCopy generates a deep copy of BGPBFDConfigSpec.
func (o BGPBFDConfigSpec) DeepCopy() BGPBFDConfigSpec {
	var cp BGPBFDConfigSpec = o
	return cp
}

// DeepCopy generates a deep copy of BGPNeighborConfigSpec.
func (o BGPNeighborConfigSpec) DeepCopy() BGPNeighborConfigSpec {
	var cp BGPNeighborConfigSpec = o
	if o.BFD != nil {
		retV := o.BFD.DeepCopy()
		cp.BFD = &retV
	}
...
// DeepCopy generates a deep copy of BGPInstanceConfigSpec.
func (o BGPInstanceConfigSpec) DeepCopy() BGPInstanceConfigSpec {
	var cp BGPInstanceConfigSpec = o
	if o.AdvertiseLinks != nil {
		cp.AdvertiseLinks = make([]string, len(o.AdvertiseLinks))
		copy(cp.AdvertiseLinks, o.AdvertiseLinks)
	}
	if o.Neighbors != nil {
		cp.Neighbors = make([]BGPNeighborConfigSpec, len(o.Neighbors))
		copy(cp.Neighbors, o.Neighbors)
		for i2 := range o.Neighbors {
...
// DeepCopy generates a deep copy of BGPPeerStatusSpec.
func (o BGPPeerStatusSpec) DeepCopy() BGPPeerStatusSpec {
	var cp BGPPeerStatusSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of LLDPNeighborSpec.
func (o LLDPNeighborSpec) DeepCopy() LLDPNeighborSpec {
	var cp LLDPNeighborSpec = o
	if o.ManagementAddresses != nil {
		cp.ManagementAddresses = make([]string, len(o.ManagementAddresses))
		copy(cp.ManagementAddresses, o.ManagementAddresses)
	}
	if o.VLANs != nil {
		cp.VLANs = make([]LLDPVLANSpec, len(o.VLANs))
		copy(cp.VLANs, o.VLANs)
		for i2 := range o.VLANs {
			cp.VLANs[i2] = o.VLANs[i2].DeepCopy()
		}
	}
	return cp
}

// DeepCopy generates a deep copy of LLDPNeighborStatusSpec.
func (o LLDPNeighborStatusSpec) DeepCopy() LLDPNeighborStatusSpec {
	var cp LLDPNeighborStatusSpec = o
	if o.Neighbors != nil {
		cp.Neighbors = make([]LLDPNeighborSpec, len(o.Neighbors))
		copy(cp.Neighbors, o.Neighbors)
		for i2 := range o.Neighbors {
			cp.Neighbors[i2] = o.Neighbors[i2].DeepCopy()
		}
...
// DeepCopy generates a deep copy of LLDPVLANSpec.
func (o LLDPVLANSpec) DeepCopy() LLDPVLANSpec {
	var cp LLDPVLANSpec = o
	return cp
}
...
func (o RouteSpecSpec) DeepCopy() RouteSpecSpec {
	...
	if o.NextHops != nil {
		cp.NextHops = make([]RouteNextHop, len(o.NextHops))
		copy(cp.NextHops, o.NextHops)
	}
	return cp
}
...
// DeepCopy generates a deep copy of StaticHostSpec.
func (o StaticHostSpec) DeepCopy() StaticHostSpec {
	var cp StaticHostSpec = o
	if o.Addresses != nil {
