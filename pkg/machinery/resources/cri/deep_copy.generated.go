...
// Code generated by "deep-copy -type BaseRuntimeSpecConfigSpec -type CustomizationConfigSpec -type RegistriesConfigSpec -type ImageCacheConfigSpec -type SeccompProfileSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.

package cri

// DeepCopy generates a deep copy of BaseRuntimeSpecConfigSpec.
func (o BaseRuntimeSpecConfigSpec) DeepCopy() BaseRuntimeSpecConfigSpec {
	var cp BaseRuntimeSpecConfigSpec = o
	if o.Object != nil {
		cp.Object = make(map[string]any, len(o.Object))
		for k2, v2 := range o.Object {
			cp.Object[k2] = v2
		}
	}
	return cp
...
// DeepCopy generates a deep copy of CustomizationConfigSpec.
func (o CustomizationConfigSpec) DeepCopy() CustomizationConfigSpec {
	var cp CustomizationConfigSpec = o
	return cp
}
