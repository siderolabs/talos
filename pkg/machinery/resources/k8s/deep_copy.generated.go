...
// DeepCopy generates a deep copy of AuthenticationConfigSpec.
func (o AuthenticationConfigSpec) DeepCopy() AuthenticationConfigSpec {
	var cp AuthenticationConfigSpec = o
	if o.Config != nil {
		cp.Config = make(map[string]any, len(o.Config))
		for k2, v2 := range o.Config {
			cp.Config[k2] = v2
...
// DeepCopy generates a deep copy of EtcdEncryptionConfigSpec.
func (o EtcdEncryptionConfigSpec) DeepCopy() EtcdEncryptionConfigSpec {
	var cp EtcdEncryptionConfigSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of KubeletStatusSpec.
func (o KubeletStatusSpec) DeepCopy() KubeletStatusSpec {
	var cp KubeletStatusSpec = o
	return cp
}
