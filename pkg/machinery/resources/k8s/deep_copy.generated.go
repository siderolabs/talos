...
// DeepCopy generates a deep copy of LoadBalancerConfigSpec.
func (o LoadBalancerConfigSpec) DeepCopy() LoadBalancerConfigSpec {
	var cp LoadBalancerConfigSpec = o
	if o.Endpoints != nil {
		cp.Endpoints = make([]APIServerEndpoint, len(o.Endpoints))
		copy(cp.Endpoints, o.Endpoints)
	}
...
// DeepCopy generates a deep copy of LoadBalancerStatusesSpec.
func (o LoadBalancerStatusesSpec) DeepCopy() LoadBalancerStatusesSpec {
	var cp LoadBalancerStatusesSpec = o
	return cp
}
