...
//go:generate go tool github.com/siderolabs/deep-copy -type ContainerSpecSpec -type ContainerImageStatusSpec -type ContainerMountStatusSpec -type ContainerDependencyStatusSpec -type ContainerInstanceSpecSpec -type ContainerInstanceStatusSpec -type ContainerLifecycleSpec -type ContainerStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go .
