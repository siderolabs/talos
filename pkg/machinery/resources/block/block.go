...
//go:generate go tool github.com/dmarkham/enumer -type=VolumeType,VolumePhase,FilesystemType,EncryptionKeyType,EncryptionProviderType,NFSVersionType,NFSProtocolType,FSParameterType -linecomment -text
