// Code generated by "enumer -type=VolumeType,VolumePhase,FilesystemType,EncryptionKeyType,EncryptionProviderType,NFSVersionType,NFSProtocolType,FSParameterType -linecomment -text"; DO NOT EDIT.
...
const _FilesystemTypeName = "nonexfsvfatext4iso9660swapinfsvirtiofs"

var _FilesystemTypeIndex = [...]uint8{0, 4, 7, 11, 15, 22, 27, 30, 38}

const _FilesystemTypeLowerName = "nonexfsvfatext4iso9660swapinfsvirtiofs"
...
func _FilesystemTypeNoOp() {
	...
	_ = x[FilesystemTypeNFS-(6)]
	_ = x[FilesystemTypeVirtiofs-(7)]
}

var _FilesystemTypeValues = []FilesystemType{FilesystemTypeNone, FilesystemTypeXFS, FilesystemTypeVFAT, FilesystemTypeEXT4, FilesystemTypeISO9660, FilesystemTypeSwap, FilesystemTypeNFS, FilesystemTypeVirtiofs}
...
var _FilesystemTypeNameToValueMap = map[string]FilesystemType{
	...
	_FilesystemTypeName[27:30]:      FilesystemTypeNFS,
	_FilesystemTypeLowerName[27:30]: FilesystemTypeNFS,
	_FilesystemTypeName[30:38]:      FilesystemTypeVirtiofs,
	_FilesystemTypeLowerName[30:38]: FilesystemTypeVirtiofs,
}
...
var _FilesystemTypeNames = []string{
	...
	_FilesystemTypeName[27:30],
	_FilesystemTypeName[30:38],
}
...
const _NFSVersionTypeName = "4.24.14.032"

var _NFSVersionTypeIndex = [...]uint8{0, 3, 6, 9, 10, 11}

const _NFSVersionTypeLowerName = "4.24.14.032"

func (i NFSVersionType) String() string {
	if i < 0 || i >= NFSVersionType(len(_NFSVersionTypeIndex)-1) {
		return fmt.Sprintf("NFSVersionType(%d)", i)
	}
	return _NFSVersionTypeName[_NFSVersionTypeIndex[i]:_NFSVersionTypeIndex[i+1]]
}

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the stringer command to generate them again.
func _NFSVersionTypeNoOp() {
	var x [1]struct{}
	_ = x[NFSVersionType4_2-(0)]
	_ = x[NFSVersionType4_1-(1)]
	_ = x[NFSVersionType4-(2)]
	_ = x[NFSVersionType3-(3)]
	_ = x[NFSVersionType2-(4)]
}

var _NFSVersionTypeValues = []NFSVersionType{NFSVersionType4_2, NFSVersionType4_1, NFSVersionType4, NFSVersionType3, NFSVersionType2}

var _NFSVersionTypeNameToValueMap = map[string]NFSVersionType{
	_NFSVersionTypeName[0:3]:        NFSVersionType4_2,
	_NFSVersionTypeLowerName[0:3]:   NFSVersionType4_2,
	_NFSVersionTypeName[3:6]:        NFSVersionType4_1,
	_NFSVersionTypeLowerName[3:6]:   NFSVersionType4_1,
	_NFSVersionTypeName[6:9]:        NFSVersionType4,
	_NFSVersionTypeLowerName[6:9]:   NFSVersionType4,
	_NFSVersionTypeName[9:10]:       NFSVersionType3,
	_NFSVersionTypeLowerName[9:10]:  NFSVersionType3,
	_NFSVersionTypeName[10:11]:      NFSVersionType2,
	_NFSVersionTypeLowerName[10:11]: NFSVersionType2,
}

var _NFSVersionTypeNames = []string{
	_NFSVersionTypeName[0:3],
	_NFSVersionTypeName[3:6],
	_NFSVersionTypeName[6:9],
	_NFSVersionTypeName[9:10],
	_NFSVersionTypeName[10:11],
}

// NFSVersionTypeString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func NFSVersionTypeString(s string) (NFSVersionType, error) {
	if val, ok := _NFSVersionTypeNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _NFSVersionTypeNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to NFSVersionType values", s)
}

// NFSVersionTypeValues returns all values of the enum
func NFSVersionTypeValues() []NFSVersionType {
	return _NFSVersionTypeValues
}

// NFSVersionTypeStrings returns a slice of all String values of the enum
func NFSVersionTypeStrings() []string {
	strs := make([]string, len(_NFSVersionTypeNames))
	copy(strs, _NFSVersionTypeNames)
	return strs
}

// IsANFSVersionType returns "true" if the value is listed in the enum definition. "false" otherwise
func (i NFSVersionType) IsANFSVersionType() bool {
	for _, v := range _NFSVersionTypeValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for NFSVersionType
func (i NFSVersionType) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for NFSVersionType
func (i *NFSVersionType) UnmarshalText(text []byte) error {
	var err error
	*i, err = NFSVersionTypeString(string(text))
	return err
}

const _NFSProtocolTypeName = "tcptcp6udpudp6rdmardma6"

var _NFSProtocolTypeIndex = [...]uint8{0, 3, 7, 10, 14, 18, 23}

const _NFSProtocolTypeLowerName = "tcptcp6udpudp6rdmardma6"

func (i NFSProtocolType) String() string {
	if i < 0 || i >= NFSProtocolType(len(_NFSProtocolTypeIndex)-1) {
		return fmt.Sprintf("NFSProtocolType(%d)", i)
	}
	return _NFSProtocolTypeName[_NFSProtocolTypeIndex[i]:_NFSProtocolTypeIndex[i+1]]
}

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the stringer command to generate them again.
func _NFSProtocolTypeNoOp() {
	var x [1]struct{}
	_ = x[NFSProtocolTypeTCP-(0)]
	_ = x[NFSProtocolTypeTCP6-(1)]
	_ = x[NFSProtocolTypeUDP-(2)]
	_ = x[NFSProtocolTypeUDP6-(3)]
	_ = x[NFSProtocolTypeRDMA-(4)]
	_ = x[NFSProtocolTypeRDMA6-(5)]
}

var _NFSProtocolTypeValues = []NFSProtocolType{NFSProtocolTypeTCP, NFSProtocolTypeTCP6, NFSProtocolTypeUDP, NFSProtocolTypeUDP6, NFSProtocolTypeRDMA, NFSProtocolTypeRDMA6}

var _NFSProtocolTypeNameToValueMap = map[string]NFSProtocolType{
	_NFSProtocolTypeName[0:3]:        NFSProtocolTypeTCP,
	_NFSProtocolTypeLowerName[0:3]:   NFSProtocolTypeTCP,
	_NFSProtocolTypeName[3:7]:        NFSProtocolTypeTCP6,
	_NFSProtocolTypeLowerName[3:7]:   NFSProtocolTypeTCP6,
	_NFSProtocolTypeName[7:10]:       NFSProtocolTypeUDP,
	_NFSProtocolTypeLowerName[7:10]:  NFSProtocolTypeUDP,
	_NFSProtocolTypeName[10:14]:      NFSProtocolTypeUDP6,
	_NFSProtocolTypeLowerName[10:14]: NFSProtocolTypeUDP6,
	_NFSProtocolTypeName[14:18]:      NFSProtocolTypeRDMA,
	_NFSProtocolTypeLowerName[14:18]: NFSProtocolTypeRDMA,
	_NFSProtocolTypeName[18:23]:      NFSProtocolTypeRDMA6,
	_NFSProtocolTypeLowerName[18:23]: NFSProtocolTypeRDMA6,
}

var _NFSProtocolTypeNames = []string{
	_NFSProtocolTypeName[0:3],
	_NFSProtocolTypeName[3:7],
	_NFSProtocolTypeName[7:10],
	_NFSProtocolTypeName[10:14],
	_NFSProtocolTypeName[14:18],
	_NFSProtocolTypeName[18:23],
}

// NFSProtocolTypeString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func NFSProtocolTypeString(s string) (NFSProtocolType, error) {
	if val, ok := _NFSProtocolTypeNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _NFSProtocolTypeNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to NFSProtocolType values", s)
}

// NFSProtocolTypeValues returns all values of the enum
func NFSProtocolTypeValues() []NFSProtocolType {
	return _NFSProtocolTypeValues
}

// NFSProtocolTypeStrings returns a slice of all String values of the enum
func NFSProtocolTypeStrings() []string {
	strs := make([]string, len(_NFSProtocolTypeNames))
	copy(strs, _NFSProtocolTypeNames)
	return strs
}

// IsANFSProtocolType returns "true" if the value is listed in the enum definition. "false" otherwise
func (i NFSProtocolType) IsANFSProtocolType() bool {
	for _, v := range _NFSProtocolTypeValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for NFSProtocolType
func (i NFSProtocolType) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for NFSProtocolType
func (i *NFSProtocolType) UnmarshalText(text []byte) error {
	var err error
	*i, err = NFSProtocolTypeString(string(text))
	return err
}
