// Code generated by "enumer -type=VolumeType,VolumePhase,FilesystemType,EncryptionKeyType,EncryptionProviderType,FSParameterType,DiskHealthSource,DiskHealthStatusValue -linecomment -text"; DO NOT EDIT.
...
const _DiskHealthSourceName = "unknownnvmeataunsupported"

var _DiskHealthSourceIndex = [...]uint8{0, 7, 11, 14, 25}

const _DiskHealthSourceLowerName = "unknownnvmeataunsupported"

func (i DiskHealthSource) String() string {
	if i < 0 || i >= DiskHealthSource(len(_DiskHealthSourceIndex)-1) {
		return fmt.Sprintf("DiskHealthSource(%d)", i)
	}
	return _DiskHealthSourceName[_DiskHealthSourceIndex[i]:_DiskHealthSourceIndex[i+1]]
}
...
var _DiskHealthSourceNameToValueMap = map[string]DiskHealthSource{
	...
	_DiskHealthSourceLowerName[14:25]: DiskHealthSourceUnsupported,
}

var _DiskHealthSourceNames = []string{
	_DiskHealthSourceName[0:7],
	_DiskHealthSourceName[7:11],
	_DiskHealthSourceName[11:14],
	_DiskHealthSourceName[14:25],
}

// DiskHealthSourceString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func DiskHealthSourceString(s string) (DiskHealthSource, error) {
	if val, ok := _DiskHealthSourceNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _DiskHealthSourceNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to DiskHealthSource values", s)
}

// DiskHealthSourceValues returns all values of the enum
func DiskHealthSourceValues() []DiskHealthSource {
	return _DiskHealthSourceValues
}

// DiskHealthSourceStrings returns a slice of all String values of the enum
func DiskHealthSourceStrings() []string {
	strs := make([]string, len(_DiskHealthSourceNames))
	copy(strs, _DiskHealthSourceNames)
	return strs
}

// IsADiskHealthSource returns "true" if the value is listed in the enum definition. "false" otherwise
func (i DiskHealthSource) IsADiskHealthSource() bool {
	for _, v := range _DiskHealthSourceValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for DiskHealthSource
func (i DiskHealthSource) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for DiskHealthSource
func (i *DiskHealthSource) UnmarshalText(text []byte) error {
	var err error
	*i, err = DiskHealthSourceString(string(text))
	return err
}

const _DiskHealthStatusValueName = "unknownhealthywarningcritical"

var _DiskHealthStatusValueIndex = [...]uint8{0, 7, 14, 21, 29}

const _DiskHealthStatusValueLowerName = "unknownhealthywarningcritical"

func (i DiskHealthStatusValue) String() string {
	if i < 0 || i >= DiskHealthStatusValue(len(_DiskHealthStatusValueIndex)-1) {
		return fmt.Sprintf("DiskHealthStatusValue(%d)", i)
	}
	return _DiskHealthStatusValueName[_DiskHealthStatusValueIndex[i]:_DiskHealthStatusValueIndex[i+1]]
}

// An "invalid array index" compiler error signifies that the constant values have changed.
// Re-run the stringer command to generate them again.
func _DiskHealthStatusValueNoOp() {
	var x [1]struct{}
	_ = x[DiskHealthStatusValueUnknown-(0)]
	_ = x[DiskHealthStatusValueHealthy-(1)]
	_ = x[DiskHealthStatusValueWarning-(2)]
	_ = x[DiskHealthStatusValueCritical-(3)]
}

var _DiskHealthStatusValueValues = []DiskHealthStatusValue{DiskHealthStatusValueUnknown, DiskHealthStatusValueHealthy, DiskHealthStatusValueWarning, DiskHealthStatusValueCritical}

var _DiskHealthStatusValueNameToValueMap = map[string]DiskHealthStatusValue{
	_DiskHealthStatusValueName[0:7]:        DiskHealthStatusValueUnknown,
	_DiskHealthStatusValueLowerName[0:7]:   DiskHealthStatusValueUnknown,
	_DiskHealthStatusValueName[7:14]:       DiskHealthStatusValueHealthy,
	_DiskHealthStatusValueLowerName[7:14]:  DiskHealthStatusValueHealthy,
	_DiskHealthStatusValueName[14:21]:      DiskHealthStatusValueWarning,
	_DiskHealthStatusValueLowerName[14:21]: DiskHealthStatusValueWarning,
	_DiskHealthStatusValueName[21:29]:      DiskHealthStatusValueCritical,
	_DiskHealthStatusValueLowerName[21:29]: DiskHealthStatusValueCritical,
}

var _DiskHealthStatusValueNames = []string{
	_DiskHealthStatusValueName[0:7],
	_DiskHealthStatusValueName[7:14],
	_DiskHealthStatusValueName[14:21],
	_DiskHealthStatusValueName[21:29],
}

// DiskHealthStatusValueString retrieves an enum value from the enum constants string name.
// Throws an error if the param is not part of the enum.
func DiskHealthStatusValueString(s string) (DiskHealthStatusValue, error) {
	if val, ok := _DiskHealthStatusValueNameToValueMap[s]; ok {
		return val, nil
	}

	if val, ok := _DiskHealthStatusValueNameToValueMap[strings.ToLower(s)]; ok {
		return val, nil
	}
	return 0, fmt.Errorf("%s does not belong to DiskHealthStatusValue values", s)
}

// DiskHealthStatusValueValues returns all values of the enum
func DiskHealthStatusValueValues() []DiskHealthStatusValue {
	return _DiskHealthStatusValueValues
}

// DiskHealthStatusValueStrings returns a slice of all String values of the enum
func DiskHealthStatusValueStrings() []string {
	strs := make([]string, len(_DiskHealthStatusValueNames))
	copy(strs, _DiskHealthStatusValueNames)
	return strs
}

// IsADiskHealthStatusValue returns "true" if the value is listed in the enum definition. "false" otherwise
func (i DiskHealthStatusValue) IsADiskHealthStatusValue() bool {
	for _, v := range _DiskHealthStatusValueValues {
		if i == v {
			return true
		}
	}
...
// MarshalText implements the encoding.TextMarshaler interface for DiskHealthStatusValue
func (i DiskHealthStatusValue) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for DiskHealthStatusValue
func (i *DiskHealthStatusValue) UnmarshalText(text []byte) error {
	var err error
	*i, err = DiskHealthStatusValueString(string(text))
	return err
}
