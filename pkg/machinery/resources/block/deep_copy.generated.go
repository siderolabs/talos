...
// Code generated by "deep-copy -type DeviceSpec -type DiscoveredVolumeSpec -type DiscoveryRefreshRequestSpec -type DiscoveryRefreshStatusSpec -type DiskSpec -type LVMLogicalVolumeSpec -type MountRequestSpec -type MountStatusSpec -type ParameterSpec -type LVMPhysicalVolumeSpec -type SwapStatusSpec -type SymlinkSpec -type SystemDiskSpec -type UserDiskConfigStatusSpec -type VolumeConfigSpec -type LVMVolumeGroupSpec -type VolumeLifecycleSpec -type VolumeMountRequestSpec -type VolumeMountStatusSpec -type VolumeStatusSpec -type ZswapStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of LVMLogicalVolumeSpec.
func (o LVMLogicalVolumeSpec) DeepCopy() LVMLogicalVolumeSpec {
	var cp LVMLogicalVolumeSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of LVMPhysicalVolumeSpec.
func (o LVMPhysicalVolumeSpec) DeepCopy() LVMPhysicalVolumeSpec {
	var cp LVMPhysicalVolumeSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of LVMVolumeGroupSpec.
func (o LVMVolumeGroupSpec) DeepCopy() LVMVolumeGroupSpec {
	var cp LVMVolumeGroupSpec = o
