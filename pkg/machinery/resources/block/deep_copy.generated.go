...
// Code generated by "deep-copy -type DeviceSpec -type DiscoveredVolumeSpec -type DiscoveredVolumesStatusSpec -type DiscoveryRefreshRequestSpec -type DiscoveryRefreshStatusSpec -type DiskSpec -type FSScrubScheduleSpec -type FSScrubStatusSpec -type MountRequestSpec -type MountStatusSpec -type ParameterSpec -type SMARTStatusSpec -type SwapStatusSpec -type SymlinkSpec -type SystemDiskSpec -type UserDiskConfigStatusSpec -type VolumeConfigSpec -type VolumeLifecycleSpec -type VolumeMountRequestSpec -type VolumeMountStatusSpec -type VolumeStatusSpec -type VolumeTrimScheduleSpec -type ZswapStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of DiscoveredVolumesStatusSpec.
func (o DiscoveredVolumesStatusSpec) DeepCopy() DiscoveredVolumesStatusSpec {
	var cp DiscoveredVolumesStatusSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of FSScrubScheduleSpec.
func (o FSScrubScheduleSpec) DeepCopy() FSScrubScheduleSpec {
	var cp FSScrubScheduleSpec = o
	return cp
}

// DeepCopy generates a deep copy of FSScrubStatusSpec.
func (o FSScrubStatusSpec) DeepCopy() FSScrubStatusSpec {
	var cp FSScrubStatusSpec = o
	return cp
}
...
// DeepCopy generates a deep copy of SMARTStatusSpec.
func (o SMARTStatusSpec) DeepCopy() SMARTStatusSpec {
	var cp SMARTStatusSpec = o
	if o.Attributes != nil {
		cp.Attributes = make([]SMARTAttribute, len(o.Attributes))
...
// DeepCopy generates a deep copy of VolumeTrimScheduleSpec.
func (o VolumeTrimScheduleSpec) DeepCopy() VolumeTrimScheduleSpec {
	var cp VolumeTrimScheduleSpec = o
	return cp
}
