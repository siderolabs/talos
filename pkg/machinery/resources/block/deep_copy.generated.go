...
// Code generated by "deep-copy -type DeviceSpec -type DiscoveredVolumeSpec -type DiscoveredVolumesStatusSpec -type DiscoveryRefreshRequestSpec -type DiscoveryRefreshStatusSpec -type DiskSpec -type FSScrubScheduleSpec -type FSScrubStatusSpec -type MountRequestSpec -type MountStatusSpec -type ParameterSpec -type SwapStatusSpec -type SymlinkSpec -type SystemDiskSpec -type UserDiskConfigStatusSpec -type VolumeConfigSpec -type VolumeLifecycleSpec -type VolumeMountRequestSpec -type VolumeMountStatusSpec -type VolumeStatusSpec -type VolumeTrimScheduleSpec -type VolumeWipeStatusSpec -type ZswapStatusSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of VolumeWipeStatusSpec.
func (o VolumeWipeStatusSpec) DeepCopy() VolumeWipeStatusSpec {
	var cp VolumeWipeStatusSpec = o
	return cp
}
