...
var file_machine_machine_proto_rawDesc = []byte{
	...
	0x65, 0x4d, 0x73, 0x32, 0x8a, 0x0f, 0x0a, 0x0e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x42, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x73, 0x74,
	...
	0x01, 0x12, 0x3d, 0x0a, 0x08, 0x48, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x2e,
	...
	0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x07, 0x4c, 0x6f, 0x61,
	...
	0x6f, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x0b,
	...
	0x42, 0x4b, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x2e,
	0x61, 0x70, 0x69, 0x42, 0x0a, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x41, 0x70, 0x69, 0x50,
	0x01, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x61,
	0x6c, 0x6f, 0x73, 0x2d, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x2f, 0x74, 0x61, 0x6c, 0x6f,
	0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x62, 0x06, 0x70,
...
var (
	...
	file_machine_machine_proto_msgTypes  = make([]protoimpl.MessageInfo, 92)
	file_machine_machine_proto_goTypes   = []interface{}{
		...
		(*HostnameResponse)(nil),           // 80: machine.HostnameResponse
		(*Hostname)(nil),                   // 81: machine.Hostname
		(*LoadAvgResponse)(nil),            // 82: machine.LoadAvgResponse
		(*LoadAvg)(nil),                    // 83: machine.LoadAvg
		(*SystemStatResponse)(nil),         // 84: machine.SystemStatResponse
		(*SystemStat)(nil),                 // 85: machine.SystemStat
		(*CPUStat)(nil),                    // 86: machine.CPUStat
		(*SoftIRQStat)(nil),                // 87: machine.SoftIRQStat
		(*CPUInfoResponse)(nil),            // 88: machine.CPUInfoResponse
		(*CPUsInfo)(nil),                   // 89: machine.CPUsInfo
		(*CPUInfo)(nil),                    // 90: machine.CPUInfo
		(*NetworkDeviceStatsResponse)(nil), // 91: machine.NetworkDeviceStatsResponse
		(*NetworkDeviceStats)(nil),         // 92: machine.NetworkDeviceStats
		(*NetDev)(nil),                     // 93: machine.NetDev
		(*DiskStatsResponse)(nil),          // 94: machine.DiskStatsResponse
		(*DiskStats)(nil),                  // 95: machine.DiskStats
		(*DiskStat)(nil),                   // 96: machine.DiskStat
		(*common.Metadata)(nil),            // 97: common.Metadata
		(*common.Error)(nil),               // 98: common.Error
		(*any.Any)(nil),                    // 99: google.protobuf.Any
		(*timestamp.Timestamp)(nil),        // 100: google.protobuf.Timestamp
		(common.ContainerDriver)(0),        // 101: common.ContainerDriver
		(*empty.Empty)(nil),                // 102: google.protobuf.Empty
		(*common.Data)(nil),                // 103: common.Data
	}
)

var file_machine_machine_proto_depIdxs = []int32{
	97,  // 0: machine.Reboot.metadata:type_name -> common.Metadata
	5,   // 1: machine.RebootResponse.messages:type_name -> machine.Reboot
	97,  // 2: machine.Bootstrap.metadata:type_name -> common.Metadata
	...
	98,  // 5: machine.SequenceEvent.error:type_name -> common.Error
	...
	97,  // 9: machine.Event.metadata:type_name -> common.Metadata
	99,  // 10: machine.Event.data:type_name -> google.protobuf.Any
	97,  // 11: machine.Reset.metadata:type_name -> common.Metadata
	...
	97,  // 14: machine.Recover.metadata:type_name -> common.Metadata
	20,  // 15: machine.RecoverResponse.messages:type_name -> machine.Recover
	97,  // 16: machine.Shutdown.metadata:type_name -> common.Metadata
	22,  // 17: machine.ShutdownResponse.messages:type_name -> machine.Shutdown
	97,  // 18: machine.Upgrade.metadata:type_name -> common.Metadata
	25,  // 19: machine.UpgradeResponse.messages:type_name -> machine.Upgrade
	97,  // 20: machine.ServiceList.metadata:type_name -> common.Metadata
	...
	100, // 26: machine.ServiceEvent.ts:type_name -> google.protobuf.Timestamp
	100, // 27: machine.ServiceHealth.last_change:type_name -> google.protobuf.Timestamp
	97,  // 28: machine.ServiceStart.metadata:type_name -> common.Metadata
	34,  // 29: machine.ServiceStartResponse.messages:type_name -> machine.ServiceStart
	97,  // 30: machine.ServiceStop.metadata:type_name -> common.Metadata
	37,  // 31: machine.ServiceStopResponse.messages:type_name -> machine.ServiceStop
	97,  // 32: machine.ServiceRestart.metadata:type_name -> common.Metadata
	40,  // 33: machine.ServiceRestartResponse.messages:type_name -> machine.ServiceRestart
	97,  // 34: machine.FileInfo.metadata:type_name -> common.Metadata
	97,  // 35: machine.Mounts.metadata:type_name -> common.Metadata
	51,  // 36: machine.Mounts.stats:type_name -> machine.MountStat
	49,  // 37: machine.MountsResponse.messages:type_name -> machine.Mounts
	97,  // 38: machine.Version.metadata:type_name -> common.Metadata
	...
	101, // 42: machine.LogsRequest.driver:type_name -> common.ContainerDriver
	97,  // 43: machine.Rollback.metadata:type_name -> common.Metadata
	59,  // 44: machine.RollbackResponse.messages:type_name -> machine.Rollback
	101, // 45: machine.ContainersRequest.driver:type_name -> common.ContainerDriver
	97,  // 46: machine.Container.metadata:type_name -> common.Metadata
	...
	97,  // 50: machine.Process.metadata:type_name -> common.Metadata
	69,  // 51: machine.Process.processes:type_name -> machine.ProcessInfo
	101, // 52: machine.RestartRequest.driver:type_name -> common.ContainerDriver
	97,  // 53: machine.Restart.metadata:type_name -> common.Metadata
	71,  // 54: machine.RestartResponse.messages:type_name -> machine.Restart
	101, // 55: machine.StatsRequest.driver:type_name -> common.ContainerDriver
	97,  // 56: machine.Stats.metadata:type_name -> common.Metadata
	76,  // 57: machine.Stats.stats:type_name -> machine.Stat
	74,  // 58: machine.StatsResponse.messages:type_name -> machine.Stats
	97,  // 59: machine.Memory.metadata:type_name -> common.Metadata
	79,  // 60: machine.Memory.meminfo:type_name -> machine.MemInfo
	77,  // 61: machine.MemoryResponse.messages:type_name -> machine.Memory
	81,  // 62: machine.HostnameResponse.messages:type_name -> machine.Hostname
	97,  // 63: machine.Hostname.metadata:type_name -> common.Metadata
	83,  // 64: machine.LoadAvgResponse.messages:type_name -> machine.LoadAvg
	97,  // 65: machine.LoadAvg.metadata:type_name -> common.Metadata
	85,  // 66: machine.SystemStatResponse.messages:type_name -> machine.SystemStat
	97,  // 67: machine.SystemStat.metadata:type_name -> common.Metadata
	86,  // 68: machine.SystemStat.cpu_total:type_name -> machine.CPUStat
	86,  // 69: machine.SystemStat.cpu:type_name -> machine.CPUStat
	87,  // 70: machine.SystemStat.soft_irq:type_name -> machine.SoftIRQStat
	89,  // 71: machine.CPUInfoResponse.messages:type_name -> machine.CPUsInfo
	97,  // 72: machine.CPUsInfo.metadata:type_name -> common.Metadata
	90,  // 73: machine.CPUsInfo.cpu_info:type_name -> machine.CPUInfo
	92,  // 74: machine.NetworkDeviceStatsResponse.messages:type_name -> machine.NetworkDeviceStats
	97,  // 75: machine.NetworkDeviceStats.metadata:type_name -> common.Metadata
	93,  // 76: machine.NetworkDeviceStats.total:type_name -> machine.NetDev
	93,  // 77: machine.NetworkDeviceStats.devices:type_name -> machine.NetDev
	95,  // 78: machine.DiskStatsResponse.messages:type_name -> machine.DiskStats
	97,  // 79: machine.DiskStats.metadata:type_name -> common.Metadata
	96,  // 80: machine.DiskStats.total:type_name -> machine.DiskStat
	96,  // 81: machine.DiskStats.devices:type_name -> machine.DiskStat
	7,   // 82: machine.MachineService.Bootstrap:input_type -> machine.BootstrapRequest
	61,  // 83: machine.MachineService.Containers:input_type -> machine.ContainersRequest
	46,  // 84: machine.MachineService.Copy:input_type -> machine.CopyRequest
	102, // 85: machine.MachineService.CPUInfo:input_type -> google.protobuf.Empty
	102, // 86: machine.MachineService.DiskStats:input_type -> google.protobuf.Empty
	65,  // 87: machine.MachineService.Dmesg:input_type -> machine.DmesgRequest
	14,  // 88: machine.MachineService.Events:input_type -> machine.EventsRequest
	102, // 89: machine.MachineService.Hostname:input_type -> google.protobuf.Empty
	102, // 90: machine.MachineService.Kubeconfig:input_type -> google.protobuf.Empty
	47,  // 91: machine.MachineService.List:input_type -> machine.ListRequest
	102, // 92: machine.MachineService.LoadAvg:input_type -> google.protobuf.Empty
	56,  // 93: machine.MachineService.Logs:input_type -> machine.LogsRequest
	102, // 94: machine.MachineService.Memory:input_type -> google.protobuf.Empty
	102, // 95: machine.MachineService.Mounts:input_type -> google.protobuf.Empty
	102, // 96: machine.MachineService.NetworkDeviceStats:input_type -> google.protobuf.Empty
	102, // 97: machine.MachineService.Processes:input_type -> google.protobuf.Empty
	57,  // 98: machine.MachineService.Read:input_type -> machine.ReadRequest
	102, // 99: machine.MachineService.Reboot:input_type -> google.protobuf.Empty
	70,  // 100: machine.MachineService.Restart:input_type -> machine.RestartRequest
	58,  // 101: machine.MachineService.Rollback:input_type -> machine.RollbackRequest
	16,  // 102: machine.MachineService.Reset:input_type -> machine.ResetRequest
	19,  // 103: machine.MachineService.Recover:input_type -> machine.RecoverRequest
	102, // 104: machine.MachineService.ServiceList:input_type -> google.protobuf.Empty
	39,  // 105: machine.MachineService.ServiceRestart:input_type -> machine.ServiceRestartRequest
	33,  // 106: machine.MachineService.ServiceStart:input_type -> machine.ServiceStartRequest
	36,  // 107: machine.MachineService.ServiceStop:input_type -> machine.ServiceStopRequest
	102, // 108: machine.MachineService.Shutdown:input_type -> google.protobuf.Empty
	73,  // 109: machine.MachineService.Stats:input_type -> machine.StatsRequest
	102, // 110: machine.MachineService.SystemStat:input_type -> google.protobuf.Empty
	24,  // 111: machine.MachineService.Upgrade:input_type -> machine.UpgradeRequest
	102, // 112: machine.MachineService.Version:input_type -> google.protobuf.Empty
	9,   // 113: machine.MachineService.Bootstrap:output_type -> machine.BootstrapResponse
	64,  // 114: machine.MachineService.Containers:output_type -> machine.ContainersResponse
	103, // 115: machine.MachineService.Copy:output_type -> common.Data
	88,  // 116: machine.MachineService.CPUInfo:output_type -> machine.CPUInfoResponse
	94,  // 117: machine.MachineService.DiskStats:output_type -> machine.DiskStatsResponse
	103, // 118: machine.MachineService.Dmesg:output_type -> common.Data
	15,  // 119: machine.MachineService.Events:output_type -> machine.Event
	80,  // 120: machine.MachineService.Hostname:output_type -> machine.HostnameResponse
	103, // 121: machine.MachineService.Kubeconfig:output_type -> common.Data
	48,  // 122: machine.MachineService.List:output_type -> machine.FileInfo
	82,  // 123: machine.MachineService.LoadAvg:output_type -> machine.LoadAvgResponse
	103, // 124: machine.MachineService.Logs:output_type -> common.Data
	78,  // 125: machine.MachineService.Memory:output_type -> machine.MemoryResponse
	50,  // 126: machine.MachineService.Mounts:output_type -> machine.MountsResponse
	91,  // 127: machine.MachineService.NetworkDeviceStats:output_type -> machine.NetworkDeviceStatsResponse
	67,  // 128: machine.MachineService.Processes:output_type -> machine.ProcessesResponse
	103, // 129: machine.MachineService.Read:output_type -> common.Data
	6,   // 130: machine.MachineService.Reboot:output_type -> machine.RebootResponse
	72,  // 131: machine.MachineService.Restart:output_type -> machine.RestartResponse
	60,  // 132: machine.MachineService.Rollback:output_type -> machine.RollbackResponse
	18,  // 133: machine.MachineService.Reset:output_type -> machine.ResetResponse
	21,  // 134: machine.MachineService.Recover:output_type -> machine.RecoverResponse
	28,  // 135: machine.MachineService.ServiceList:output_type -> machine.ServiceListResponse
	41,  // 136: machine.MachineService.ServiceRestart:output_type -> machine.ServiceRestartResponse
	35,  // 137: machine.MachineService.ServiceStart:output_type -> machine.ServiceStartResponse
	38,  // 138: machine.MachineService.ServiceStop:output_type -> machine.ServiceStopResponse
	23,  // 139: machine.MachineService.Shutdown:output_type -> machine.ShutdownResponse
	75,  // 140: machine.MachineService.Stats:output_type -> machine.StatsResponse
	84,  // 141: machine.MachineService.SystemStat:output_type -> machine.SystemStatResponse
	26,  // 142: machine.MachineService.Upgrade:output_type -> machine.UpgradeResponse
	53,  // 143: machine.MachineService.Version:output_type -> machine.VersionResponse
