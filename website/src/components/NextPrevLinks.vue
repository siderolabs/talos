  ...
  <div>
    <div class="flex flex-row justify-between items-center">
      ...
      <g-link
        v-if="next"
        :to="next.path"
        class="mb-4 sm:mb-0 flex items-center ml-auto text-ui-primary font-bold px-4 py-2 border border-ui-border rounded-lg hover:bg-ui-primary hover:text-white transition-colors"
      >
        {{ next.title }}
