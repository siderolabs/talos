...
kubelet:
    image: ghcr.io/siderolabs/kubelet:v1.29.0-alpha.3 # The `image` field is an optional reference to an alternative kubelet image.
...
image: ghcr.io/siderolabs/kubelet:v1.29.0-alpha.3
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-apiserver:v1.29.0-alpha.3
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-controller-manager:v1.29.0-alpha.3
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-proxy:v1.29.0-alpha.3
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-scheduler:v1.29.0-alpha.3
{{< /highlight >}}</details> | |
