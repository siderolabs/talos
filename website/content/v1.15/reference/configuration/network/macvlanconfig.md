---
description: MacVLANConfig is a config document to create a MACVLAN link over a parent
    link.
title: MacVLANConfig
---
...
apiVersion: v1alpha1
kind: MacVLANConfig
name: eth0.macvlan # Name of the macvlan link (interface) to be created.
mode: bridge # MACVLAN mode to use for the link.
parent: eth0 # Name of the parent link (interface) the macvlan link is created on.
...
|-------|------|-------------|----------|
|`name` |string |Name of the macvlan link (interface) to be created. <details><summary>Show example(s)</summary>{{< highlight yaml >}}
name: eth0.macvlan
{{< /highlight >}}</details> | |
|`mode` |MacvlanMode |MACVLAN mode to use for the link.<br>If not set, defaults to bridge.<br><br>The `source` mode requires a list of source MAC addresses, which is<br>not supported yet, so it can't be used. <details><summary>Show example(s)</summary>{{< highlight yaml >}}
mode: bridge
{{< /highlight >}}</details> |`private`<br />`vepa`<br />`bridge`<br />`passthru`<br />`source`<br /> |
|`parent` |string |Name of the parent link (interface) the macvlan link is created on.<br>Link aliases can be used here as well. <details><summary>Show example(s)</summary>{{< highlight yaml >}}
parent: eth0
{{< /highlight >}}</details> | |
...
|`addresses` |<a href="#MacVLANConfig.addresses.">[]AddressConfig</a> |Configure addresses to be statically assigned to the link.  | |
|`routes` |<a href="#MacVLANConfig.routes.">[]RouteConfig</a> |Configure routes to be statically created via the link.  | |
|`multicast` |bool |Set the multicast capability of the link.  | |




## addresses[] {#MacVLANConfig.addresses.}
