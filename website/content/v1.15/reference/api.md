...
| dev_type | [string](#string) |  | DevType is the SMART device type: "nvme", "sata" or "scsi". |
...
| health | [talos.resource.definitions.enums.ContainersContainerHealth](#talos.resource.definitions.enums.ContainersContainerHealth) |  | Health is the coarse user-facing status. |
