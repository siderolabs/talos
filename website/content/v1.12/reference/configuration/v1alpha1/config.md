...
image: ghcr.io/siderolabs/kubelet:v1.35.0-alpha.2
{{< /highlight >}}</details> | |
...
apiServer:
    image: registry.k8s.io/kube-apiserver:v1.35.0-alpha.2 # The container image used in the API server manifest.
...
controllerManager:
    image: registry.k8s.io/kube-controller-manager:v1.35.0-alpha.2 # The container image used in the controller manager manifest.
...
proxy:
    image: registry.k8s.io/kube-proxy:v1.35.0-alpha.2 # The container image used in the kube-proxy manifest.
...
scheduler:
    image: registry.k8s.io/kube-scheduler:v1.35.0-alpha.2 # The container image used in the scheduler manifest.
...
coreDNS:
    image: registry.k8s.io/coredns/coredns:v1.13.0 # The `image` field is an override to the default coredns image.
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-apiserver:v1.35.0-alpha.2
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-controller-manager:v1.35.0-alpha.2
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-proxy:v1.35.0-alpha.2
{{< /highlight >}}</details> | |
...
image: registry.k8s.io/kube-scheduler:v1.35.0-alpha.2
{{< /highlight >}}</details> | |
