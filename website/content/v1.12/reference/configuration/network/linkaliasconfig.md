...
selector:
    match: glob(mac(link.permanent_addr), "00:1a:2b:*") # The Common Expression Language (CEL) expression to match the link.
{{< /highlight >}}
...
match: glob(mac(link.permanent_addr), "00:1a:2b:*")
