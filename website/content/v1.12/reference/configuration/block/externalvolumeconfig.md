...
mount:
    ...
    # NFS mount options.
    nfs:
        vers: "4.2" # NFS version to use.
        proto: tcp # NFS protocol to use.
        acl: true # Enable or disable ACL for NFS.
{{< /highlight >}}
...
| Field | Type | Description | Value(s) |
|-------|------|-------------|----------|
|`vers` |NFSVersionType |NFS version to use.  |`4.2`<br />`4.1`<br />`4.0`<br />`3`<br />`2`<br /> |
|`proto` |NFSProtocolType |NFS protocol to use.  |`tcp`<br />`tcp6`<br />`udp`<br />`udp6`<br />`rdma`<br />`rdma6`<br /> |
|`acl` |bool |Enable or disable ACL for NFS.  | |
