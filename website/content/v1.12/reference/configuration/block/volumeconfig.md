...
|`lockToSecureBootState` |bool |Lock the TPM key to the current Secureboot state. changing Secureboot status or configuration after the initial enrollment will make the key unusable.  | |
