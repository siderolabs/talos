...
```
      ...
      --cni-bundle-url string                    URL to download CNI bundle from (VM only) (default "https://github.com/siderolabs/talos/releases/download/v1.9.5-dirty/talosctl-cni-bundle-${ARCH}.tar.gz")
...
```
talosctl images cache-create --images=ghcr.io/siderolabs/kubelet:1.32.4 --image-cache-path=/tmp/talos-image-cache
...
```
  ...
  -i, --image string         the container image to use for performing the install (default "ghcr.io/siderolabs/installer:v1.9.5-dirty")
