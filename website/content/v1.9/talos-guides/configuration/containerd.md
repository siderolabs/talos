...
By default Containerd configures CDI to read discovered hardware devices from `["/etc/cdi", "/var/run/cdi"]`. Since /etc is not writable in Talos, CDI does not work for Dynamic Resource Allocation out of the box.
