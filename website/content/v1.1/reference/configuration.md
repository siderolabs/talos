...
``` yaml
kubelet:
    image: ghcr.io/siderolabs/kubelet:v1.24.0-alpha.4 # The `image` field is an optional reference to an alternative kubelet image.
...
``` yaml
apiServer:
    image: k8s.gcr.io/kube-apiserver:v1.24.0-alpha.4 # The container image used in the API server manifest.
...
``` yaml
controllerManager:
    image: k8s.gcr.io/kube-controller-manager:v1.24.0-alpha.4 # The container image used in the controller manager manifest.
...
``` yaml
proxy:
    image: k8s.gcr.io/kube-proxy:v1.24.0-alpha.4 # The container image used in the kube-proxy manifest.
...
``` yaml
scheduler:
    image: k8s.gcr.io/kube-scheduler:v1.24.0-alpha.4 # The container image used in the scheduler manifest.
...
``` yaml
image: ghcr.io/siderolabs/kubelet:v1.24.0-alpha.4
```
...
``` yaml
image: k8s.gcr.io/kube-apiserver:v1.24.0-alpha.4
```
...
``` yaml
image: k8s.gcr.io/kube-controller-manager:v1.24.0-alpha.4
```
...
``` yaml
image: k8s.gcr.io/kube-proxy:v1.24.0-alpha.4
```
...
``` yaml
image: k8s.gcr.io/kube-scheduler:v1.24.0-alpha.4
```
