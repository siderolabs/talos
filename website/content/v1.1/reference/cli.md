...
```
  ...
  -i, --input-dir string                         location of pre-generated config files
      ...
      --kubernetes-version string                desired kubernetes version to run (default "1.24.0-alpha.4")
...
```
  ...
  -h, --help              help for upgrade-k8s
      --to string         the Kubernetes control plane version to upgrade to (default "1.24.0-alpha.4")
