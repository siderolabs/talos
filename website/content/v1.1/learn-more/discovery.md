...
We maintain a public discovery service whereby members of your cluster can use a shared and unique key to coordinate the most basic connection information (i.e. the set of possible "endpoints", or IP:port pairs).
