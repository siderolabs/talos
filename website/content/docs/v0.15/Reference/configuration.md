...
install:
    ...
    # # Allows for supplying additionsl system extension images to install on top of base Talos image.
    # extensions: ghcr.io/talos-systems/installer:latest
```
...
``` yaml
ghcr.io/talos-systems/installer:latest
```
