...
```
      ...
      --cni-bundle-url string                    URL to download CNI bundle from (default "https://github.com/siderolabs/talos/releases/download/v1.11.0-alpha.3/talosctl-cni-bundle-${ARCH}.tar.gz")
...
```
      ...
      --cpus-workers string                      the share of CPUs as fraction (each worker/VM) (default "2.0")
      --disable-ipv6                             skip enabling IPv6 in containers
  ...
  -h, --help                                     help for create-docker
      ...
      --memory-workers int                       the limit on memory usage in MB (each worker/VM) (default 2048)
      --mount mount                              attach a mount to the container
