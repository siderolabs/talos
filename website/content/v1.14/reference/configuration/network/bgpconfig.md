...
neighbors:
    - interface: enp1s0 # Interface name for an unnumbered (IPv6 link-local) session. Mutually exclusive with `address`.
      # BFD (Bidirectional Forwarding Detection) configuration for the neighbor.
      bfd: {}
    - interface: enp2s0 # Interface name for an unnumbered (IPv6 link-local) session. Mutually exclusive with `address`.
      # BFD (Bidirectional Forwarding Detection) configuration for the neighbor.
      bfd: {}
...
|`neighbors` |<a href="#BGPConfig.neighbors.">[]BGPNeighborConfig</a> |BGP neighbors to peer with.  | |




## neighbors[] {#BGPConfig.neighbors.}
...
|`bfd` |<a href="#BGPConfig.neighbors..bfd">BGPBFDConfig</a> |BFD (Bidirectional Forwarding Detection) configuration for the neighbor.  | |




### bfd {#BGPConfig.neighbors..bfd}
