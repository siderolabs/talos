...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| image_ref | [string](#string) |  | Image reference to verify.
...
| credentials | [ImageServiceCredentials](#machine.ImageServiceCredentials) |  | Authentication credentials for the registry (if needed).
