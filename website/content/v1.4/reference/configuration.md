...
kubelet:
    image: ghcr.io/siderolabs/kubelet:v1.26.3 # The `image` field is an optional reference to an alternative kubelet image.
...
apiServer:
    image: registry.k8s.io/kube-apiserver:v1.26.3 # The container image used in the API server manifest.
...
controllerManager:
    image: registry.k8s.io/kube-controller-manager:v1.26.3 # The container image used in the controller manager manifest.
...
proxy:
    image: registry.k8s.io/kube-proxy:v1.26.3 # The container image used in the kube-proxy manifest.
...
scheduler:
    image: registry.k8s.io/kube-scheduler:v1.26.3 # The container image used in the scheduler manifest.
