...
- X86: [https://github.com/siderolabs/talos/releases/download/v0.11.0/talos-amd64.iso](https://github.com/siderolabs/talos/releases/download/v0.11.0/talos-amd64.iso)
- ARM64: [https://github.com/siderolabs/talos/releases/download/v0.11.0/talos-arm64.iso](https://github.com/siderolabs/talos/releases/download/v0.11.0/talos-arm64.iso)

For self-built media and network booting, you can use the kernel and initramfs:

- X86: [https://github.com/siderolabs/talos/releases/download/v0.11.0/boot-amd64.tar.gz](https://github.com/siderolabs/talos/releases/download/v0.11.0/boot-amd64.tar.gz)
- ARM64: [https://github.com/siderolabs/talos/releases/download/v0.11.0/boot-ard64.tar.gz](https://github.com/siderolabs/talos/releases/download/v0.11.0/boot-ard64.tar.gz)
