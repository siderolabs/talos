...
> 
> Note: When using KMS encryption for `STATE` partition, custom CA Certificates cannot be used for the KMS server, as these are stored in the `STATE` partition.
