...
If you're looking to set up a cluster with multiple control plane nodes, see [Production Notes](/website/content/v1.10/introduction/prodnotes).

**New to Talos?** Start with [Quickstart](/website/content/v1.10/introduction/quickstart) to create a local virtual cluster on your workstation.

**Planning for production?** See [Production Notes](/website/content/v1.10/introduction/prodnotes) for additional requirements and best practices.

**Installing on cloud or virtualized platforms?** Check out the [platform-specific guides](/website/content/v1.10/talos-guides/install) for installation methods tailored to different environments.
...
Refer to the [talosctl installation guide](/website/content/v1.10/talos-guides/install/talosctl) for installation on other platforms.
...
- **Ensure network access**: Your machines will need internet access to download the Talos installer and container images, sync time, and more.
    ...
    If you’re working in a restricted network environment, check out the official documentation on using [registry proxies](/website/content/v1.10/talos-guides/configuration/pull-through-cache), local registries, or setting up an [air-gapped installation](/website/content/v1.10/advanced/air-gapped).
