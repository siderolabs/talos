...
```
  ...
  -i, --input-dir string                         location of pre-generated config files
      ...
      --cni-bundle-url string                    (QEMU only) URL to download CNI bundle from (default "https://github.com/siderolabs/talos/releases/download/v1.10.0-alpha.1/talosctl-cni-bundle-${ARCH}.tar.gz")
...
```
  ...
  -i, --image string         the container image to use for performing the install (default "ghcr.io/siderolabs/installer:v1.10.0-alpha.1")
