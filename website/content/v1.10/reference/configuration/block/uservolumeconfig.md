...
|-------|------|-------------|----------|
|`name` |string |<details><summary>Name of the volume.</summary><br />Name might be between 1 and 36 characters long and can only contain:<br />lowercase and uppercase ASCII letters, digits, and hyphens.</details>  | |
