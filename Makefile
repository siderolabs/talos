...
ARTIFACTS := _out
TOOLS ?= ghcr.io/siderolabs/tools:v1.2.0-3-g81b11c8
PKGS ?= v1.2.0-22-g3903d18
...
KUBECTL_URL ?= https://storage.googleapis.com/kubernetes-release/release/v1.25.4/bin/$(OPERATING_SYSTEM)/amd64/kubectl
