...
ARTIFACTS := _out
TOOLS ?= ghcr.io/siderolabs/tools:v1.3.0-4-g9a1d3ec
PKGS ?= v1.3.0-17-g49b4ba8
EXTRAS ?= v1.3.0-5-g75d687a
GO_VERSION ?= 1.19
...
KUBECTL_URL ?= https://storage.googleapis.com/kubernetes-release/release/v1.26.3/bin/$(OPERATING_SYSTEM)/amd64/kubectl
