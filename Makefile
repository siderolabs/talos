...
COMMON_ARGS += --build-arg=EMBED_NAME=$(NAME)
COMMON_ARGS += --build-arg=EMBED_SHA=$(SHA)
COMMON_ARGS += --build-arg=EMBED_USERNAME=$(USERNAME)
COMMON_ARGS += --build-arg=EMBED_REGISTRY=$(REGISTRY)
