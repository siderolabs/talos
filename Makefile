...
ARTIFACTS := _out
TOOLS ?= ghcr.io/siderolabs/tools:v1.6.0-alpha.0-3-g09023c1
PKGS ?= v1.6.0-alpha.0-21-g34f3c41
PKG_KERNEL ?= ghcr.io/siderolabs/kernel:$(PKGS)
EXTRAS ?= v1.6.0-alpha.0-1-g09d7c3e
...
KUBECTL_VERSION ?= v1.29.0-alpha.1
