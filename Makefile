...
PKGS ?= v1.1.0-7-g5016a9d
EXTRAS ?= v1.1.0-1-g5800284
GO_VERSION ?= 1.18
...
KUBECTL_URL ?= https://storage.googleapis.com/kubernetes-release/release/v1.24.1/bin/$(OPERATING_SYSTEM)/amd64/kubectl
