...
TOOLS ?= v1.15.0-alpha.0-3-ge033f2a
PKGS_PREFIX ?= ghcr.io/siderolabs
PKGS ?= v1.15.0-alpha.0-13-gb6b2843
...
PKG_WPA_SUPPLICANT ?= $(PKGS_PREFIX)/wpa-supplicant:$(PKGS)
...
COMMON_ARGS += --build-arg=PKG_WPA_SUPPLICANT=$(PKG_WPA_SUPPLICANT)
