...
func init() {
	upgradeK8sCmd.Flags().StringVar(&upgradeK8sCmdFlags.fromVersion, "from-version", "", "the Kubernetes control plane version to upgrade from")
	upgradeK8sCmd.Flags().StringVar(&upgradeK8sCmdFlags.toVersion, "to-version", constants.DefaultKubernetesVersion, "the Kubernetes control plane version to upgrade to")
	cli.Should(upgradeK8sCmd.MarkFlagRequired("from-version"))
	cli.Should(upgradeK8sCmd.MarkFlagRequired("to-version"))
